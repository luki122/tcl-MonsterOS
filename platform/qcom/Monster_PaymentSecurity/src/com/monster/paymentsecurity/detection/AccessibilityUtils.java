...
public class AccessibilityUtils {
    ...
    public static Set<ComponentName> getEnabledServicesFromSettings(Context context, int userId) {
        final String enabledServicesSetting = Settings.Secure.getStringForUser(
                ...
                userId);
        Log.e("sandysheny", "getEnabledServicesFromSettings :" + enabledServicesSetting);
    ...
    public static void setAccessibilityServiceEnabled(Context context) {
        String settingValue = Settings.Secure.getString(context.getApplicationContext().getContentResolver(),
                Settings.Secure.ENABLED_ACCESSIBILITY_SERVICES);
        StringBuilder builder = new StringBuilder();
        builder.append(settingValue).append(":").append(Constant.ACCESSIBILITY_NAME);
