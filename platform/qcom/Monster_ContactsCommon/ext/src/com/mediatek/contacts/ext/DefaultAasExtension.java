...
public class DefaultAasExtension implements IAasExtension {
     ...
     */
    @Override
    public boolean rebuildLabelSelection(RawContactDelta state, MstSpinner label,
     ...
     *            the string value pair to update for copy to insert in SIM in one go
     */
    @Override
    ...
    /**
     * update the aas column to dest builder
     *
     * @param srcCursor
     *            the source cursor
     * @param destBuilder
