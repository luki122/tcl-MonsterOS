...
/**
 * CSIM accountType for special SIM card.
 */
public class CsimAccountType extends BaseAccountType {
    private static final String TAG = "CsimAccountType";

    public static final String ACCOUNT_TYPE = AccountTypeUtils.ACCOUNT_TYPE_CSIM;
    public static final int FLAGS_USIM_NUMBER = FLAGS_PHONE;

    /**
     * CsimAccountType function init items.
     *
     * @param context
     *            the Context value.
     ...
     *            string value.
     */
    public CsimAccountType(Context context, String resPackageName) {
        Log.i(TAG, "[CsimAccountType]resPackageName:" + resPackageName);
    ...
    protected DataKind addDataKindStructuredNameForUsim(Context context)
