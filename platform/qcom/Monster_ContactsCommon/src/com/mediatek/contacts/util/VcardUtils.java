...
public class VcardUtils {
    ...
    public static void setDestSelection(VCardService service, Activity activity) {
        String selection = activity.getIntent().getStringExtra("exportselection");
        service.setQuerySelection(selection);
        String destStoragePath = activity.getIntent().getStringExtra("dest_path");
        Log.d(TAG, "[setDestSelection]destStoragePath:" + destStoragePath + ",selection = "
                + selection);
