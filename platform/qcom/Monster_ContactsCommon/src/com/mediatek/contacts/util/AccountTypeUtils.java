...
public class AccountTypeUtils {
    ...
    public static final SparseArray<SparseArray<String>> SIM_ACCOUNT_NAME_ARRAY =
            new SparseArray<SparseArray<String>>(
    ...
    public static Drawable getDisplayIconBySubId(Context context, int subId, int titleRes,
        ...
        if (titleRes != -1 && syncAdapterPackageName != null) {
             ...
             * R.drawable.mtk_ic_contact_account_sim; } return
            ...
            return ExtensionManager.getInstance().getCtExtension()
    ...
    public static int getSubIdBySimAccountName(Context context, String accountName) {
        ...
        Log.d(TAG, "[getSubIdBySimAccountName]account " + accountName + " is not sim account");
     ...
     *
     * @param kind
     *            the data kind of ImsCall.
     * @param flagsSipAddress
     *            BaseAccountType.FLAGS_SIP_ADDRESS.
     */
    public static void setDataKindImsCall(DataKind kind, int flagsSipAddress) {
        ...
        kind.fieldList
                .add(new EditField(ImsCall.URL, R.string.imsCallLabelsGroup, flagsSipAddress));
    }
}
