...
//        }
    ...
    public Cursor loadInBackground() {
        ...
        if (mEnableDefaultSearch) {
            ...
            cursor = dialerSearchHelper.getSmartDialerSearchResults(mQuery,true);
        }
        if (cursor != null) {
    ...
    protected void onStartLoading() {
    	Log.d(TAG, "MTK-DialerSearch, onStartLoading() "  + this+" mCursor:"+mCursor);
        if (mCursor != null) {
    ...
    protected void onStopLoading() {
    	Log.d(TAG, "MTK-DialerSearch, onStopLoading() "  + this);
