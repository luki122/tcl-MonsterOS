...
import mst.provider.ContactsContract.CommonDataKinds.Callable;
import mst.provider.ContactsContract.CommonDataKinds.Phone;
import mst.provider.ContactsContract.DialerSearch;
...
public class DialerSearchHelper {
    ...
    public static void initContactsPreferences(Context context) {
        ...
        context.getContentResolver().query(Uri.parse("content://com.android.contacts/mst_dialer_search_init"),
				null, null, null, null);
    }
...
//    private static final String QUERY_CONTACTLIST_PREFIX = "mstquerycontactlistprefix";
     ...
     */
    public Cursor getSmartDialerSearchResults(String query,boolean isForDialerSearch) {
...
//        query =QUERY_CONTACTLIST_PREFIX+query;
        final ContentResolver resolver = mContext.getContentResolver();
        Cursor cursor = null;
        try {
            int displayOrder = sContactsPrefs.getDisplayOrder();
            int sortOrder = sContactsPrefs.getSortOrder();
            Uri baseUri = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, isForDialerSearch?"mst_dialer_search":"mst_contacts_search");
...
//                            String.valueOf(sortOrder)).build();
            Uri dialerSearchParamUri = dialerSearchUri;

            Log.d(TAG,"getSmartDialerSearchResults,dialerSearchParamUri:"+dialerSearchParamUri.toString());
            cursor = resolver.query(dialerSearchParamUri, null, null, null, null);

            Log.d(TAG, "MTK-DialerSearch, cursor.getCount1: " + cursor.getCount());
    ...
    public Cursor getRegularDialerSearchResults(String query, boolean useCallableUri) {
        ...
        try {
            ...
            Log.d(TAG,"getRegularDialerSearchResults,regularDialerSearchUri:"+regularDialerSearchUri
