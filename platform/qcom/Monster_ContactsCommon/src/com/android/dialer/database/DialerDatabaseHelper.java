...
public class DialerDatabaseHelper extends SQLiteOpenHelper {
    private static final String TAG = "DialerDatabaseHelper1";
    ...
    /**
     * Access function to get the singleton instance of DialerDatabaseHelper1.
     */
    ...
    protected void insertUpdatedContactsAndNumberPrefix(SQLiteDatabase db,
        ...
        try {
            ...
            while (updatedContactCursor.moveToNext()) {
                ...
                if (displayName == null) {
                    insert.bindString(5, "no name"/*mContext.getResources().getString(R.string.missing_name)*/);
                } else {
