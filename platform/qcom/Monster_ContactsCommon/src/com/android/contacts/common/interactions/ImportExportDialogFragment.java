...
public class ImportExportDialogFragment extends DialogFragment
    ...
    public static void show(FragmentManager fragmentManager, boolean contactsAreAvailable,
        ...
        Log.d(TAG, "[show]put callingActivity.");
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Log.d(TAG,"[onCreateDialog]callingActivity = " + callingActivity);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (resId) {
                    ...
                    case R.string.export_to_vcf_file: {
                        Log.d(TAG,"[onCreateDialog]export_to_vcf_file.");
                        dismissDialog = true;
            ...
            try {
                if (!cursor.moveToFirst()) {
                        Toast.makeText(getActivity(), R.string.share_error, Toast.LENGTH_SHORT)
                                .show();
                    Log.w(TAG, "[doShareVisibleContacts]no data in cursor,return!");
                    return;
                }
