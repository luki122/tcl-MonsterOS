...
import mst.provider.ContactsContract.Settings;
        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //AOSP code: setContentView(R.layout.contact_list_filter_custom);
        View listLayout = getLayoutInflater().inflate(R.layout.contact_list_filter_custom, null);
    ...
    public static class CustomFilterConfigurationLoader extends AsyncTaskLoader<AccountSet> {
        ...
        public AccountSet loadInBackground() {
            ...
            for (AccountWithDataSet account : accountTypes.getAccounts(false)) {
                ...
                if (!ContactsCommonListUtils.isUserOwner()
                        && ContactsCommonListUtils.isAccountTypeSimUsim(accountType)) {
                    continue;
                }
                /// @}
                ...
                /** M: Bug Fix for ALPS00116855 */
                final Cursor cursor = resolver.query(groupsUri.build(), null, CLAUSE_GROUP_VISIBLE,
                        null, null);
                if (cursor == null) {
                    continue;
                }
                ...
                try {
                    ...
                    Log.d(TAG, "loadInBackground befor fromSettings");
    ...
    protected static class DisplayAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            if (AccountWithDataSetEx.isLocalPhone(accountType.accountType)) {
                ...
                /** M:need to set the sub group title view visible again. fix bug:ALPS00839926 */
