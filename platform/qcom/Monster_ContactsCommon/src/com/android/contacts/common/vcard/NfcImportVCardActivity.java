...
public class NfcImportVCardActivity extends Activity implements ServiceConnection,
    ...
    protected void onCreate(Bundle bundle) {
        ...
        // M: Bug fix for ALPS01881564, since SIM account not support vcard,
        // so filter SIM account when import by NFC @{.
        final List<AccountWithDataSet> accountList = VcardUtils.addNonSimAccount(
                                                    accountTypes.getAccounts(true));
        // }
