...
public abstract class AccountType {
    ...
    public Drawable getDisplayIcon(Context context) {
        Log.d(TAG, "[getDisplayIcon]titleRes = " + titleRes + ",syncAdapterPackageName = "
    ...
    /**
     * M: Descriptions: cu feature change photo by slot id.
     *   CR ID: ALPS00233786
     * @param context the Context.
     * @param subId the current sub id.
     * @return the icon according to sub id.
     */
    public Drawable getDisplayIconBySubId(Context context, int subId) {
       return AccountTypeUtils.getDisplayIconBySubId(context, subId,
            titleRes, iconRes, syncAdapterPackageName);
    }
