 ...
 */
public class AutoScrollListView extends MstListView {

	/**
	 * Position the element at about 1/3 of the list height
	 */
	private static final float PREFERRED_SELECTION_OFFSET_FROM_TOP = 0.33f;
	protected PinnedHeaderListAdapter mPinnedHeaderListAdapter;
	...
	protected void layoutChildren() {
		if(mPinnedHeaderListAdapter==null) super.layoutChildren();
		else if(mPinnedHeaderListAdapter.getCursor()!=null && !mPinnedHeaderListAdapter.getCursor().isClosed()){
		    //add by lgy for 3169289
		    try {
