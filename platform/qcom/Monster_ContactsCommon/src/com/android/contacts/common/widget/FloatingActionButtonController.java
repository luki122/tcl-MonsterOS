...
public class FloatingActionButtonController {
	...
	private static final String TAG = "FloatingActionButtonController";
    ...
    public FloatingActionButtonController(Activity activity, View container, ImageButton button) {
        ...
        Log.d(TAG,"mFloatingActionButtonContainer:"+mFloatingActionButtonContainer);
//        ViewUtil.setupFloatingActionButton(mFloatingActionButtonContainer, resources);
    ...
    public void setVisible(boolean visible) {
    	Log.d(TAG,"setVisible:"+visible+" mFloatingActionButtonContainer:"+mFloatingActionButtonContainer);
...
//    		mFloatingActionButtonContainer.setIconDrawable(icon);
//    		return;
//    	}
...
//        mFloatingActionButtonContainer.setTranslationY(0);
    ...
    */}
    ...
    public void scaleIn(int delayMs) {
    	Log.d(TAG,"scaleIn:"+delayMs);
        setVisible(true);
        AnimUtils.scaleIn(mFloatingActionButtonContainer, FAB_SCALE_IN_DURATION, delayMs);
//        AnimUtils.fadeIn(/*mFloatingActionButton*/mFloatingActionButtonContainer, FAB_SCALE_IN_DURATION,
...
//        mFloatingActionButton.setVisibility(View.VISIBLE);
    	mFloatingActionButtonContainer.setAlpha(1f);
...
//        AnimUtils.fadeOut(/*mFloatingActionButton*/mFloatingActionButtonContainer, FAB_ICON_FADE_OUT_DURATION, null);
    }
