...
DialogInterface.OnClickListener, DialogInterface.OnCancelListener {
			...
			case VCardService.MSG_SET_AVAILABLE_EXPORT_DESTINATION:
				if (msg.obj == null) {
					...
					if (TextUtils.isEmpty(mTargetFileName)) {
						...
						//						Intent intent=new Intent("DIALOG_EXPORT_CONFIRMATION");
						//						intent.putExtra("path", mTargetFileName);
						//						sendBroadcast(intent);
						new AlertDialog.Builder(ExportVCardActivity.this)
						.setTitle(getString(R.string.mst_menu_export_to_sd))
						.setMessage(getString(R.string.mst_export_sim_contacts_to_sd_confication_message,mTargetFileName))
						.setPositiveButton(android.R.string.ok,new ExportConfirmationListener(mTargetFileName))
						.setNegativeButton(android.R.string.cancel,ExportVCardActivity.this)
	...
	protected void onCreate(Bundle bundle) {
		...
		//		intentFilter.addAction("CONTACTS_EXPORT_CANCEL");
	...
	//			if(TextUtils.equals(action, "CONTACTS_EXPORT_CANCEL")){
	//				mService.handleCancelRequest(new CancelRequest(mService.mCurrentJobId-1,null), null);
	//			}
	//		}
	//	}
