...
import com.mediatek.contacts.model.CsimAccountType;
...
class AccountTypeManagerImpl extends AccountTypeManager
    ...
    public AccountTypeManagerImpl(Context context) {
        ...
        AccountTypeManagerEx.registerReceiverOnSimStateAndInfoChanged(mContext,
                mBroadcastReceiver);
...
//        }
        ...
        for (SyncAdapterType sync : syncs) {
            ...
            Log.d(TAG, "the AuthenticatorDescription [] auths = " + auths);
            ...
            Log.d("AccountTypeManager", "the   type is " + type + " the auth is = " + auth);
        ...
        addSimAndLocalAccountType(accountTypesByTypeAndDataSet, accountTypesByType);
...
//           Log.d(Constants.PERFORMANCE_TAG, "AccountTypeManager.loadAccountsInBackground finish");
 //       }
        ...
        // done from UI thread.
        ///M: fix ALPS00538943:delay check,let AccountManager has time to load SIM/USIM Accounts
        mMainThreadHandler.postAtTime(mCheckFilterValidityRunnable, System.currentTimeMillis()
                + 1000);
...
//            }
    ...
    ///M:
    private void addSimAndLocalAccountType(
            final Map<AccountTypeWithDataSet, AccountType> accountTypesByTypeAndDataSet,
        ...
        addAccountType(new UimAccountType(mContext, null), accountTypesByTypeAndDataSet,
                accountTypesByType);
        addAccountType(new CsimAccountType(mContext, null), accountTypesByTypeAndDataSet,
                accountTypesByType);
        //UIM
