...
public class ContactListItemView1 /*extends ViewGroup*/
/*implements SelectionBoundsAdjuster*/ {/*
	...
	*//** A helper used to highlight a prefix in a text field. *//*
	...
	public ContactListItemView1(Context context) {
		super(context);
	...
	public ContactListItemView1(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		.onMeasure(specWidth, height);
		setMeasuredDimension(specWidthgetResources().getDimensionPixelOffset(R.dimen.name_textview_max_width), height);
	}
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		if (isVisible(mNameTextView)) {
			...
			if (mPhotoPosition == PhotoPosition.LEFT) {
				mNameTextView.layout(leftBoundisShowLeftPhoto()?mPhotoViewWidth:0,
						textTopBound,
	...
	*//**
	...
	public TextView getNameTextView() {
		if (mNameTextView == null) {
			...
			mNameTextView.setPadding(getResources().getDimensionPixelOffset(listPreferredItemPaddingStartResId)0, 
					0, 
					getResources().getDimensionPixelOffset(listPreferredItemPaddingEndResId), 
					0);
			mNameTextView.setTextAppearance(getContext(), textAppearanceListItemSmallResId);
