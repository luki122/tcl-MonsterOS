...
public class TextHighlighter {
    ...
    public void applyMaskingHighlight(SpannableString text, int start, int end) {
    	Log.d(TAG,"applyMaskingHighlight,text:"+text+" start:"+start+" end:"+end);
    ...
    public CharSequence applyPrefixHighlight(CharSequence text, String prefix) {
    	Log.d(TAG, "applyPrefixHighligh,text:"+text+" prefix:"+prefix);
        if (prefix == null) {
            return text;
        }
        ...
        Log.d(TAG,"trimmedPrefix:"+trimmedPrefix);
