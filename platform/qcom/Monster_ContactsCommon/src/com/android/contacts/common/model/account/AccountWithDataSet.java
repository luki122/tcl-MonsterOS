 ...
 */
///M:
public class AccountWithDataSet extends Account implements Parcelable {
    ...
    /*M:@{ Because we have extends Account class,so we don't need keep two examples.
    ...
    public AccountWithDataSet(String name, String type, String dataSet) {
        super(name, type);
        ///M: we have do this on super(name, type) @{
