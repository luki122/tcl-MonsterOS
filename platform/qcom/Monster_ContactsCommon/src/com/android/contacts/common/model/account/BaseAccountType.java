...
//        kind.typeList.add(buildPhoneType(Phone.TYPE_MMS).setSecondary(true));
    ...
    /**
     * M: VOLTE IMS Call feature, add IMS call {@link DataKind}.
     */
    protected DataKind addDataKindImsCall(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(ImsCall.CONTENT_ITEM_TYPE,
                R.string.imsCallLabelsGroup, Weight.IMS_CALL, true));
        AccountTypeUtils.setDataKindImsCall(kind, FLAGS_SIP_ADDRESS);
        return kind;
    }

    protected DataKind addDataKindEmail(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Email.CONTENT_ITEM_TYPE, R.string.mst_emailLabelsGroup,
                Weight.EMAIL, true));
...
//                buildEmailType(Email.TYPE_CUSTOM).setSecondary(true).setCustomColumn(Email.LABEL));
        ...
        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add(new EditField(Email.DATA, R.string.mst_emailLabelsGroup, FLAGS_EMAIL));
    ...
    protected DataKind addDataKindStructuredPostal(Context context) throws DefinitionException {
        ...
        kind.fieldList = Lists.newArrayList();
        /// M: CMCC request 7 edit fields.
        AccountTypeUtils.setStructuredPostalFiledList(kind, FLAGS_POSTAL);
        //kind.fieldList.add(
    ...
    protected DataKind addDataKindOrganization(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Organization.CONTENT_ITEM_TYPE,
                    R.string.mst_organizationLabelsGroup, Weight.ORGANIZATION, true));
        kind.actionHeader = new SimpleInflater(R.string.mst_organizationLabelsGroup);
    ...
    protected DataKind addDataKindNote(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Note.CONTENT_ITEM_TYPE, R.string.label_notes,
                Weight.NONE, true));//mengxue.liu past:Weight.NOTE
        kind.typeOverallMax = 1;
    ...
    protected DataKind addDataKindGroupMembership(Context context) throws DefinitionException {
        ...
        kind.typeOverallMax = 1;
        /// M: Add group member ship datakind's actionHeader and actionBody. @{
        kind.actionHeader = new SimpleInflater(R.string.groupsLabel);
...
//            }
    ...
    private static class EmailKindBuilder extends KindBuilder {
        ...
        public List<DataKind> parseDataKind(Context context, XmlPullParser parser,
                ...
                IOException {
            final DataKind kind = newDataKind(context, parser, attrs, false,
                    Email.CONTENT_ITEM_TYPE, Email.TYPE, R.string.mst_emailLabelsGroup, Weight.EMAIL,
    ...
    /**
    *
    * @return The value  Type Postal Field Editor use
    */
   public static int getTypePostal() {
	   return FLAGS_POSTAL;
   }
   
    /**
    *
    * @return The value  Type Email Field Editor use
    */
