...
public final class ContactListFilter implements Comparable<ContactListFilter>, Parcelable {
    ...
    private static final String TAG = ContactListFilter.class.getSimpleName();
    ...
    public static final int FILTER_TYPE_RECORD_CONTACT = -7;    
    public static final int FILTER_TYPE_SELECT_RECORD_CONTACT = -8;
    
    public static final int FILTER_TYPE_PRIVACY_CONTACT = -9;
    
    public static final int FILTER_TYPE_ADD_PRIVACY_CONTACT = -10;
    ...
    public ContactListFilter(int filterType, String accountType, String accountName, String dataSet,
        Drawable icon, String displayName) {
    ...
    public ContactListFilter(int filterType, String accountType, String accountName, String dataSet,
            Drawable icon, String displayName,Object extra) {
            this.filterType = filterType;
            this.accountType = accountType;
            this.accountName = accountName;
            this.dataSet = dataSet;
    ...
    public static ContactListFilter createFilterWithType(int filterType,Object extra) {
        return new ContactListFilter(filterType, null, null, null, null, null,extra);
    }

    public static ContactListFilter createAccountFilter(String accountType, String accountName,
            String dataSet, Drawable icon, String displayName) {
        /** M: ALPS913966 cache displayname in account filter and  push to intent */
        return new ContactListFilter(ContactListFilter.FILTER_TYPE_ACCOUNT, accountType,
                accountName, dataSet, icon, displayName);
    }
        ...
        switch (filterType) {
            ...
            case FILTER_TYPE_ACCOUNT:
                return "account: " + accountType + (dataSet != null ? "/" + dataSet : "")
                        + " " + accountName;
            case FILTER_TYPE_RECORD_CONTACT:
            	return "record_contact";
            case FILTER_TYPE_SELECT_RECORD_CONTACT:
            	return "select_record_contact";
        }
    ...
    public static final Parcelable.Creator<ContactListFilter> CREATOR =
        ...
        public ContactListFilter createFromParcel(Parcel source) {
            ...
            /**
             * M: ALPS913966 cache displayname in account filter and push to
             * intent @{
             */
    ...
    public static final String filterTypeToString(int filterType) {
        switch (filterType) {
            ...
            case FILTER_TYPE_RECORD_CONTACT:
            	return "FILTER_TYPE_RECORD_CONTACT";
            case FILTER_TYPE_SELECT_RECORD_CONTACT:
            	return "FILTER_TYPE_SELECT_RECORD_CONTACT";
            default:
                return "(unknown)";
        }
    }
