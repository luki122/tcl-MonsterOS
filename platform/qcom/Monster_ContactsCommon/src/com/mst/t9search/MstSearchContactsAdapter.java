...
//		Log.d(TAG,"reQueryisMultiSimEnabled");
	...
	public void setmContacts(List<Contacts> mContacts) {
		this.mContacts = mContacts;
	}
...
//		Log.d(TAG,"getItemViewType:"+position);	
		...
		if(isForDialer&&position>=mContacts.size()) return ITEM_FOOTER;
	...
	public View getView(int position, final View convertView, final ViewGroup parent) {
		...
		case ITEM_CONTENT_DOUBLE:{
			...
			case SearchByPhoneNumber:
				...
				ViewUtil.showTextHighlight(viewHolder.number, number, contact.getMatchKeywords().toString());
				break;
			case SearchByName:
