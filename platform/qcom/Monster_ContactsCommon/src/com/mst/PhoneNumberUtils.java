...
public class PhoneNumberUtils
{
    ...
    public static String getNumberFromIntent(Intent intent, Context context) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error getting phone number.", e);
        } finally {
            if (c != null) {
                c.close();
            }
    ...
    compareLoosely(String a, String b) {
        ...
        //[FEATURE]-ADD-BEGIN by TSNJ.xiaowei.yang-nb,09/24/2015 ,Task-528186
        int min_match = Integer.valueOf(SystemProperties.get("phone.num.significant.length", "6"));
        //[FEATURE]-ADD-END by TSNJ.xiaowei.yang-nb,09/24/2015 ,Task-528186
        ...
        //[FEATURE]-ADD-BEGIN by TSNJ.xiaowei.yang-nb,09/24/2015 ,Task-528186
        if (SystemProperties.getBoolean("ro.config.phnum.accurate", false)) {
            if (matched >= min_match) {
                return true;
            }
        }
...
//        JapanesePhoneNumberFormatter.format(text);
 ...
 /**
    ...
    //[SOLUTION]-Add-BEGIN by TCTNB.(Yubin.Ying), 08/09/2016, SOLUTION-2504679
       /**
    * check the given string is a shortcode call or not, which will dial out as a call not ussd code.
    * Add by kaibang.liu for Defect: 1453059, Porting from l8936 PR-1042889
    * @hide
    */
    public static boolean isShortCodeCall(Context context,String dialString) {
        // check if it meets the required pattern * and only one digit.
        ...
        boolean shortCodeCall = context.getResources().getBoolean(com.android.internal.R.bool.def_tctfw_shortCodeCall_on);
        Log.d(LOG_TAG, "isShortCodeCall, shortCodeCall:" + shortCodeCall);

        return shortCodeCall;
    }
