 ...
 */
public class MstDefaultItemAnimator extends RecyclerView.ItemAnimator {
    ...
    public void clearInterpolator(View view) {
        if (mDefaultInterpolator == null) {
            ...
            mDefaultInterpolator = anim.getInterpolator();
        }
    ...
    private static class VpaListenerAdapter implements AnimatorListener {
