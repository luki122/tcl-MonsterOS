...
public class RecentsTransitionHelper {
     ...
     */
    public void launchTaskFromRecents(View view, final TaskStack stack, @Nullable final Task task,
...
//        final ActivityOptions opts = ActivityOptions.makeScaleUpAnimation(view,  -pts[0],  -pts[1] - view.getMeasuredHeight(), 
//        		view.getMeasuredWidth(), view.getMeasuredHeight());
        final ActivityOptions opts = ActivityOptions.makeScaleUpAnimation(view,  0,  0, view.getMeasuredWidth(), view.getMeasuredHeight());
