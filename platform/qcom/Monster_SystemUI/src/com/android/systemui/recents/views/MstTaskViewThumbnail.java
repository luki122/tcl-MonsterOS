 ...
 */
public class MstTaskViewThumbnail extends View {
    ...
    public MstTaskViewThumbnail(Context context) {
        this(context, null);
    }

    public MstTaskViewThumbnail(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MstTaskViewThumbnail(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public MstTaskViewThumbnail(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//                R.dimen.recents_task_view_rounded_corners_radius);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBitmapShader != null && thumbnailWidth > 0 && thumbnailHeight > 0) {
            ...
            // Draw the thumbnail
            canvas.drawRoundRect(0, topOffset, getWidth(), getHeight(),
        ...
        */
        ...
        if(mBitmapShader != null) {
        	...
        	canvas.drawRoundRect(0, 0, getWidth(), getHeight(), mCornerRadius, mCornerRadius,
                    mBgFillPaint);
        }
        /**Mst: tangjun add begin*/
    }
    ...
    void onTaskDataLoaded(ActivityManager.TaskThumbnailInfo thumbnailInfo) {
        if (mTask.thumbnail != null) {
            ...
            //Mst: mod by tangjun for redraw when thumbnail is not null 2016.10.10 begin
            postInvalidate();
            //invalidate();
            //Mst: mod by tangjun for redraw when thumbnail is not null 2016.10.10 end
        } else {
