...
public class NotificationHeaderViewWrapper extends NotificationViewWrapper {
    ...
    protected NotificationHeaderViewWrapper(Context ctx, View view, ExpandableNotificationRow row) {
        ...
        mIcongetter = IconGetterManager.getInstance(ctx,false,true);
        resolveHeaderViews();
        updateInvertHelper();
        //add by chenhl start
        mIconDrawable = ctx.getDrawable(R.drawable.ic_tcl_status_icon_bg);
        //add by chenhl end
    }
    ...
    public void notifyContentUpdated(StatusBarNotification notification) {
        ...
        //add by chenhl start
        updateHeaderIcon(notification);
        //add by chenhl end
    }

    //add by chenhl start
    public void updateHeaderIcon(StatusBarNotification notification){
        if(mIcon != null){
            try {
                if(isSystemIcon(notification.getPackageName())){
                    if(mIconDrawable!=null){
                        mIcon.setBackground(mIconDrawable);
                    }
                    return;
                }
                if(mIcongetter==null){
                ...
                Drawable icon = mIcongetter.getIconDrawable(notification.getPackageName());
                if (icon != null) {
