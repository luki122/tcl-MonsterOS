...
public class LockscreenWallpaper extends IWallpaperManagerCallback.Stub implements Runnable {
    ...
    // kth add for keyguard inversion 20161013 start
    public interface LockscreenWallpaperListener{
        void notifyWallpaperChanged(int RGB, float alpha);
    }
    // kth add for keyguard inversion 20161013 end
    ...
    private boolean mUserSetupComplete;// TCL Monster: kth add for update lockscreen wallpaper notify setup completed 20161124
    ...
    public Bitmap getBitmap() {
        ...
        if (result.success) {
            if (mUserSetupComplete && result.bitmap != null) {// TCL Monster: kth mod for update lockscreen wallpaper notify setup completed 20161124
                mCached = true;
