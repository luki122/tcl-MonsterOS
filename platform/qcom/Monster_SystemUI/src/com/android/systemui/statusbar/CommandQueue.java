...
public class CommandQueue extends IStatusBar.Stub {
    ...
    //add by chenhl start
    private static final int MSG_UPDATE_PAY_STATE              = 33 << MSG_SHIFT;
    //add by chenhl end
    ...
    public interface Callbacks {
        ...
        //add by chenhl start
        void updatePayState(boolean show,String showText,int color);
        //add by chenhl end
    }
    ...
    public void updatePayState(boolean show,String showText,int color){
        synchronized (mLock) {
            mHandler.obtainMessage(MSG_UPDATE_PAY_STATE,show?1:0,color,showText).sendToTarget();
        }
    }
    //add by chenhl end
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_TOGGLE_APP_SPLIT_SCREEN:
                    ...
                    break;
                //add by chenhl start
                case MSG_UPDATE_PAY_STATE:
                    mCallbacks.updatePayState(msg.arg1==1,msg.obj.toString(),msg.arg2);
                    break;
                //add by chenhl end
            }
        }
