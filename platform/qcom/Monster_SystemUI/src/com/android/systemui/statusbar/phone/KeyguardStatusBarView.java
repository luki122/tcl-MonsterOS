...
public class KeyguardStatusBarView extends RelativeLayout
        implements BatteryController.BatteryStateChangeCallback, LockscreenWallpaper.LockscreenWallpaperListener {
    ...
    protected void onFinishInflate() {
        ...
        mMultiUserAvatar.setVisibility(View.INVISIBLE);// TCL Monster: kth add for hide avatar in keyguad 20160818
        mMultiUserSwitch.setVisibility(View.INVISIBLE);// TCL Monster: kth add for hide avatar in keyguad 20160818
        ///TCL Monster: kth mod use the same view with statusbar 20160927 start @{
        // mBatteryLevel = (TextView) findViewById(R.id.battery_level);
        mBatteryMeterViewKeyguard = (BatteryMeterView) mSystemIconsContainer.findViewById(R.id.battery);
        mBatteryLevel = (TextView) mSystemIconsContainer.findViewById(R.id.battery_percent);
        mBatteryMeterViewKeyguard.setPercentView(mBatteryLevel);
        ///end @}
...
/* TCL Monster: kth mod use the same view with statusbar 20160927
...
/* TCL Monster: kth remove it 20161028        mCarrierLabel.setTextSize(TypedValue.COMPLEX_UNIT_PX,
...
//        mBatteryLevel.setText(percentage);//TCL Monster: kth mod use the same view with statusbar 20160927
    ...
    /// TCL Monster: kth add for keyguard inversion 20161017 start
    @Override
    public void notifyWallpaperChanged(int RGB, float alpha) {
        Log.d("0917", "onWallpaperChanged: RGB=" + RGB);
        mCarrierLabel.setAlpha(alpha);
        mCarrierLabel.setTextColor(RGB);
    }

    private PhoneStatusBar phoneStatusBar;
    public void setPhoneStatusBar(PhoneStatusBar phoneStatusBar) {
        this.phoneStatusBar = phoneStatusBar;
        this.phoneStatusBar.addLockScreenWpListener(this);
    }
    /// TCL Monster: kth add for keyguard inversion 20161017 end
}
