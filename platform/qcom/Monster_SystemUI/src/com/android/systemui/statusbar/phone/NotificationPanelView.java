    ...
    */
    ...
    private void startAnimationForShow() {
        ...
        animSet.addListener(new AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                // TODO Auto-generated method stub
                mKeyguardBottomAreaView.launchCamera(KeyguardBottomAreaView.CAMERA_LAUNCH_SOURCE_AFFORDANCE);
                postDelayed(mResetRunnable, 800);
            }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (DEBUG_LOG) Log.d("ktt_fre", "NotificationPanelView onTouchEvent isShowBouncer=" + isShowBouncer);/// end@}
        if (mStatusBar.getBarState() != StatusBarState.SHADE && !isShowBouncer) {
