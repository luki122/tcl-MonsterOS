...
public class NotificationSettingsIconRow extends FrameLayout implements View.OnClickListener {
    ...
    private View mGearIcon; //modify by chenhl
    ...
    protected void onFinishInflate() {
        ...
        mGearIcon = findViewById(R.id.gear_icon); //modify by chenhl
    ...
    public void resetState() {
        ...
        setTranslationX(mHorizSpaceForGear);//add by chenhl
    }
    ...
    public void setNotificationRowParent(ExpandableNotificationRow parent) {
        ...
        FrameLayout.LayoutParams params=(FrameLayout.LayoutParams)mGearIcon.getLayoutParams();
        params.height=parentHeight;
        mGearIcon.setLayoutParams(params);
        //add by chenhl end
    }
    ...
    public void setAppName(String appName) {
        ...
        String description = String.format(res.getString(R.string.notification_gear_accessibility),
                appName);
        //mGearIcon.setContentDescription(description); //delete by chenhl
    }
    ...
    public void updateSettingsIcons(final float transX, final float size) {
        ...
        float delt = transX+mHorizSpaceForGear;
        setTranslationX(delt<0?0:delt);
        ...
        setGearAlpha(delt<mHorizSpaceForGear?1:0);
    ...
    public void fadeInSettings(final boolean fromLeft, final float transX,
        ...
        if (isIconLocationChange(transX)) {
            //setGearAlpha(0f); //delete by chenhl
        }
    ...
    public void setIconLocation(boolean onLeft) {
        ...
        //setTranslationX(onLeft ? left + centerX : right + centerX); //delete by chenhl
        mOnLeft = onLeft;
        mIconPlaced = true;
    }
