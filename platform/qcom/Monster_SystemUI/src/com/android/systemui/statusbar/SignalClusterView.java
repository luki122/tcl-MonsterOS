...
public class SignalClusterView
    ...
    public void setMobileDataIndicators(IconState statusIcon, IconState qsIcon, int statusType,
        ...
        //add by chenhl start
        state.mMobileActivityId=getMobileActivityId(activityIn,activityOut);
        //add by chenhl end
        apply();
    }
    ...
    public void setNoSims(boolean show) {
        ...
        mNoSimsVisible = show && !mBlockMobile&&!mIsAirplaneMode;
    ...
    private void apply() {
        ...
        if (mIsAirplaneMode && mWifiVisible) {
            mWifiAirplaneSpacer.setVisibility(View.GONE);//modify by chenhl
        } else {
            mWifiAirplaneSpacer.setVisibility(View.GONE);
        }

        if (((anyMobileVisible && firstMobileTypeId != 0) || mNoSimsVisible) && mWifiVisible) {
            mWifiSignalSpacer.setVisibility(View.GONE);//modify by chenhl
        } else {
    ...
    private void applyIconTint() {
        ...
        //add by chenhl start
        setTint(mWifiActivity, StatusBarIconController.getTint(mTintArea, mWifiActivity, mIconTint));
        //add by chenhl end
        applyDarkIntensity(
    ...
    private class PhoneState {
        ...
        public void setIconTint(int tint, float darkIntensity, Rect tintArea) {
            ...
            //add by chenhl start
            setTint(mMobileActivity, StatusBarIconController.getTint(tintArea, mMobileActivity, tint));
            //add by chenhl end
        }
    }

    //add by chenhl start
    private int getMobileActivityId(boolean activityIn, boolean activityOut) {
