...
public class NotificationChildrenContainer extends ViewGroup {
    ...
    private void initDimens() {
        ...
        //add by chenhl start
        mDividerMarginstart=getResources().getDimensionPixelSize(R.dimen.tcl_notification_raw_marginstart);
        //add by chenhl end
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //modify by chenhl
            mDividers.get(i).layout(mDividerMarginstart, 0, getWidth(), mDividerHeight);
        }
    ...
    public void recreateNotificationHeader(OnClickListener listener, StatusBarNotification notification) {
        ...
        if (mNotificationHeader == null) {
            ...
            mNotificationHeaderWrapper.updateHeaderIcon(mNotificationParent.getStatusBarNotification());//add by chenhl
    ...
    public void getState(StackScrollState resultState, StackViewState parentState) {
        ...
        if (mNotificationHeader != null) {
            ...
            /*mHeaderViewState.zTranslation = childrenExpanded
                    ? mNotificationParent.getTranslationZ()
                    : 0;*/
            mHeaderViewState.zTranslation=0;
            //moidfy by chenhl end
        }
    }
