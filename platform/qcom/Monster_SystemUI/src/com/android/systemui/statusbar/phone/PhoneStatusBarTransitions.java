...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    public void init() {
        ...
        //mClock = mView.findViewById(R.id.clock); //delete by chenhl
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    //animateTransitionTo(mClock, newAlphaBC)//delete by chenhl
                    );
            if (isLightsOut(mode)) {
            ...
            //mClock.setAlpha(newAlphaBC);//delete by chenhl
        }
    }
}