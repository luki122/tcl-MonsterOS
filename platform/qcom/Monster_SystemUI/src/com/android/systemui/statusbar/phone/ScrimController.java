...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener,
    ...
    protected void updateScrims() {
        Log.d(TAG, "updateScrims: mDozing=" + mDozing + " mForceHideScrims=" + mForceHideScrims + " mAnimateKeyguardFadingOut=" + mAnimateKeyguardFadingOut + " mWakeAndUnlocking=" + mWakeAndUnlocking);
    ...
    public void setTranslation(float t){
        if(mScrimBehind!=null){
            mScrimBehind.setTranslationY(t);
            mScrimInFront.setTranslationY(t);
            mHeadsUpScrim.setTranslationY(t);
        }
    }
    //add by chenhl end
}
