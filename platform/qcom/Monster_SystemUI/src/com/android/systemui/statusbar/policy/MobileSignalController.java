...
public class MobileSignalController extends SignalController<
    ...
    public void notifyListeners(SignalCallback callback) {
        ...
        if (mCurrentState.dataSim) {
            //qsTypeIcon = showDataIcon ? icons.mQsDataType : 0; //delete by chenhl for don't show on QS
    ...
    class MobilePhoneStateListener extends PhoneStateListener {
        ...
        public void onServiceStateChanged(ServiceState state) {
            ...
            mServiceState = state;
            //modify by chenhl start
            int dataType = state.getDataNetworkType();
            mDataNetType=((dataType == TelephonyManager.NETWORK_TYPE_UNKNOWN))
                    ?state.getVoiceNetworkType():dataType;
        ...
        public void onDataConnectionStateChanged(int state, int networkType) {
            ...
            mDataState = state;
            //modify by chenhl start
            mDataNetType=((networkType == TelephonyManager.NETWORK_TYPE_UNKNOWN))
                    ?mServiceState.getVoiceNetworkType():networkType;
