...
public class KeyguardClockPositionAlgorithm {
    ...
    //Mst: tangjun translate clock: clock's MarginBottom begin
    private int mClockMargin;
    //Mst: tangjun translate clock: clock's MarginBottom end
    ...
    public void loadDimens(Resources res) {
        ...
        //Mst: tangjun translate clock: get Margin of clock  begin
        mClockMargin = res.getDimensionPixelSize(
                R.dimen.mst_clock_padding_bottom);
        //Mst: tangjun translate clock: get Margin of clock  end
    }
    ...
    public void run(Result result) {
        ...
        //Mst: tangjun translate clock: get translationY of clock begin
        //Log.d("ktt", "KeyguardClockPostitionAlgorithm run y=" + y + " clockAdjustment*7.0f=" 
        //     + clockAdjustment*7.0f + " mClockMargin=" + mClockMargin + " getClockNotificationsPadding=" + getClockNotificationsPadding());
        result.translationY = y + getClockNotificationsPadding() + ((int)(clockAdjustment*6.0f)) - mClockMargin;// 
        //Mst: tangjun translate clock: get translationY of clock end
    }
    ...
    public float getClockYExpansionAdjustment2()    {
    	return getClockYExpansionAdjustment();
    }
    //Mst: tangjun add end
    ...
    private float getClockAlpha(float scale) {
        ...
        return (float)Math.pow(MathUtils.constrain(alpha, 0, 1), 2);/// TCL Monster: kth add for clock alpha when slide out 20161026
//        return Math.max(0, Math.min(1, alpha));
    ...
    public static class Result {
        ...
        //Mst: tangjun translate clock: used to adjust clock scroll 2015/06/18 begin
        public int translationY;
        //Mst: tangjun translate clock: used to adjust clock scroll 2015/06/18 end
    }
}
