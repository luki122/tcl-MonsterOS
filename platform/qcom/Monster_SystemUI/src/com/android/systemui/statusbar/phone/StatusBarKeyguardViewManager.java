...
public class StatusBarKeyguardViewManager implements RemoteInputController.Callback {
    ...
    private static final boolean DEBUG_FP = KeyguardConstants.DEBUG;// TCL Monster: kth add for fp debug 20161130
	...
	private boolean mLastSecurityPwd; // TCL Monster: kth add for hide nevagitionbar 20160923
	...
	private boolean mDeviceLocked = true;
	// Mst: tangjun add end
    ...
    public void dismissWithAction(OnDismissAction r, Runnable cancelAction,
        ...
        if (mShowing) {
            ...
            animateCollapsePanels(2.0f);// kth mod for [BUG 3500398] 20161128
        }
        ///kth mod swipe up NotificationPanel and show bouncer when Notifications double-click 
        ///updateState will repeate Swipe up Bouncer Action,PhoneStatusBar will invoke it. 20160826
        ///{@link PhoneStatusBar#dismissKeyguardThenExecute()}.
        ///old: updateStates(); 
		updateStates();
    }
...
//            reset();
    ...
    protected void updateStates() {
		...
		boolean isPswSecurityMode = mBouncer.isPwdSecurity();        ///kth add for hide navigationbar except Password 20160829
        ...
        if ((showing && !occluded) != (mLastShowing && !mLastOccluded) || mFirstUpdate) {
            // TCL Monster: kth add for fp feature handle kg hide when occlude [Defect 3534778] 20161130 start @{
            if (DEBUG_FP) Log.d(TAG, "updateStates: showing=" + showing + " occluded=" + occluded);
		...
		mLastSecurityPwd = isPswSecurityMode;///kth add for hide navigationbar except Password 20160829
    ...
    protected boolean isNavBarVisible() {
		//kth mod  hide navigationbar except Password Security when bouncer showing 20160917 
        //return !(mShowing && !mOccluded) || mBouncer.isShowing() || mRemoteInputActive;
		return !(mShowing && !mOccluded) || (mBouncer.isShowing() && mBouncer.isPwdSecurity()) || mRemoteInputActive;
    }
    ...
    protected boolean getLastNavBarVisible() {
		...
		return !(mLastShowing && !mLastOccluded) || (mLastBouncerShowing && mLastSecurityPwd) || mLastRemoteInputActive;
    }
