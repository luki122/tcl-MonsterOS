...
public class ExpandableNotificationRow extends ActivatableNotificationView {
    ...
    //add by chenhl start
    private int mPortWidth,mHeadsUpPadding;
    //add by chenhl end
    ...
    public void setHeadsUp(boolean isHeadsUp) {
        ...
        //add by chenhl start
        ViewGroup.LayoutParams layoutp = getLayoutParams();
        layoutp.width = mIsHeadsUp ? mPortWidth - mHeadsUpPadding*2 : -1;
    ...
    private void initDimens() {
        ...
        //add by chenhl start
        mPortWidth = getResources().getDimensionPixelSize(R.dimen.tcl_max_statuswind_height_w);
        mHeadsUpPadding = getResources().getDimensionPixelSize(R.dimen.tcl_headsup_padding);
        //add by chenhl end
    ...
    protected void onFinishInflate() {
	    ...
	    mTranslateableViews.remove(mLineView);//add by chenhl
    }
    ...
    public void setTranslation(float translationX) {
        ...
        if (mSettingsIconRow != null) {
            ...
            if(isHeadsUp()){
                mSettingsIconRow.updateSettingsIcons(mSettingsIconRow.getSpaceForGear(), getMeasuredWidth());
            }else {
    ...
    public void setDark(boolean dark, boolean fade, long delay) {
        ...
        if (showing != null) {
            //showing.setDark(dark, fade, delay);//delete by chenhl
        }
        if (mIsSummaryWithChildren) {
            //mChildrenContainer.setDark(dark, fade, delay); //delete by chenhl
        }
    }
    ...
    public void setActualHeight(int height, boolean notifyListeners) {
        ...
        //add by chenhl start
        if(mSettingsIconRow!=null) {
            mSettingsIconRow.setActualHeight(height);
        }
        //add by cehnhl end
    }
    ...
    //add by chenhl start
    public void updateExpandButton(boolean show){
        mPrivateLayout.setShowKeygurad(show);
        mPublicLayout.setShowKeygurad(show);
    }
    //add by chenhl end
}
