...
public class LightStatusBarController {
    ...
    public void onSystemUiVisibilityChanged(int fullscreenStackVis, int dockedStackVis, int mask,
        ...
        //add by chenhl start
        mLastMask = mask;
        mLastSbModeChanged = sbModeChanged;
    ...
    //add by chenhl start
    private boolean mLastSbModeChanged;
    private int mLastStatusBarMode,mLastMask;
    private boolean mPowerSave;
    public void updateByPowerSaveChange(boolean powerSave){
        if(powerSave){
            mIconController.setIconsDark(false, animateChange());
        }else {
            onSystemUiVisibilityChanged(mFullscreenStackVisibility,mDockedStackVisibility,
                    mLastMask,mLastFullscreenBounds,mLastDockedBounds,mLastSbModeChanged,mLastStatusBarMode);
        }
    }
    //add by chenhl end
}
