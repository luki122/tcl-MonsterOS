...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    private ImageView mCusCameraImageView;
    ...
    protected void onFinishInflate() {
        ...
        mCusCameraImageView = (ImageView) findViewById(R.id.camera_button_custom);/// kth add for custom camera icon 20161018
        ...
        mLeftAffordanceView.setVisibility(View.GONE); // TCL Monster: kth mod keyguard requirement 20160810
        mCameraImageView.setVisibility(View.GONE); // TCL Monster: kth mod keyguard requirement 20160810
        mEmergencyButton.setVisibility(View.INVISIBLE); // TCL Monster: kth mod keyguard requirement 20160923
        initAccessibility();
    }
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        mIndicationText.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                getResources().getDimensionPixelSize(
                        R.dimen.kg_carrier_text_size_normal));// TCL Monster: kth mod for carrier text 20161103
        ...
        mCameraImageView.setImageDrawable(mContext.getDrawable(R.drawable.ic_camera_alt_24dp_custom));
        ...
        updateEmergencyButton();
        updateCustomCameraIcon();// TCL Monster: kth add for update camera visible notify setup complete or not 20161124
    }
    ...
    private void updateCustomCameraIcon() {
        mCusCameraImageView.setVisibility(mUserSetupComplete ? View.VISIBLE : View.GONE);
    }
    ...
    public void launchCamera(String source) {
        ...
        intent.setPackage("com.tct.camera");//TCL Monster:kth add for tct camera 20161123
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        mPhoneStatusBar.resetWindowFrameX(false);// TCL Monster: kth mod for optimizing launch accordance camera 20161207
                    }
                    Log.d(TAG, "launchCamera result=" + result);
                    ...
                    post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mPhoneStatusBar.resetWindowFrameX(launched);// TCL Monster: kth mod for optimizing launch accordance camera 20161207
                        }
                    });
                }
            });
            ...
            mActivityStarter.startActivity(intent, false /* dismissShade */,
                    new ActivityStarter.Callback() {
                        ...
                        public void onActivityStarted(int resultCode) {
                            ...
                            mPhoneStatusBar.resetWindowFrameX(true);// TCL Monster: kth mod for optimizing launch accordance camera 20161207
                        }
                    });
        }
    }
...
//                mEmergencyButton.updateEmergencyCallButton();
    ...
    public void onWallpaperChanged(int RGB) {
        mIndicationController.setDefaultColor(RGB);
        mCusCameraImageView.setColorFilter(RGB, PorterDuff.Mode.SRC_IN);
        mLockIcon.setColorFilter(RGB, PorterDuff.Mode.SRC_IN);
    }
