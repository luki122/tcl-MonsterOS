...
//  TCL Monster: kth mod for update QS edit layout 20161010 start @{
        if (isEditMode()) {
            iv.setColorFilter(getContext().getColor(R.color.tcl_qs_tile_tint_edit_icon), PorterDuff.Mode.SRC_IN);
        }
    }
...
//  TCL Monster: kth mod for update QS edit layout 20161010 end @}
