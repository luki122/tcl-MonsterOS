...
public class QSPanel extends LinearLayout implements Tunable, Callback {
    ...
    protected void setupTileLayout() {
        ...
        findViewById(android.R.id.edit).setVisibility(View.GONE);//add by chenhl
    }
    ...
    public void setBrightnessMirror(BrightnessMirrorController c) {
        ...
        mBrightnessController.setMirrorController(c);//add by chenhl
    }
    ...
    protected void addTile(final QSTile<?> tile, boolean collapsedView) {
        ...
        //add by chenhl start
        final View.OnClickListener labelclick = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                r.tile.click();
            }
        };
        r.tileView.setLabelClick(labelclick);
        //add by chenhl end
