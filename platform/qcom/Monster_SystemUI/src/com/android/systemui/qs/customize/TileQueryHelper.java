...
public class TileQueryHelper {
    ...
    private void addSystemTiles(final QSTileHost host) {
        String possible = mContext.getString(R.string.mst_quick_settings_tiles_default); //modify by chenhl
...
/*TCL Monster: kth mod remove Tile Service like (GPU/LayoutProfile) 3q chenhl 20161110
        qsHandler.post(new Runnable() {
            @Override
            public void run() {
                mainHandler.post(new Runnable() {
