...
public class PagedTileLayout extends ViewPager implements QSTileLayout {
    ...
    private MstPageIndicator mPageIndicator;
    ...
    public PagedTileLayout(Context context, AttributeSet attrs) {
        ...
        setOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                mPageIndicator.setLocation(position);//add by chenhl
            }
            ...
            public void onPageScrolled(int position, float positionOffset,
                ...
                //mPageIndicator.setLocation(position + positionOffset);//delete by chenhl
                if (mPageListener != null) {
    ...
    protected void onFinishInflate() {
        ...
        mPageIndicator = (MstPageIndicator) findViewById(R.id.page_indicator);
