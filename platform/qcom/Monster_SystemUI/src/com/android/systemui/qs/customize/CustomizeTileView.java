...
public class CustomizeTileView extends QSTileView {
    ...
    protected void createLabel() {
        super.createLabel();
        /// TCL Monster: kth add for update QS edit layout 20161010 start @{
        mLabel.setTextColor(mContext.getColor(R.color.tcl_qs_tile_tint_edit_label));
        mLabel.setAlpha(0.3f);
        getIcon().setEditMode(true);
        /// end @}
