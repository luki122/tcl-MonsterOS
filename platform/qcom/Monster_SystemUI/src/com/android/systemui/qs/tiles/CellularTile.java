...
public class CellularTile extends QSTile<QSTile.SignalState> {
    static final Intent CELLULAR_SETTINGS = new Intent().setComponent(new ComponentName(
            "com.android.settings", "com.android.settings.Settings$TctDualSimNetworkSettingsActivity"));//modify by chenhl
    ...
    protected void handleClick() {
        ...
        if (mDataController.isMobileDataSupported()) {
            //showDetail(true);
            boolean state = mDataController.isMobileDataEnabled();
            mDataController.setMobileDataEnabled(!state);
            Settings.System.putInt(mContext.getContentResolver(),
                    Settings.System.TCT_DUALSIM_CELLULAR_DATA_ENABLE, !state ? 1 : 0);
        } /*else {
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        final int iconId = cb.noSim ? R.drawable.ic_mst_qs_signal_disabled
                : !cb.enabled || cb.airplaneModeEnabled ? R.drawable.ic_mst_qs_signal_disabled
                : mDataController.isMobileDataEnabled() ? R.drawable.ic_mst_qs_signal_enabled
                : R.drawable.ic_mst_qs_signal_disabled;
        //modify by chenhl end
        ...
        state.activityIn = false;//cb.enabled && cb.activityIn;//modify by chenhl
        state.activityOut = false;//cb.enabled && cb.activityOut;//modify by chenhl

        //modify by chenhl start
        /*state.label = cb.enabled
                ? removeTrailingPeriod(cb.enabledDesc)
                : r.getString(R.string.quick_settings_rssi_emergency_only);*/
        state.label = r.getString(R.string.tcl_data_switch);
        //modify by chenhl end
