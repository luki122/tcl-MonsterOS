...
public class RotationLockTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (rotationLocked) {
            ...
            state.icon = ResourceIcon.get(R.drawable.ic_mst_rotate_enable);//portrait ? mAutoToPortrait : mAutoToLandscape;//modify by chenhl
        } else {
            state.label = mContext.getString(R.string.quick_settings_rotation_unlocked_label);
            state.icon = ResourceIcon.get(R.drawable.ic_mst_rotate_disable);
            //portrait ? mPortraitToAuto : mLandscapeToAuto;//modify by chenhl
        }
