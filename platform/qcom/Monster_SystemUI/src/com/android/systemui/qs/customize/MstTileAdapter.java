...
import com.android.systemui.qs.customize.MstTileAdapter.Holder;
 ...
 */
public class MstTileAdapter extends RecyclerView.Adapter<Holder> implements TileStateListener {
    ...
    public MstTileAdapter(Context context) {
        mContext = context;
    ...
    public void onTilesChanged(List<TileInfo> tiles) {
        mAllTiles = tiles;
        Log.d("TileAdapter", "onTilesChanged: tiles.size" + tiles.size());
        recalcSpecs();
    }

    private void recalcSpecs() {
        Log.d("TileAdapter", "recalcSpecs: mAllTiles=" + mAllTiles + "--mCurrentSpecs=" + mCurrentSpecs);
        ...
        Log.d("TileAdapter", "recalcSpecs: mTiles=" + mTiles.toString() + " mTileDividerIndex=" + mTileDividerIndex);
    ...
    public void onBindViewHolder(final Holder holder, int position) {
        ...
        // TCL Monster: kth mod for edit qstile icon 20161125 start
//old:        holder.mTileView.onStateChanged(info.state);
        holder.mTileView.onStateChangedEditMode(info.state);
        resetMstQSCustomIcon((ImageView)holder.mTileView.getIcon().getIconView(), info.spec);
        // TCL Monster: kth mod for edit qstile icon 20161125 end
    ...
    // TCL Monster: kth mod for edit qstile icon 20161125 start
    private void resetMstQSCustomIcon (ImageView imgView, String tileSpec) {
        Drawable drawable = null;
        if (tileSpec.equals("wifi")) drawable = mContext.getDrawable(R.drawable.ic_qs_wifi_full_4);
        else if (tileSpec.equals("bt")) drawable = mContext.getDrawable(R.drawable.ic_mst_qs_bluetooth_on);
        else if (tileSpec.equals("cell")) drawable = mContext.getDrawable(R.drawable.ic_mst_qs_signal_enabled);
        else if (tileSpec.equals("dnd")) drawable = mContext.getDrawable(R.drawable.ic_qs_dnd_on);
        else if (tileSpec.equals("inversion")) drawable = mContext.getDrawable(R.drawable.ic_invert_colors_enable);
        else if (tileSpec.equals("airplane")) drawable = mContext.getDrawable(R.drawable.ic_mst_signal_airplane_enable);
         /* MODIFIED-BEGIN by Wang Xiongke, 2016-09-28,BUG-3005175*/
            ...
            if (SmartContainerConfig.WITH_OUT_VIRTUAL_BOX) {
                drawable = mContext.getDrawable(R.drawable.ic_signal_workmode_enable);
            }
        }
        //SmartContainer modify end
        /* MODIFIED-END by Wang Xiongke,BUG-3005175*/
        //patch clone app add end
        else if (tileSpec.equals("rotation")) drawable = mContext.getDrawable(R.drawable.ic_mst_rotate_enable);
        else if (tileSpec.equals("flashlight")) drawable = mContext.getDrawable(R.drawable.ic_mst_signal_flashlight_enable);
        else if (tileSpec.equals("location")) drawable = mContext.getDrawable(R.drawable.ic_mst_signal_location_enable);
        else if (tileSpec.equals("cast")) drawable = mContext.getDrawable(R.drawable.ic_mst_qs_cast_on);
        else if (tileSpec.equals("hotspot")) drawable = mContext.getDrawable(R.drawable.ic_mst_hotspot_enable);
        else if (tileSpec.equals("battery")) drawable = mContext.getDrawable(R.drawable.ic_mst_powersaver_enable);
        else if (tileSpec.equals("saver")) drawable = mContext.getDrawable(R.drawable.ic_data_saver);
        else if (tileSpec.equals("mute")) drawable = mContext.getDrawable(R.drawable.ic_mst_mute_enable);
        else if (tileSpec.equals("vibration")) drawable = mContext.getDrawable(R.drawable.ic_mst_vibrate_enable);
        else if (tileSpec.equals("nfc")) drawable = mContext.getDrawable(R.drawable.ic_mst_qs_nfc_enable);
        else if (tileSpec.equals("vpn")) drawable = mContext.getDrawable(R.drawable.ic_mst_qs_vpn_enable);
        else if (tileSpec.equals("secretletter")) drawable = mContext.getDrawable(R.drawable.ic_mst_qs_secret_enable);
        else if (tileSpec.equals("hidebar")) drawable = mContext.getDrawable(R.drawable.ic_mst_navigationbar_show);
        else {
            Log.w("MstTileAdapter", "Bad tile spec: " + tileSpec);
            drawable = null;
        }
        if (drawable != null) {
            imgView.setImageDrawable(drawable);
            imgView.setColorFilter(mContext.getColor(R.color.tcl_qs_tile_tint_edit_icon), PorterDuff.Mode.SRC_IN);
    ...
    public class Holder extends ViewHolder {
        ...
        public void clearDrag() {
            ...
            mTileView.findViewById(R.id.tile_label).setAlpha(.3f);
    ...
    private final ItemDecoration mDecoration = new ItemDecoration() {
        ...
        private final ColorDrawable mDrawable = new ColorDrawable(0xfffafafa);
