...
public class CastTile extends QSTile<QSTile.BooleanState> {
    ...
    public CastTile(Host host) {
        ...
        //add by chenhl start
        mSetting = new GlobalSetting(mContext, mHandler, Settings.Global.WIFI_DISPLAY_ON) {
            @Override
    ...
    public void setListening(boolean listening) {
        ...
        mSetting.setListening(listening);//add by chenhl
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        //add by chenhl start
        state.value=checkCast();
        //add by chenhl end
        state.icon = ResourceIcon.get(state.value ? R.drawable.ic_mst_qs_cast_on
                : R.drawable.ic_mst_qs_cast_off/*R.drawable.ic_qs_cast_on
                : R.drawable.ic_qs_cast_off*/);//modify by chenhl
    ...
    private void setCastEnable(boolean is){
        Settings.Global.putInt(mContext.getContentResolver(),
                Settings.Global.WIFI_DISPLAY_ON, is?1:0);
    }
    //add by chenhl end
}
