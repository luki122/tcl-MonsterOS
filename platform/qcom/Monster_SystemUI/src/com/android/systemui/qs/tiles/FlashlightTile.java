...
public class FlashlightTile extends QSTile<QSTile.BooleanState> implements
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (!mFlashlightController.isAvailable()) {
            Drawable icon = mHost.getContext().getDrawable(R.drawable.ic_mst_signal_flashlight_disable)//modify by chenhl
                    .mutate();
        ...
        state.icon = ResourceIcon.get(state.value ?R.drawable.ic_mst_signal_flashlight_enable:
                R.drawable.ic_mst_signal_flashlight_disable);//icon;//modify by chenhl
