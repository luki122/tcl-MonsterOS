...
public class BatteryTile extends QSTile<QSTile.State> implements BatteryController.BatteryStateChangeCallback {
    ...
    protected void handleUpdateState(State state, Object arg) {
        ...
        //modify by chenhl start
        state.icon = ResourceIcon.get(mPowerSave?R.drawable.ic_mst_powersaver_enable:
                R.drawable.ic_mst_powersaver_disable);
        if(mCharging){
            state.label = mContext.getString(R.string.tcl_charging);
        }else{
            state.label = mContext.getString(R.string.tcl_save_battery);
        }
        //modify by chenhl end
