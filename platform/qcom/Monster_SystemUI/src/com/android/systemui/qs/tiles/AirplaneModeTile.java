...
public class AirplaneModeTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (airplaneMode) {
            state.icon = ResourceIcon.get(R.drawable.ic_mst_signal_airplane_enable);//mEnable; //modify by chenhl
        } else {
            state.icon = ResourceIcon.get(R.drawable.ic_mst_signal_airplane_disable);//mDisable; //modify by chenhl
        }
