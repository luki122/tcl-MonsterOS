...
public class HotspotTile extends QSTile<QSTile.AirplaneBooleanState> {
    ...
    protected void handleClick() {
        ...
        //add by chenhl start
        mState.icon = ResourceIcon.get(mState.value?R.drawable.ic_mst_hotspot_disable
                :R.drawable.ic_mst_hotspot_enable);
        handleStateChanged();
        //add by chenhl end
    }
    ...
    protected void handleUpdateState(AirplaneBooleanState state, Object arg) {
        ...
        state.icon = ResourceIcon.get(state.value ? R.drawable.ic_mst_hotspot_enable:
                R.drawable.ic_mst_hotspot_disable);//mEnable : mDisable;//modify by chenhl
