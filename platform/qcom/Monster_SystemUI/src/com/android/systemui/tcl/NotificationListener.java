...
public class NotificationListener extends NotificationListenerService {
    ...
    private void setScripWhiteListDefault() {
        SharedPreferences preferences = mContext.getSharedPreferences("notify_settings", MODE_PRIVATE);
        boolean hasSet = preferences.getBoolean("scrip_white_has_set", false);
        if (!hasSet) {
            ...
            editor.putBoolean("scrip_white_has_set", true);
            editor.commit();
        }
    }
    ...
    private class PackageIntentReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_PACKAGE_ADDED.equals(actionStr)) {
                ...
                SpamNotifyHandle.getInstance(mContext).updateWdjNotifyClearGroups(pkgName);
            }
        }
    }
}
