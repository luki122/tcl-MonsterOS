...
public class Utils {
    ...
    public static String getAppLabel(Context context, String pkg, int uid) {
        final PackageManager pm = context.getPackageManager();
        final PackageInfo info = Utils.findPackageInfo(pm, pkg, uid);
        CharSequence label = "";
        try {
            label = info.applicationInfo.loadLabel(pm);
        } catch (Throwable t) {
        }
