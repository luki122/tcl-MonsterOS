...
public class NotificationManageActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private List<String> noDisplayPackage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        noDisplayPackage = getNoDisplayPackage();
    ...
    private class LoadAppEntryTask extends AsyncTask {
        ...
        private boolean filterApp(AppEntry entry) {
            if (noDisplayPackage.contains(entry.info.packageName)) {
                return false;
            }
    ...
    private List<String> getNoDisplayPackage() {
        //产品要求不显示的应用
        List<String> nodisplay = new ArrayList<>();
        nodisplay.add("com.monster.privacymanage");//隐私空间
        return nodisplay;
    }
}
