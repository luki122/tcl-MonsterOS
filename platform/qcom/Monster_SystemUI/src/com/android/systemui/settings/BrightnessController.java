...
import com.android.systemui.statusbar.policy.AutoBrightnessControllerImpl;
...
public class BrightnessController implements ToggleSlider.Listener {
    ...
    //add by chenhl start
    private final AutoBrightnessController mAutoController;
    //add by chenhl end
    ...
    public BrightnessController(Context context, ImageView icon, ToggleSlider control) {
        ...
        //add by chenhl start
		mAutoController = new AutoBrightnessControllerImpl(mContext);
        mIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean isChecked = mAutoController.isAutoBrightnessEnabled();
                mAutoController.setAutoBrightnessEnabled(!isChecked);
            }
        });
        //add by chenhl end
    }
    ...
    private void updateIcon(boolean automatic) {
        if (mIcon != null) {
            mIcon.setImageResource(automatic && SHOW_AUTOMATIC_ICON ?
                    com.android.systemui.R.drawable.ic_mst_qs_brightness_auto_on :
                    com.android.systemui.R.drawable.ic_mst_qs_brightness_auto_off); //modify by chenhl
        }
        //add by chenhl start
        if(mMirrorController!=null){
            mMirrorController.updateAutoBrightnessIcon(automatic);
        }
        //add by chenhl end
    }
