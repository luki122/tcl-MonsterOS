        ...
        public void onSimStateChanged(int subId, int slotId, IccCardConstants.State simState) {
            ...
            switch (simState) {
                ...
                case ABSENT:
                    ...
                    synchronized (this) {
                        // TCL Monster: kth mod for [BUG 3673273] reset and dismiss sim security view when absent sim card 20161207 start @{
//                        if (shouldWaitForProvisioning()) {
                            if (!mShowing) {
                                ...
                                Log.d(TAG, "sim card ABSENT resetStateLocked");
                                resetStateLocked();
                            }
//                        } end @}
                    }
    ...
    private final Runnable mKeyguardGoingAwayRunnable = new Runnable() {
        ...
        public void run() {
            try {
                ...
                int flags = 0;
                ///TCL Monster: kth mod for UX test failed and remove anim 20161129 start
/*                if (mStatusBarKeyguardViewManager.shouldDisableWindowAnimationsForUnlock()
                ...
                flags |= WindowManagerPolicy.KEYGUARD_GOING_AWAY_FLAG_NO_WINDOW_ANIMATIONS;
                ///TCL Monster: kth mod for UX test failed and remove anim 20161129 end
    ...
    private void handleStartKeyguardExitAnimation(long startTime, long fadeoutDuration) {
        synchronized (KeyguardViewMediator.this) {
            ...
            if (TelephonyManager.EXTRA_STATE_IDLE.equals(mPhoneState)) {
                ///TCL Monster: kth mod for [BUG 3575456] Alarm Clock repeat several times 20161128 start @{
                if (!mOccluded) {
                    playSounds(false);
                }
                /// end @}
