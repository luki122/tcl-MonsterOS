...
public class AnalogClock extends View {
    ...
    public AnalogClock(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDial = r.getDrawable(R.drawable.tcl_clock_analog_dial);
        mHourHand = r.getDrawable(R.drawable.tcl_clock_analog_hour);
        mMinuteHand = r.getDrawable(R.drawable.tcl_clock_analog_minute);
        mSecondHand = r.getDrawable(R.drawable.tcl_clock_analog_second);
    ...
    public void setMainClock(){//设置为时钟主界面的时钟
        Resources r = mContext.getResources();
        mDial = r.getDrawable(R.drawable.main_dial);
        mHourHand = r.getDrawable(R.drawable.main_hou);
        mMinuteHand = r.getDrawable(R.drawable.main_min);
        mSecondHand = r.getDrawable(R.drawable.main_sec);
