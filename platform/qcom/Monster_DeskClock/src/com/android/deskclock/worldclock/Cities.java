...
public class Cities {
    ...
    public static void saveCityToSharedPrefs(SharedPreferences prefs, CityObj city) {
        int count = prefs.getInt(NUMBER_OF_CITIES,0) + 1;//要从０开始
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(NUMBER_OF_CITIES, count);
        city.saveCityToSharedPrefs(editor, count-1);
        editor.apply();
    }
