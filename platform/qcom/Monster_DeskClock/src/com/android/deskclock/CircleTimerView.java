...
public class CircleTimerView extends View {
    ...
    public void startIntervalAnimation() {
        ...
        invalidate();
        mPaused = false;
        Log.i("zouxu","startIntervalAnimation!!!!!");
    }
...
//        Log.i("zouxu","onDraw mIntervalStartTime="+mIntervalStartTime+",mPaused="+mPaused+",mAnimate="+mAnimate);
        ...
        if (mIntervalStartTime == -1) {
            ...
            if(is_time_up){//add zouxu 20160907 有时时间到的时候还会画一小段弧线
                redPercent = 1;
                is_time_up = false;
            }
