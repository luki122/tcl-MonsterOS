...
public class TimerReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        Log.i("zouxu","TimerReceiver! actionType = "+actionType);

        Log.i("TimerReceiver_my", "TimerReceiver actionType="+actionType);
...
//        if(true){//屏蔽原生闹铃注册并发生TIMES_UP广播方法 该方法再设置时间小于６秒的时候接受到TIMES_UP广播慢
//            return;
//        }
