            ...
            for (int i = 0; i < mAdapter.getCount(); i++) {
                ...
                if (t.mState == TimerObj.STATE_RUNNING || t.mState == TimerObj.STATE_TIMESUP) {
                    ...
                    if (t.mView != null) {
                        ...
                        Log.i("zouxu"," t.mView.setTime(timeLeft, false); timeLeft="+timeLeft);
...
//                mFab.setImageResource(R.drawable.ic_fab_pause);
                mFab.setIconDrawable(getActivity().getResources().getDrawable(R.drawable.ic_fab_pause));
                break;
...
//                mFab.setImageResource(R.drawable.ic_fab_play);
                mFab.setIconDrawable(getActivity().getResources().getDrawable(R.drawable.ic_fab_play));
                break;
...
//                mFab.setImageResource(R.drawable.ic_fab_stop);
                mFab.setIconDrawable(getActivity().getResources().getDrawable(R.drawable.ic_fab_stop));
                break;
            default:
        }
    }
