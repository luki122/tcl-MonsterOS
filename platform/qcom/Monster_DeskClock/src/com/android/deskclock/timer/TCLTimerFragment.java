...
//    private TextView text3;
    ...
    private FloatingActionButton img_cancle;
    private FloatingActionButton img_pause;
    private FloatingActionButton img_cancle_center;
...
//        text3 = (TextView) view.findViewById(R.id.text3);
        ...
        img_pause = (FloatingActionButton) view.findViewById(R.id.img_pause);
        img_cancle_center = (FloatingActionButton) view.findViewById(R.id.img_cancle_center);

        img_start = (FloatingActionButton) view.findViewById(R.id.img_start);
        img_cancle = (FloatingActionButton) view.findViewById(R.id.img_cancle);
