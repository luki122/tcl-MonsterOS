...
public class TimerSetupView extends LinearLayout implements Button.OnClickListener,
    ...
    protected FloatingActionButton mStart;
...
//    private TextView text3;
    ...
    public TimerSetupView(Context context, AttributeSet attrs, int defStyle) {
...
//        text3.setOnClickListener(this);
        ...
        for (int i = 0; i < 10; i++) {
            ...
            mNumbers[i].setTextColor(getContext().getColor(R.color.text_gray));
            mNumbers[i].setTag(R.id.numbers_key, new Integer(i));
        }
        updateTime();
    }

    public void registerStartButton(FloatingActionButton start) {
        mStart = start;
