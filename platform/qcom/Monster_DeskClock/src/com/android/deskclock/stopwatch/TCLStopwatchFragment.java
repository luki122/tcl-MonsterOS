...
public class TCLStopwatchFragment extends DeskClockFragment implements OnSharedPreferenceChangeListener,
    ...
    private TextView text_count_reset;
    private TextView text_play_stop;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        text_count_reset = (TextView) v.findViewById(R.id.text_count_reset);
        text_play_stop = (TextView) v.findViewById(R.id.text_play_stop);
    ...
    public void setFabAppearance() {
        ...
        if (mState == Stopwatches.STOPWATCH_RUNNING) {
            ...
            // mFab.setContentDescription(getString(R.string.sw_stop_button));
             ...
             text_play_stop.setText(R.string.str_pause);
