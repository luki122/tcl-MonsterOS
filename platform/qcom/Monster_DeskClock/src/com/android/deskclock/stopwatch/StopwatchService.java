...
public class StopwatchService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch(actionType) {
            case HandleDeskClockApiCalls.ACTION_START_STOPWATCH:
                ...
                prefs.edit().putBoolean (Stopwatches.KEY + TCLStopWatchCircleTimerView.IS_ANIM, true).apply();// add zouxu 20160914 开始动画
            ...
            case HandleDeskClockApiCalls.ACTION_STOP_STOPWATCH:
                ...
                prefs.edit().putBoolean (Stopwatches.KEY + TCLStopWatchCircleTimerView.IS_ANIM, false).apply();// add zouxu 20160914 停止动画
    ...
    private void writeSharedPrefsStopped(long elapsedTime, boolean updateCircle) {
        ...
        if (updateCircle) {
            ...
            editor.putBoolean (Stopwatches.KEY + TCLStopWatchCircleTimerView.IS_ANIM, false);// add zouxu 20160914 停止动画
            editor.apply();
        }
    }
