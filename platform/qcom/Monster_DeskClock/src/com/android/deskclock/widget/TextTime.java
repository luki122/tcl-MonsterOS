...
public class TextTime extends TextView {
    ...
    private void chooseFormat() {
        ...
        Log.i("zouxu", " chooseFormat mFormat24 = "+mFormat24+",mFormat12 = "+mFormat12+",mFormat = "+mFormat);
...
//        if(m_context !=null){
//            mFormat = Utils.get12ModeFormat(m_context, m_context.getResources().getDimensionPixelSize(R.dimen.label_font_size));//和世界时钟保持一致
//        }
        
        CharSequence text = DateFormat.format(mFormat, calendar);
        Log.i("zouxu", " updateTime mFormat = "+mFormat+",text = "+text);
        setText(text);
