 ...
 */
public abstract class AlarmClockFragmentOrg extends DeskClockFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.alarm_clock_org, container, false);
    ...
    private class AlarmItemAdapter extends CursorAdapter {
        ...
        private long mScrollAlarmId = AlarmClockFragmentOrg.INVALID_ID;
        private final Runnable mScrollRunnable = new Runnable() {
            @Override
            public void run() {
                if (mScrollAlarmId != AlarmClockFragmentOrg.INVALID_ID) {
                    View v = getViewById(mScrollAlarmId);
                    if (v != null) {
                        Rect rect = new Rect(v.getLeft(), v.getTop(), v.getRight(), v.getBottom());
                        mList.requestChildRectangleOnScreen(v, rect, false);
                    }
                    mScrollAlarmId = AlarmClockFragmentOrg.INVALID_ID;
                }
            }
        };
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            final View view = mFactory.inflate(R.layout.alarm_time_org, parent, false);
            setNewHolder(view);
            return view;
        }
        ...
        private void bindExpandArea(final ItemHolder itemHolder, final Alarm alarm) {
            ...
            itemHolder.repeat.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    final Calendar oldNextAlarmTime = alarm.getNextAlarmTime(now,getActivity());
                    ...
                    final Calendar newNextAlarmTime = alarm.getNextAlarmTime(now,getActivity());
        ...
        private void collapseAlarm(final ItemHolder itemHolder, boolean animate) {
            mExpandedId = AlarmClockFragmentOrg.INVALID_ID;
    ...
    private void asyncDeleteAlarm(final Alarm alarm) {
        final Context context = AlarmClockFragmentOrg.this.getActivity().getApplicationContext();
...
//        mFab.setImageResource(R.drawable.ic_fab_plus);
        mFab.setIconDrawable(getActivity().getResources().getDrawable(R.drawable.ic_fab_plus));
