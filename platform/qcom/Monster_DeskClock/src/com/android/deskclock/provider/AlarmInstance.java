...
public final class AlarmInstance implements ClockContract.InstancesColumns {
    ...
    public static boolean deleteInstance(ContentResolver contentResolver, long instanceId) {
        ...
        Uri m_uri = getUri(instanceId);//content://com.android.deskclock/instances/1
        int deletedRows = contentResolver.delete(m_uri, "", null);
        Log.i("zouxu", "deleteInstance deletedRows="+deletedRows);
