...
public final class DaysOfWeek {
    ...
    private String toString(Context context, int firstDay, boolean forAccessibility) {
        ...
        ret.append(context.getString(R.string.str_week));
        ret.append(" ");
...
//                dfs.getShortWeekdays();
                String[] dayList = new String[DAYS_IN_A_WEEK+1];
                dayList[0]= "";
                dayList[1] = context.getString(R.string.str_sunday_short);
                dayList[2] = context.getString(R.string.str_monday_short);
                dayList[3] = context.getString(R.string.str_tuesday_short);
                dayList[4] = context.getString(R.string.str_wednesday_short);
                dayList[5] = context.getString(R.string.str_thursday_short);
                dayList[6] = context.getString(R.string.str_friday_short);
                dayList[7] = context.getString(R.string.str_saturday_short);
...
//                if (dayCount > 0) ret.append(context.getText(R.string.day_concat));
                if (dayCount > 0) ret.append(" ");//之前是用逗号分割　现在用空格
            }
        }
        return ret.toString();
    }
