...
public class DigitalWidgetViewsFactory implements RemoteViewsFactory {
    ...
    private class RemoteWorldClockAdapter extends WorldClockAdapter {
        ...
        private Context mContext;//zouxu 20161102
        ...
        public RemoteViews getViewAt(int position) {
            ...
            updateView(views, (CityObj) mCitiesList.get(index), R.id.left_clock,
            ...
            if (index + 1 < mCitiesList.size()) {
                updateView(views, (CityObj) mCitiesList.get(index + 1), R.id.right_clock,
            ...
            int lastRow = ((mCitiesList.size() + 1) / 2) - 1;
            if (position == lastRow) {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        if (v != null) {
            ...
            fillInIntent.setClass(mContext, DeskClock.class);
            fillInIntent.putExtra(DeskClock.SELECT_TAB_INTENT_EXTRA,1);
