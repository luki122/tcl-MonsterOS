...
//            Intent i_world_clock =new Intent(context,DeskClock.class);
            Intent i_clock =new Intent(context,DeskClock.class);
//            i_world_clock.putExtra(DeskClock.SELECT_TAB_INTENT_EXTRA,1);


            widget.setOnClickPendingIntent(R.id.digital_clock,
                    PendingIntent.getActivity(context, 0, i_clock, 0));

//            widget.setOnClickPendingIntent(R.id.list_layout,
//                    PendingIntent.getActivity(context, 0, i_world_clock, 0));
        }
...
//                        getActivity(context, 0, new Intent(context, CitiesActivity.class), 0));
        ...
        i.putExtra(DeskClock.SELECT_TAB_INTENT_EXTRA,1);
        widget.setPendingIntentTemplate(R.id.digital_appwidget_listview,
                PendingIntent.
                        getActivity(context, 0, i, 0));//chg zouxu 20161014
