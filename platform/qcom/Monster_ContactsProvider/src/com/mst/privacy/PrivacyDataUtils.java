...
public class PrivacyDataUtils {
    ...
    public static int[] getPrivateData(Uri uri) {
        ...
        if (url.startsWith("content://com.android.contacts/contacts/lookup/")
            ...
            long RawContactId = queryForRawContactId(ContactsProvidersApplication.getInstance().getContentResolver(), Long.parseLong(uri
                    .getLastPathSegment()));
            ...
            Cursor c = ContactsProvidersApplication.getInstance()
                    .getContentResolver()
            ...
            Cursor cursor = ContactsProvidersApplication.getInstance()
                    .getContentResolver()
                    .query(uri,
    ...
    public static long getDataIdByRawContactId(long rawContactId) {
        ...
        Cursor cursor = ContactsProvidersApplication.getInstance().getContentResolver().query(Data.CONTENT_URI,
                new String[] {Data._ID},
    ...
    public static String getPrivateRingNotificationText(long accountId) {
        ...
        String defaultText = ContactsProvidersApplication.getInstance()
