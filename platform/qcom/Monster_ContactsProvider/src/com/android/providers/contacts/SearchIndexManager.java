...
//        	Log.d(TAG,"appendNameFromColumn:"+columnName);
            appendName(getString(columnName));
        }

        public void appendName(String name) {
//        	Log.d(TAG,"appendName:"+name);
...
//        	Log.d(TAG,"appendNameInternal:"+name);
            if (mSbName.length() != 0) {
                mSbName.append(' ');
            }
...
//    	Log.d(TAG,"buildAndInsertIndex,selection:"+selection);
        mSb.setLength(0);
        ...
        int count = 0;
//        Log.d(TAG,"query111,table:"+Tables.DATA_JOIN_MIMETYPE_RAW_CONTACTS+" columns:"+Arrays.toString(ContactIndexQuery.COLUMNS)
//        		+" selection:"+selection+" orderBy:"+mSb.toString());
