...
public class DataRowHandlerForStructuredName extends DataRowHandler {
    private static final String TAG = "DataRowHandlerForStructuredName";
    ...
    public long insert(SQLiteDatabase db, TransactionContext txContext, long rawContactId,
        ...
        DialerSearchSupport.getInstance(mContext).handleContactsInserted(db,
                rawContactId, dataId, name, StructuredName.CONTENT_ITEM_TYPE);
        /** @} */
...
//    	Log.d(TAG,"appendSearchableData:"+builder);
...
//        Log.d(TAG,"phoneticFamily:"+phoneticFamily+" phoneticMiddle:"+phoneticMiddle+" phoneticGiven:"+phoneticGiven);
...
//            Log.d(TAG,"phoneticName:"+phoneticName);
            int phoneticNameStyle = builder.getInt(StructuredName.PHONETIC_NAME_STYLE);
//            Log.d(TAG,"phoneticNameStyle:"+phoneticNameStyle);
