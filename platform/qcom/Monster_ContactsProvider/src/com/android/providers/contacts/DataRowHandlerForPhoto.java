        ...
        if (originalPhoto != null) {
            try {
                ...
                if (photoFileId != 0) {
                    ...
                    /** M: Bug Fix for ALPS01676312 @{ */
                } else if (values.containsKey(Photo.PHOTO_FILE_ID)) {
                    int originalPhotoId = values.getAsInteger(Photo.PHOTO_FILE_ID);
                    values.put(Photo.PHOTO_FILE_ID, originalPhotoId);
                    /** @} */
                } else {
                    values.putNull(Photo.PHOTO_FILE_ID);
                }
