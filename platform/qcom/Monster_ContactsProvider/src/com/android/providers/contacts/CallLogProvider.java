...
import com.mst.dialersearch.DialerSearchHelperForMst.CallLogQuery;
...
public class CallLogProvider extends ContentProvider {
    ...
    static {
        ...
        sURIMatcher.addURI(CallLog.AUTHORITY, "mstcallsjoindataview", REJECT_CALLS_JION_DATA_VIEW);
    }
...
//        setMoMSPermission(SubPermissions.QUERY_CALL_LOG, SubPermissions.MODIFY_CALL_LOG);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case USEFUL_NUMBER:{
            	Cursor cursor=db.query("mst_useful_number", 
    					null, 
    					null, 
    					null, 
    					null,
    ...
    //add by liyang begin
    private static final String MST_PRIVATE_ID = "privacy_id";
    private String parseCallLogSelection(String selection, boolean flag) {
		...
		if (!TextUtils.isEmpty(sel)) {
			if (!sel.contains(MST_PRIVATE_ID)) {
				sel = "(" + sel + ") AND " + MST_PRIVATE_ID + defaultStr;
			}
		} else {
			sel = MST_PRIVATE_ID + defaultStr;
		}
