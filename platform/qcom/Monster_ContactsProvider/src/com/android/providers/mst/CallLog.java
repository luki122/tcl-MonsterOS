...
import com.android.providers.mst.ContactsContract.CommonDataKinds.Callable;
...
//Porting WifiCall IR94 Interface which Gapp needeed
        /* { PR2125778 '''[WFC][MTR][CSL]Call Log''' bob.shen 2016-05-19 */

        /**
         * @hide
         */
        public static final String RAT_TYPE = "rat_type";
        /** Call log rat type for calls. */

        /**
         * @hide
         */
        public static final int CSFB_TYPE = 1;

        /**
         * @hide
         */
        public static final int VOLTE_TYPE = 2;

        /**
         * @hide
         */
        public static final int VILTE_TYPE = 3;

        /**
         * @hide
         */
        public static final int VOWIFI_TYPE = 4;
        /* { PR2125778 bob.shen 2016-05-19 */
...
//Porting WifiCall IR94 Interface which Gapp needeed
            /* { PR2125778 '''[WFC][MTR][CSL]Call Log''' bob.shen 2016-05-19 */
            int ratType = Calls.CSFB_TYPE;
            try {
                TelephonyManager teleMgr = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
                boolean isImsRegisterd = teleMgr.isImsRegistered();
                if (isImsRegisterd) {
                    if (teleMgr.isVolteAvailable()) {
                        ratType = VOLTE_TYPE;
                    } else if (teleMgr.isWifiCallingAvailable()) {
                        ratType = VOWIFI_TYPE;
                    }
                }
            } catch (Exception e) {
