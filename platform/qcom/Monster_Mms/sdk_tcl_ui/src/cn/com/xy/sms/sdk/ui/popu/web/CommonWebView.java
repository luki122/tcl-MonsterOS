...
public class CommonWebView extends WebView {
    ...
    private void invokeMethod(String method, String param) {
        ...
        try {
            ...
            SmartSmsSdkUtil.smartSdkExceptionLog("CommonWebView error:", e);
        }
    }

    /**
     * 若要删除JavaScript，请调用该方法 注意：切记不要调用RemoveJavaScriptInterface，否则会有异常
     * 
     * 原因： Android 2.x的RemoveJavaScriptInterface不能直接访问，必须通过反射，更不能用Super来调用。
