    ...
    public static void setBotton(final Activity context, View button, final TextView buttonText,
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /* NUBIA-109 zhaoxiachao 20161114 start */
                Boolean clickAble = Boolean.TRUE;
                if(extend != null && !extend.isEmpty()){
                    clickAble = (Boolean) extend.get(ContentUtil.ISCLICKABLE);
                    Boolean resultObj = (Boolean) mUiInterface.doUiAction(ViewManger.UIPART_ACTION_SIMPLE_BOTTOM_CLICK_ABLE, null);
                    if((clickAble != null && clickAble.equals(Boolean.FALSE)) && (resultObj!=null && resultObj.equals(Boolean.TRUE))){
                        return ;
                    }
                }
                /* NUBIA-109 zhaoxiachao 20161114 end */
                ...
                OnBottomClick onClick = new OnBottomClick() {
                    @Override
                ...
                Object objShowAlertDialog = mUiInterface.doUiActionMulti(ViewManger.UIPART_ACTION_SHOW_ALERT_DIALOG, jsonArray, context, 0, onClick);
                if (objShowAlertDialog !=null && Boolean.TRUE.equals(objShowAlertDialog)) {
                    return ;
                }
                
                final MoreButtonDataDialog selectDialog = new MoreButtonDataDialog(jsonArray, context, 0);
                selectDialog.ShowDialog(onClick);
            }
        });
    }
