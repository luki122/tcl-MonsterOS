...
public class XYComponseManager {
    ...
    public void loadMenu(IXYSmartSmsHolder xiaoYuanSmsHolder, String recipientNumber) {
        if(DEBUG) Log.d(TAG, "XYComponseManager loadMenu(), recipientNumber = "+recipientNumber);
    ...
    /*private void hideInputMethod() {
        View focusView = mCtx.getCurrentFocus();
        if(focusView != null){
    ...
    public void hideXYMenu() {
        if(DEBUG) Log.d(TAG, "XYComponseManager, hideXYMenu()");
    ...
    private void initMenu() {
        if (mXYSmsHolder == null) {
            Log.w(TAG, XYComponseManager.class.getName()
                    + "initSmartSmsMenuManager iSmartSmsUIHolder is null");
            return;
        }
        if (mCtx == null) {
            Log.w(TAG, XYComponseManager.class.getName()
                    + "initSmartSmsMenuManager iSmartSmsUIHolder.getActivityContext() is null");
            return;
        }
        if(DEBUG) Log.i(TAG, XYComponseManager.class.getName() + " --------initMenu ------------");
    ...
    private void dataInit(final String recipientNumber, final Activity ctx,
            final IXYSmartSmsHolder xiaoYuanSmsHolder) {
        if(DEBUG) Log.i(TAG, XYComponseManager.class.getName() + " ------dataInit --------------");
    ...
    private void loadBubbleData(final String recipientNumber) {
        if(DEBUG) Log.i(TAG, XYComponseManager.class.getName() + " -------loadBubbleData --------");
        if (mCtx == null) {
            return;
        }
        mDataInitPool.execute(new Runnable() {
    ...
    private void bindMenuView(JSONArray jsonCustomMenu, final Activity ctx)
        ...
        if(DEBUG) Log.i(TAG, XYComponseManager.class.getName() + "-----bindMenuView-------");
