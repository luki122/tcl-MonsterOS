...
public class MmsConfig {
    ...
    //tangyisen modify
    private static final int MAX_IMAGE_HEIGHT = Integer.MAX_VALUE;//480;
    private static final int MAX_IMAGE_WIDTH = Integer.MAX_VALUE;//640
    ...
    //lichao add for test
    public static final String TEST_PHONE_NUMBERS = "15013875455, 15019467235, 18682301353, 18658275708";
    public static final String TELECOM_OPERATORS_PHONE_NUMBERS = "10086, 10010, 10000";
