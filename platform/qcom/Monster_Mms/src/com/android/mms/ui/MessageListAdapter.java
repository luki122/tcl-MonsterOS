...
public class MessageListAdapter extends CursorAdapter {
    ...
    static final int COLUMN_MMS_EXTRA          = 26;
    static final int COLUMN_MMS_SUB_ID          = 27;
    static final int COLUMN_RECIPIENT_IDS       = 28;
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (headerView != null) {
            ...
            if (msgItem != null) {
                ...
                Log.d("XIAOYUAN", "\n\n bindView, >>>headerView.bindMessageItem()");
    ...
    public MessageItem getCachedMessageItem(String type, long msgId, Cursor c) {
        ...
        if (item == null && c != null && isCursorValid(c)) {
            try {
                item = new MessageItem(mContext, type, c, mColumnsMap, mHighlight, mIsFromReject);
    ...
    //begin tangyisen
    private boolean mIsFromReject;
    public void setIsFromReject(boolean isReject) {
        mIsFromReject = isReject;
    }
    //end tangyisen
    ...
    public static class ColumnsMap {
        ...
        public int mColumnMmsExtra;//tangyisen extra
        ...
        public ColumnsMap() {
            ...
            mColumnMmsExtra         =    COLUMN_MMS_EXTRA;//tangyisen extra
        ...
        public ColumnsMap(Cursor cursor) {
            ...
            //tangyisen extra
            try {
                mColumnMmsExtra = cursor.getColumnIndexOrThrow("extra");
            } catch (IllegalArgumentException e) {
                Log.w("colsMap", e.getMessage());
            }
