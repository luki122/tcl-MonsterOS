...
public class ConversationListAdapter extends CursorAdapter implements AbsListView.RecyclerListener {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        //Conversation conv = getCachedConversation(cursor);
        if(conv != null){
...
//    private final ConversationCache mConversationCache;
//    public Conversation getCachedConversation(Cursor c) {
//        long threadId = cursor.getLong(cursor.getColumnIndex("thread_id"));
//        Conversation conv = mConversationCache.get(threadId);
//        if (conv == null && c != null && isCursorValid(c)) {
//            try {
//                conv = Conversation.from(context, cursor);
//                mConversationCache.put(threadId, conv);
//            } catch (MmsException e) {
//                Log.e(TAG, "getCachedConversation: ", e);
//            }
//        }
//        return conv;
//    }
//    private static class ConversationCache extends LruCache<Long, Conversation> {
//        public ConversationCache(int maxSize) {
//            super(maxSize);
//        }
//
//        @Override
//        protected void entryRemoved(boolean evicted, Long key,
//                                    MessageItem oldValue, Conversation newValue) {
...
//    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        //        .inflate(R.layout.conversation_list_item_slideview_mst, parent, false);
        SliderView sliderView = (SliderView) LayoutInflater.from(context)
                .inflate(R.layout.conversation_list_item_slideview_mst, null);
