...
public class MessageItem implements IXYSmartMessageItem{
    ...
    private int mBubbleModelForItem = XYBubbleListItem.DUOQU_SMARTSMS_SHOW_DEFAULT_PRIMITIVE;
    public void setBubbleModelForItem(int bubbleModelForItem) {
        mBubbleModelForItem = bubbleModelForItem;
    }
    public int getBubbleModelForItem() {
        return mBubbleModelForItem;
    }
