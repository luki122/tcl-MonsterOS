...
public class ManageSimMessages extends MstActivity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setMstContentView(R.layout.sim_list);
		//mSimList = (ListView) findViewById(R.id.messages);
        initListView();
        mSimList.setEmptyView(findViewById(R.id.empty_view_layout_id));
        mEmptyMessage =(TextView)mSimList.getEmptyView().findViewById(R.id.tv_id_no_message);
        ...
        protected void onQueryComplete(
            ...
            if (mCursor != null) {
                if (!mCursor.moveToFirst()) {
                    ...
                    mListAdapter.setOnSliderButtonLickListener(ManageSimMessages.this);
        ...
        switch (state) {
            case SHOW_LIST:
                ...
                if(mProgressDialog != null && mProgressDialog.isShowing()
                        && ManageSimMessages.this!=null && !ManageSimMessages.this.isFinishing()) {
	...
	*/
		...
		public void onClick(DialogInterface dialog, int whichButton) {
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
                    showEditMode(false /*isEditMode*/);
					refreshMessageList();
                    Toast.makeText(ManageSimMessages.this, ManageSimMessages.this.getResources()
    ...
    private void updateBottomMenuItems() {
        ...
        //as mst:menu="@menu/sim_msg_multi_select_menu" in sim_list.xml
...
//        sim_msg_deleteItem.setEnabled(checkedCount > 0);
    ...
    private void updateFootView() {
        ...
        if (listCount <= 6) {
            ...
            allCountTextView.setText(ManageSimMessages.this
