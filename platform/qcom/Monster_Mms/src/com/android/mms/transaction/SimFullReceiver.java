...
public class SimFullReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (Settings.Global.getInt(context.getContentResolver(),
            ...
            int slot = intent.getIntExtra(PhoneConstants.SLOT_KEY,
                    PhoneConstants.SUB1);
            Intent viewSimIntent = new Intent(context, SimMessageList.class);
            viewSimIntent.setAction(Intent.ACTION_VIEW);
            viewSimIntent.putExtra(PhoneConstants.SLOT_KEY, slot);
            ...
            notification.setLatestEventInfo(
                    ...
                    pendingIntent);
            nm.notify(SimMessageList.SIM_FULL_NOTIFICATION_ID, notification);
       }
    }
