...
public class SendTransaction extends Transaction implements Runnable {
    private static final String TAG = LogTag.TAG+"/SendTransaction";
    ...
    public void run() {
        try {
            ...
            if(DEBUG) Log.d(TAG, "lineNumber " + lineNumber);
            ...
            if (mTransactionState.getState() != TransactionState.SUCCESS) {
                ...
                Log.e(TAG, "finally, Delivery failed.");
            }
            notifyObservers();
        }
    }
    ...
    @Override
    public void abort() {
        if(DEBUG) Log.d(TAG, "markFailed = " + this);
        mTransactionState.setState(TransactionState.FAILED);
        mTransactionState.setContentUri(mSendReqURI);
