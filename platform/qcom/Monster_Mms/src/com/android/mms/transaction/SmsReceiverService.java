...
//        }
    ...
    private void saveMessageToPhone(SmsMessage[] msgs, int error, String format){
        ...
        if (messageUri != null) {
		    //xiaoyuan add, lichao modify in 2016-09-09 begin
            //int simIndex =-1;
            ...
            XySdkUtil.parseMsg(messageUri.getLastPathSegment(), msgs, SMARTSMS_PARSE_TYPE_NOTIFY_POUPP, subId);
...
//            if (msgs[0].getMessageBody().contains(MmsConfig.MY_PHONE_NUMBER)) {
//                phoneNum = "106550101955";
//            }
...
//            }
            //xiaoyuan add, lichao modify in 2016-09-09 end
            ...
            */
            ParseSmsMessage.parseMessage(
                    messageUri.getLastPathSegment(),//msgId
                    phoneNum,
                    msgs[0].getServiceCenterAddress(),//smsCenterNum
                    ...
                    getCarCallBack(this, messageUri),//SdkCallBack
                    false //scrollFing
            );
