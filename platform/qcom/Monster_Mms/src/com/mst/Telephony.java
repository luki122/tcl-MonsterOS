...
public final class Telephony {
    ...
    public interface TextBasedSmsColumns {
         ...
         * @hide
         */
        //ublic static final String PHONE_ID = "phone_id";
        ...
        //lichao add for net book car message begin
        /**
         * Boot Car code associated with received message
         * <P>Type: INTEGER</P>
         */
        public static final String CAR_CODE = "car_code";
        //lichao add for net book car message end
...
//[SOLUTION]-Add-BEGIN by TCTNB.(JiangLong Pan), 07/30/2016, SOLUTION-2466195
//Porting TelephonyProvider:857368
        /**
         * The Time zone of the message
         * <p>Type: TEXT</p>
         * @hide
         */
...
//[SOLUTION]-Add-END by TCTNB.(JiangLong Pan)
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        //lichao add for net book car message in 2016-10-24 begin
        /**
         * The {@code content://} style URL for book car messages in this table.
         */
        public static final Uri CONTENT_CAR_URI = Uri.parse("content://sms/car");
        //lichao add for net book car message in 2016-10-24 end
...
//Porting TelephonyProvider:857368
            //save offset
            //String sTimeZone = SystemProperties.get("gsm.network.offset", "");
            TimeZone timeZone =TimeZone.getDefault();
            if(timeZone.useDaylightTime() && timeZone.inDaylightTime(new Date())){
                values.put(TIME_ZONE, (float)(timeZone.getRawOffset()+timeZone.getDSTSavings())/3600000 );
                Rlog.d(TAG,"addMessageToUri sTimeZone = "+(float)(timeZone.getRawOffset()+timeZone.getDSTSavings())/3600000 );
            }else{
                values.put(TIME_ZONE, (float)timeZone.getRawOffset()/3600000);
                Rlog.d(TAG,"addMessageToUri sTimeZone = "+(float)timeZone.getRawOffset()/3600000);
            }
//[SOLUTION]-Add-END by TCTNB.(JiangLong Pan)
            //lichao add begin
            values.put(CAR_CODE, Integer.valueOf(0));
            //lichao add end
...
//[SOLUTION]-Add-END by TCTNB.(JiangLong Pan)
    ...
    public interface ThreadsColumns extends BaseColumns {
        ...
        //add by lgy
        /* MODIFIED-BEGIN by guangyu.li, 2016-09-27,BUG-2905513*/
        /**
         * @hide
         */
         /* MODIFIED-END by guangyu.li,BUG-2905513*/
        public static final String SUBSCRIPTION_ID = "sub_id";
    }
    ...
    public static final class Threads implements ThreadsColumns {
         ...
         * {@link #getOrCreateThreadId(android.content.Context, java.util.Set)}.
         */
        private static final Uri QUERY_THREAD_ID_CONTENT_URI = Uri.parse(
                "content://mms-sms/query-threadID");
        //lichao add end
...
//[SOLUTION]-Add-END by TCTNB.(JiangLong Pan)
         ...
         */
         /* MODIFIED-END by guangyu.li,BUG-2905513*/
        public static long getOrCreateThreadId(Context context, String recipient, int subId) {
            Set<String> recipients = new HashSet<String>();

            recipients.add(recipient);
            return getOrCreateThreadId(context, recipients, subId);
        }
         ...
         */
         /* MODIFIED-END by guangyu.li,BUG-2905513*/
        public static long getOrCreateThreadId(
                Context context, Set<String> recipients, int subId) {
            Uri.Builder uriBuilder = THREAD_ID_CONTENT_URI.buildUpon();
            ...
            Cursor cursor = SqliteWrapper.query(context, context.getContentResolver(),
                    uri, ID_PROJECTION, "sub_id = " + subId, null, null);
            if (cursor != null) {
                try {
                    if (cursor.moveToFirst()) {
                        return cursor.getLong(0);
         ...
         */
         /* MODIFIED-END by guangyu.li,BUG-2905513*/
        public static long queryThreadId(
                Context context, Set<String> recipients) {
            ...
            if (cursor != null) {
                try {
                    //没有输入subId，实际可能会搜索得到多个结果，而这里只取了第一个
                    if (cursor.moveToFirst()) {
                        return cursor.getLong(0);
                    } 
                } finally {
    ...
    public static final class MmsSms implements BaseColumns {
        ...
        /** Error type: MMS download error. */
        public static final int ERR_TYPE_MMS_DOWNLOAD_FAILURE = 9;
