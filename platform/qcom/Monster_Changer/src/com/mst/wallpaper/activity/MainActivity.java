...
PresenterBridge.DrawableView,OnColorPickerListener{
	...
	private WidgetColorThread mColorPicker;
	...
	private void loadWallpaperPreview(){
		if(mKeyguardWallpaper != null && mImageResize != null){
			mImageResize.loadImage(Config.WallpaperStored.KEYGUARD_WALLPAPER_PATH, mKeyguardWallpaper);
		}
	}
	...
	private void updateWidgetColor(){
		...
		mColorPicker = new WidgetColorThread(mWallpaper);
		mColorPicker.setOnColorPickerListener(this);
		mColorPicker.executeOnExecutor(AsyncTask.DUAL_THREAD_EXECUTOR, null);
	}
