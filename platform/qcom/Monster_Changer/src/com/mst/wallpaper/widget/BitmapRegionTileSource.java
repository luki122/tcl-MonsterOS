        	...
        	if (previewSize != 0) {
                ...
                if (preview.getWidth() <= GL_SIZE_LIMIT && preview.getHeight() <= GL_SIZE_LIMIT) {
                    mPreview = new BitmapTexture(preview);
						if (handler != null) {
                			handler.sendEmptyMessage(com.mst.wallpaper.utils.Config.HandlerIntMessage.MSG_IMAGE_LOAD_DONE);
                    	return;
                		}
                } else {
			   	...
			   	if (handler != null) {
                	handler.sendEmptyMessage(com.mst.wallpaper.utils.Config.HandlerIntMessage.MSG_IMAGE_LOAD_ERROR);
    			}
		//}
    }
