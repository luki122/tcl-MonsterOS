...
import mst.utils.Pools.Pool;
import mst.utils.Pools.SynchronizedPool;
...
public class TiledImageRenderer {
    ...
    private Pool<Bitmap> sTilePool = new SynchronizedPool<Bitmap>(32);
    ...
    private LongSparseArray<Tile> mActiveTiles = new LongSparseArray<Tile>();
   ...
   private void queueForDecode(Tile tile) {
    ...
    private void activateTile(int x, int y, int level) {
    	if (mActiveTiles == null) {
    		mActiveTiles = new LongSparseArray<Tile>();
		}
