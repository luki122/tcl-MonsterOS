...
public class ImageCache {
                ...
                try {
                    ...
                    if (snapshot == null) {
                        ...
                        if (editor != null) {
                            ...
                            Log.d("keyguard", "mCacheParams == null "+(mCacheParams == null));
                            Log.d("keyguard", "value.getBitmap() == null "+(value.getBitmap() == null));
                            Log.d("keyguard", "out == null "+(out == null));
                ...
                try {
                    ...
                    if (snapshot != null) {
                        ...
                        if (inputStream != null) {
                            ...
                            bitmap = ImageResizer.decodeSampledBitmapFromDescriptor(fd, ImageResizer.sCacheWidth,
                                    ImageResizer.sCacheHeight, ImageResizer.sIsThumb, this);
                        }
                    }
                } catch (final IOException e) {
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        ) ? context.getCacheDir().getPath() : getExternalCacheDir(
                context).getPath();
