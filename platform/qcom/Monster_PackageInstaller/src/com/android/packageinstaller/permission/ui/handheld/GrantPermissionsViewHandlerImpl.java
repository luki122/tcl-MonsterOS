...
public final class GrantPermissionsViewHandlerImpl
    ...
    private LinearLayout mDoNotAskLlyt ;
    ...
    public void updateUi(String groupName, int groupCount, int groupIndex, Icon icon,
            CharSequence message, boolean showDonNotAsk,String appName,String msg) {
    ...
    public View createView() {
        ...
        mDoNotAskLlyt = (LinearLayout) mRootView.findViewById(R.id.do_not_ask_llyt);
