...
public final class PermissionAppsFragment extends PermissionsFrameFragment implements Callback,
        Preference.OnPreferenceChangeListener ,OnMenuItemClickListener{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        /******************************************/
        if (mToolbar != null) {
        	mToolbar.setTitle(getString(R.string.permission_title, mPermissionApps.getLabel()));
        	mToolbar.inflateMenu(R.menu.show_system_menu);
    ...
    public boolean onPreferenceChange(final Preference preference, Object newValue) {
        ...
        if (newValue == Boolean.TRUE) {
            ...
            if (grantedByDefault || (!app.hasRuntimePermissions() && !mHasConfirmedRevoke)) {
                new mst.app.dialog.AlertDialog.Builder(getContext())
    ...
    public static class SystemAppsFragment extends PermissionsFrameFragment implements Callback {
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            /***********************新添加风格 2016/11/19 11:21 start**************************************/
            if (mToolbar != null) {
            	try{
	            	mToolbar.setTitle(getString(R.string.permission_title, permissionApps.getLabel()));
            	}catch(Exception e){
            		e.printStackTrace();
            	}
            }
