 ...
 */
public class PackageInstallerActivity extends Activity implements OnCancelListener, OnClickListener ,DialogInterface.OnClickListener{
    ...
    /************************2016/8/18 start***************************/
    private boolean mNewPermFlag = false ;
    private TextView app_fx ;
    private LinearLayout llyt_sm ;
    private ImageView img_sm ;
    private Button jxaz_button,delete_button ;
    ...
    private void startInstallConfirm() {
    	...
    	// yong.cao  start
    	//Toast.makeText(this, "xxxxxxxxxxxDDDadfxxxxxxxx", Toast.LENGTH_SHORT).show();
    	// end 
        ...
        /****************************/
        findViewById(R.id.llyt_bottom).setVisibility(View.VISIBLE);
        findViewById(R.id.jz_divider).setVisibility(View.GONE);
        app_fx = (TextView)findViewById(R.id.app_fx) ;
        llyt_sm = (LinearLayout)findViewById(R.id.llyt_sm) ;
        img_sm = (ImageView)findViewById(R.id.img_sm) ;
        jxaz_button =(Button) findViewById(R.id.jxaz_button) ;
        delete_button =(Button) findViewById(R.id.delete_button) ;
        
        
        jxaz_button.setOnClickListener(this);
...
//                            AppSecurityPermissions.WHICH_NEW));
                    ...
                    /*************源码部分 2016/8/17* start********************/
//                  mScrollView.addView(perms.getPermissionsView(
//                          AppSecurityPermissions.WHICH_NEW));
                  /***********************end*****************************/
                  
                  /*****************修改部分 2016/8/17start**************************/
                  mScrollView.addView(PermUtils.getNewPermView(PackageInstallerActivity.this,mPackageURI.getPath())) ;
                  
                  findViewById(R.id.tabscontainer).setVisibility(View.GONE);
                  findViewById(R.id.install_confirm_question).setVisibility(View.GONE);
                  findViewById(R.id.jz_divider).setVisibility(View.GONE);
//                  findViewById(R.id.top_divider).setVisibility(View.GONE) ;
                  /*********************end ***************************************/
                }
            }
...
//                 mScrollView.addView(label);
                 ...
                 /*****************新添加部分代码 ，新layout**start***************************/
                 View view = inflater.inflate(R.layout.app_new_perm, null) ;
...
//                    getText(R.string.newPerms)), mScrollView);
            ...
            mst.app.dialog.AlertDialog.Builder dialogBuilder = new mst.app.dialog.AlertDialog.Builder(PackageInstallerActivity.this);
            dialogBuilder.setTitle(getString(R.string.lbl_update_install_title));
            dialogBuilder.setPositiveButton(android.R.string.ok, PackageInstallerActivity.this);
            dialogBuilder.setNegativeButton(android.R.string.cancel, PackageInstallerActivity.this);
            dialogBuilder.setMessage(getString(R.string.lbl_update_install_message));
...
//            findViewById(R.id.spacer).setVisibility(View.VISIBLE);
        ...
        if (!supportsRuntimePermissions && N > 0 && !mNewPermFlag) {
            permVisible = true;
            LayoutInflater inflater = (LayoutInflater)getSystemService(
                    Context.LAYOUT_INFLATER_SERVICE);
...
//          findViewById(R.id.spacer).setVisibility(View.GONE);
          ...
          ((ViewGroup)root.findViewById(R.id.permission_list)).addView(
          		PermUtils.get(PackageInstallerActivity.this, mPackageURI.getPath()));
          /*************************      end     *****************************************/
        ...
        if (!permVisible) {
        	String msg1 = getString(R.string.lbl_new_perm003) ;
        	String msg2 = getString(R.string.lbl_new_perm004) ;
            if (mAppInfo != null) {
...
//                findViewById(R.id.spacer).setVisibility(View.VISIBLE);
                msg1 = getString(R.string.lbl_new_perm001) ;
           	    msg2 = getString(R.string.lbl_new_perm002) ;
            } else {
                // This is a new application with no permissions.
                msg = R.string.install_confirm_question_no_perms;
                msg1 = getString(R.string.lbl_new_perm003) ;
           	    msg2 = getString(R.string.lbl_new_perm004) ;
            }
//            tabHost.setVisibility(View.INVISIBLE);
//            mScrollView = null;
            
            /*******************源码 2016/8/23 10:52 start***************************/
...
//            mScrollView = null;
            ...
            View view = inflater.inflate(R.layout.app_new_perm, null) ;
            ((TextView)view.findViewById(R.id.txtView)).setText(msg1) ;
            ((TextView)view.findViewById(R.id.txtprompt)).setText(msg2) ;
            mScrollView.addView(view);
...
//            });
        ...
        int flag = Settings.Secure.getInt(PackageInstallerActivity.this.getContentResolver(), SP_INSTALL_DETECTION, 0);
        if(flag==1){
        	scanenerApk(mPackageURI);
        }else{
    ...
    public void onClick(View v) {
        if (v == mOk) {
            ...
            clearCachedApkIfNeededAndFinish();
        }else if(v == jxaz_button){
        	jxaz_button.setVisibility(View.GONE);
        	delete_button.setVisibility(View.GONE);
        	mOk.setVisibility(View.VISIBLE);
        	mCancel.setVisibility(View.VISIBLE);
        }else if(v == delete_button){
        	new File(mPackageURI.getPath()).delete();
        ...
        private final Runnable mEmptyStateRunnable = new Runnable() {
            ...
            public void run() {
                ...
                ((TextView) findViewById(R.id.install_confirm_question))
                        .setText(R.string.message_jz);
                mInstallConfirm.setVisibility(View.VISIBLE);
                findViewById(android.R.id.tabhost).setVisibility(View.INVISIBLE);
                findViewById(R.id.llyt_bottom).setVisibility(View.GONE);
                findViewById(R.id.jz_divider).setVisibility(View.VISIBLE);
...
//                findViewById(R.id.spacer).setVisibility(View.VISIBLE);
	...
	/********************************************/
	  private void scanenerApk(Uri uri) {
	    	mScannerAdPlugin = new ScannerAdPlugin(mAdPluginHandler) ;
	    	Log.e("----------------------------------","uri = " + uri.getPath()) ;
	    	mScannerAdPlugin.startScannerApk(uri.getPath()) ;
	...
	private Handler mAdPluginHandler = new Handler() {
        public void handleMessage(Message msg) {
                  ...
                  case ScannerAdPlugin.MSG_SCANNER_END:
                	  ...
                	  if(isRisk()){
                		  app_fx.setText(R.string.lbl_new_perm005);
                		  img_sm.setImageResource(R.drawable.viruses_app_bg);
                		  jxaz_button.setVisibility(View.VISIBLE);
                      	delete_button.setVisibility(View.VISIBLE);
                      	delete_button.setText(R.string.lbl_new_perm008);
                      	delete_button.setOnClickListener(PackageInstallerActivity.this);
                      	mOk.setVisibility(View.GONE);
                      	mCancel.setVisibility(View.GONE);
                	  }else{
                		  mOk.setVisibility(View.VISIBLE);
                		  delete_button.setVisibility(View.GONE);
                		  app_fx.setText(R.string.lbl_new_perm006);
                		  img_sm.setImageResource(R.drawable.security_app_bg);
                	  }
                	  llyt_sm.setVisibility(View.VISIBLE);
                	  //Toast.makeText(PackageInstallerActivity.this, "扫描： " + mQScanResultEntitys.size(), Toast.LENGTH_LONG).show() ;
                	  break;
