...
public class PrivacyDataUtils {
    ...
    public static int[] getPrivateData(Uri uri) {
        ...
        if (url.startsWith("content://com.android.contacts/contacts/lookup/")
            ...
            long RawContactId = queryForRawContactId(ManagePrivacy.getInstance().getContext().getContentResolver(), Long.parseLong(uri
                    .getLastPathSegment()));
    ...
    public static long getDataIdByRawContactId(long rawContactId) {
        ...
        Cursor cursor = ManagePrivacy
                .getInstance()
                .getContext().getContentResolver().query(Data.CONTENT_URI,
                new String[] {Data._ID},
    ...
    public static String getPrivateRingNotificationText(long accountId) {
        ...
        String defaultText = ManagePrivacy.getInstance().getContext()
