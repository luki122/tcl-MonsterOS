...
public class AsyncRingtonePlayer {
    ...
    private void handlePlay(SomeArgs args) {
        ...
        // anything.
//[SOLUTION]-Add-BEGIN by TCTNB.(JiangLong Pan), 08/31/2016, SOLUTION-2638493
//Porting MediaProvider and RingtonePicker Activity
        Uri incomingRingtoneUri = incomingCall.getRingtone();
        Log.i(this, "handlePlay incomingRingtoneUri " + incomingRingtoneUri);
        if (Uri.EMPTY.equals(incomingCall.getRingtone()) || Uri.parse("ringtone_silent").equals(incomingRingtoneUri)) {
