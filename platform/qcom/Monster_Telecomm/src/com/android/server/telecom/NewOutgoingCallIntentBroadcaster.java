...
//[SOLUTION]-Add-BEGIN by TCTNB.(JiangLong Pan), 08/12/2016, SOLUTION-2533577
//[Call]Originate call failed
    ...
    public class NewOutgoingCallBroadcastIntentReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                ...
                //[SOLUTION]-Add-BEGIN by TCTNB.(Chuanjun Chen), 08/23/2016, SOLUTION- 2487009 And TASk-2781424
...
//[SOLUTION]-Add-BEGIN by TCTNB.(JiangLong Pan), 08/12/2016, SOLUTION-2533577
//[Call]Originate call failed
                if (mIntent.getData().getSchemeSpecificPart() != null && !checkApkExist(mContext, "com.google.android.apps.googlevoice")) {
                    /* MODIFIED-END by jianglong.pan,BUG-2520358*/
                    resultNumber = mIntent.getData().getSchemeSpecificPart();
                    endEarly = false;
                } else {
