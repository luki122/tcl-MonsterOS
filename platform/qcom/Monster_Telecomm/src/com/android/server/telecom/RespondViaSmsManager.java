    ...
    public void loadCannedTextMessages(final Response<Void, List<String>> response,
        ...
        new Thread() {
            ...
            public void run() {
                ...
                //[HOMO][Orange] Change the french label for quick text
                if (!context.getResources().getBoolean(R.bool.def_Quick_Response_Via_SMS_For_FRANCE_Orange)) {
...
//                            res.getString(R.string.respond_via_sms_canned_response_4)));
                    ...
                    textMessages.add(0, prefs.getString(QuickResponseUtils.KEY_CANNED_RESPONSE_PREF_2,
                            res.getString(R.string.respond_via_sms_canned_response_2)));
                    textMessages.add(1, prefs.getString(QuickResponseUtils.KEY_CANNED_RESPONSE_PREF_3,
                            res.getString(R.string.respond_via_sms_canned_response_3)));
//                    textMessages.add(2, prefs.getString(QuickResponseUtils.KEY_CANNED_RESPONSE_PREF_4,
//                            res.getString(R.string.respond_via_sms_canned_response_4)));
                }
