...
final class PhoneStateBroadcaster extends CallsManagerListenerBase {
    ...
    private void updateStates(Call call) {
        ...
        //MODIFY-BEGIN by Dingyi  2016/08/12 SOLUTION 2496896
        android.util.TctLog.d("PhoneStateBroadcaster", "onCallRemoved hasAnyCalls = " + mCallsManager.hasAnyCalls());
        if (mCallsManager.hasAnyCalls() && mCallsManager.hasRingingCall()) {
        //MODIFY-END by Dingyi  2016/08/12 SOLUTION 2496896
            callState = TelephonyManager.CALL_STATE_RINGING;
        } else if (mCallsManager.getFirstCallWithState(CallState.DIALING, CallState.ACTIVE,
                    CallState.ON_HOLD) != null) {
            callState = TelephonyManager.CALL_STATE_OFFHOOK;
        }
        //ADD-BEGIN by Dingyi  2016/08/12 SOLUTION 2496896
        android.util.TctLog.d("PhoneStateBroadcaster", "onCallRemoved callState = " + callState);
        //ADD-END by Dingyi  2016/08/12 SOLUTION 2496896
    ...
    private void sendPhoneStateChangedBroadcast(Call call, int phoneState) {
        ...
        //ADD-END by Dingyi  2016/08/12 SOLUTION 2496896
        android.util.TctLog.d("PhoneStateBroadcaster", "sendPhoneStateChangedBroadcast phoneState = " + phoneState + ", mCurrentState = " + mCurrentState);
        //ADD-END by Dingyi  2016/08/12 SOLUTION 2496896
