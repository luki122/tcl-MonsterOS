...
public class MissedCallNotifierImpl extends CallsManagerListenerBase implements MissedCallNotifier {
            ...
            if (count == 1 && call != null) {
                ...
                if (!TextUtils.isEmpty(handle) && !TextUtils.equals(handle,
                    ...
                    intent.putExtra(TelecomManager.EXTRA_CALL_BACK_INTENT,
                            createCallBackPendingIntent(handleUri, userHandle, subId));
    ...
    private void sendNotificationThroughDefaultDialer(Call call, UserHandle userHandle) {
        ...
        Intent intent = getShowMissedCallIntentForDefaultDialer(userHandle)
            ...
            .putExtra(TelecomManager.EXTRA_NOTIFICATION_PHONE_NUMBER,
                    call != null ? call.getPhoneNumber() : null);
        //[SOLUTION]-Add-BEGIN by TCTNB.(Caixia Chen), 08/23/2016, SOLUTION-2504488
        intent.putExtra("android.telecom.extra.missedcall_name", call != null ? call.getName() : null);
        //[SOLUTION]-Add-END by TCTNB.(Caixia Chen)
    ...
    public void showMissedCallNotification(Call call) {
        //modify by lgy 
        if(!PrivacyUtils.notifyPrivateMissedCall(call)) {
    ...
    private String getNameForCall(Call call) {
        ...
        //[SOLUTION]-Add-BEGIN by TCTNB.(Chuanjun Chen), 08/24/2016, SOLUTION- 2487056 And TASk-2781418
        //Missed Voicemail number just display as number
        if (!TextUtils.isEmpty(handle) && PhoneNumberUtils.isVoiceMailNumber(handle)) {
    ...
    public static boolean isArabicLang() {
        ...
        if (langCode.equals("ar") || langCode.equals("fa") || langCode.equals("iw")) {
            return true;
        } else {
            return false;
        }
     ...
     */
    //modify by lgy for 3429114 start
    private PendingIntent createCallBackPendingIntent(Uri handle, UserHandle userHandle, String subId) {
        return createTelecomPendingIntent(
    ...
    private void configureLedOnNotification(Notification notification) {
        ...
        //[FEATURE]-Fix-BEGIN by TCTNB.(Chuanjun Chen), 10/15/2016, FEATURE-2640603 And TASk-3003215
                    ...
                    try {
                        ...
                        while (cursor.moveToNext()) {
                            ...
                            synchronized (lock) {
                                ...
                                // info query.
                                //[SOLUTION]-Add-BEGIN by TCTNB.(Caixia Chen), 08/23/2016, SOLUTION-2504488
                                mDitor.putBoolean(isStartThePhone,true).commit();
                                //[SOLUTION]-Add-END by TCTNB.(Caixia Chen)
