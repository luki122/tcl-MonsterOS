...
public class RingtoneFactory {
    ...
    private int mPhoneId = 0;/* ADD by Dingyi for dualsim 2016/08/03 FR 2655692*/
    ...
    public Ringtone getRingtone(Call incomingCall) {
        ...
        /* ADD-BEGIN by Dingyi for dualsim 2016/08/03 FR 2655692*/
            ...
            if (TelephonyManager.getDefault().isMultiSimEnabled()) {
                if (isTwoSimReady() || mPhoneId == 1){
                    ringtoneUri = RingtoneManager.getActualRingtoneUriBySubId(mContext, mPhoneId);
                }else {
                    ringtoneUri = RingtoneManager.getActualDefaultRingtoneUri(mContext, RingtoneManager.TYPE_RINGTONE);
                }
            } else {
