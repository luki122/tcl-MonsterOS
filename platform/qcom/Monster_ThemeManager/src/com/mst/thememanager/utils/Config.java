...
public class Config {
	...
	public static final String THEME_APPLY_ICON_DIR_TMP = "/data/monster/theme/current/icons_tmp/";
	...
	public static final String THEME_APPLY_CUSTOM_KEYGUARD_WALLPAPER = THEME_APPLY_CUSTOM_WALLPAPER+"lockscreen/";
	/**
