...
public abstract class AbsThemeFragment extends Fragment {
    ...
    public ImageResizer getImageResizer(){
    	return getImageResizer(2, 2,"detail_images");
    }
    
    public ImageResizer getImageResizer(int scaleW,int scaleH,String cacheDir){
    	if(mImageResizer == null){
    		...
    		mImageResizer = new ImageResizer(getContext(), width/scaleW,height/scaleH);
    		mImageResizer.addImageCache(getActivity(), cacheDir);
    	}
