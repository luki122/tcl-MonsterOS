            ...
            switch (eventType) {
                ...
                case XmlPullParser.START_TAG:
                    if (parser.getName().equals("string-array")) {
                        ...
                        if (LABEL_ICON_MAP_NAME.equals(parserName)) {
                        ...
                        if (PTOP.equals(parserName)) {
                            pTop = intText;
                        } else if (PRIGHT.equals(parserName)) {
                            pRight = intText;
                        } else if (PLEFT.equals(parserName)) {
                            pLeft = intText;
                        } else if (PBOTTOM.equals(parserName)) {
                            pBottom = intText;
                        }
                        ...
                        String text = parser.getText();
                        if (HETEROMORPHIC_THEME.equals(parserName)) {
