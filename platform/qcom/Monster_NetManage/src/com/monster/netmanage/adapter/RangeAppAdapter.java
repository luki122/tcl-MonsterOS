...
public class RangeAppAdapter  extends BaseAdapter{
   ...
   private void save(String type, ArrayList<AppItem> saveList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tBtnRange.setChecked(appItem.isPolicyStatus());
		Log.v(TAG, ">>>>>appName>>>" + appName + ">isChecked()>>"+ viewHolder.tBtnRange.isChecked());
	...
	public void setOnSelectedListener(int index, Switch tBtn) {
		...
		if (tBtn.isChecked()) {
	        ...
	        mAppInfosByPolicy.remove(appItem);
