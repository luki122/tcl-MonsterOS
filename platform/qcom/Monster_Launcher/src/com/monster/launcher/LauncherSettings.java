...
public class LauncherSettings {
    ...
    public static final class AppCategory{
        ...
        static final String TABLE_APP_INFO_CATEGORY = "app_info_category";
        static final String TABLE_APP_CATEGORY = "app_category";

        public static final Uri APP_INFO_CATEGORY_URI = Uri.parse("content://" +
            ProviderConfig.AUTHORITY + "/" + TABLE_APP_INFO_CATEGORY);

        public static final Uri APP_CATEGORY_URI = Uri.parse("content://" +
            ProviderConfig.AUTHORITY + "/" + TABLE_APP_CATEGORY);
    }
