...
public class HanziToPinyin {
	...
	private static char[] UNIHANS_OLD = {
		'\u5416', '\u54ce', '\u5b89', '\u80ae', '\u51f9', '\u516b', '\u63b0', '\u6273',
		'\u90a6', '\u52f9', '\u9642', '\u5954', '\u4f3b', '\u7680', '\u782d', '\u706c',
		'\u618b', '\u6c43', '\u51ab', '\u7676', '\u5cec', '\u5693', '\u5072', '\u53c2',
		'\u4ed3', '\u64a1', '\u518a', '\u5d7e', '\u564c', '\u6260', '\u62c6', '\u8fbf',
	...
	private final static byte[][] PINYINS_OLD = {
    ...
    private static final String FIRST_PINYIN_UNIHAN_OLD =  "\u5416";
    private static final String LAST_PINYIN_UNIHAN_OLD =  "\u5497";
    ...
    public static HanziToPinyin getInstance() {
        synchronized (HanziToPinyin.class) {
            ...
            */
            ...
            List<Token> pinyin = sInstance.get("周");
            if(pinyin != null && !pinyin.isEmpty()) {
            	String target = pinyin.get(0).target;
            	if(target != null && target.length() > 0) {
            		String sortKey = target.substring(0, 1).toUpperCase();
            		if(sortKey.equals("Z")) {
            			needChange =false;
            		}
            	}
            ...
            if(needChange) {
            	UNIHANS = UNIHANS_OLD;
            	PINYINS = PINYINS_OLD;
            	FIRST_PINYIN_UNIHAN = FIRST_PINYIN_UNIHAN_OLD;
            	LAST_PINYIN_UNIHAN = LAST_PINYIN_UNIHAN_OLD;
            }
            return sInstance;
        }
    }
    ...
    private Token getToken(char character) {
        ...
        //add 20130322 begin
        if(offset >= PINYINS.length){
        	offset = PINYINS.length - 1;
        }
        if(offset <0 ){
        	offset = 0;
        }
