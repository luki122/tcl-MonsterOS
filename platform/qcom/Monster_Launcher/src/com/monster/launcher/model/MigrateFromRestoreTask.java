...
import com.monster.launcher.LauncherProvider;
...
public class MigrateFromRestoreTask {
    ...
    public ArrayList<DbEntry> loadEntries(long screen) {
       Cursor c =  mContext.getContentResolver().query(LauncherSettings.Favorites.CONTENT_URI,
                new String[] {
                    ...
                    LauncherSettings.Favorites.CELLX,                // 2
                    LauncherSettings.Favorites.CELLY,                // 3
                    LauncherSettings.Favorites.SPANX,                // 4
                    LauncherSettings.Favorites.SPANY,                // 5
                    LauncherSettings.Favorites.INTENT,               // 6
                    LauncherSettings.Favorites.APPWIDGET_PROVIDER},  // 7
                LauncherSettings.Favorites.CONTAINER + " = " + LauncherSettings.Favorites.CONTAINER_DESKTOP
                    + " AND " + LauncherSettings.Favorites.SCREEN + " = " + screen, null, null, null);
       ...
       final int indexAppWidgetProvider = c.getColumnIndexOrThrow(LauncherSettings.Favorites.APPWIDGET_PROVIDER);
           ...
           try {
               ...
               switch (entry.itemType) {
                   ...
                   case LauncherSettings.Favorites.ITEM_TYPE_APPLICATION: {
                       ...
                       entry.weight = entry.itemType == LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT
    ...
    private int getFolderItemsCount(long folderId) {
        Cursor c =  mContext.getContentResolver().query(LauncherSettings.Favorites.CONTENT_URI,
                ...
                LauncherSettings.Favorites.CONTAINER + " = " + folderId, null, null, null);
    ...
    private static class DbEntry extends ItemInfo implements Comparable<DbEntry> {
        ...
        public int compareTo(DbEntry another) {
            if (itemType == LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET) {
                if (another.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET) {
                    return another.spanY * another.spanX - spanX * spanY;
                } else {
                    return -1;
                }
            } else if (another.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET) {
                return 1;
            } else {
