...
public class InvariantDeviceProfile {
    ...
    ArrayList<InvariantDeviceProfile> getPredefinedDeviceProfiles() {
        ...
        predefinedDeviceProfiles.add(new InvariantDeviceProfile("TCL 950",
                338, 570,     5, 3, 3, 3, 6, DEFAULT_ICON_SIZE_DP, 11, 3, DEFAULT_ICON_SIZE_DP, R.xml.default_workspace_4x4));
