...
import com.monster.launcher.util.FlingAnimation;
...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    public static boolean supportsDrop(Object info) {
        ...
        */
        //modify by xiangzx
        /*Log.i(TAG,"info = "+info);
        return (info instanceof LauncherAppWidgetInfo)||!isApplication(((info instanceof ItemInfo)?(ItemInfo)info:null))||info instanceof PendingAddItemInfo;*/
        return (info instanceof LauncherAppWidgetInfo)||isShortcut(((info instanceof ItemInfo)?(ItemInfo)info:null))||info instanceof PendingAddItemInfo;
    }
    ...
    public void changeImage() {
        super.changeImage();
        setDrawable(R.drawable.droptarget_uninstall_animation);
