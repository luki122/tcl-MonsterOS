...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    private ButtonDropTarget mLocationDropTarget;
    private ButtonDropTarget mDismissfolderDropTarget;
    ...
    public void setup(Launcher launcher, DragController dragController) {
        ...
        dragController.addDragListener(mLocationDropTarget);
        dragController.addDragListener(mDismissfolderDropTarget);

        dragController.addDropTarget(mInfoDropTarget);
        dragController.addDropTarget(mDeleteDropTarget);
        dragController.addDropTarget(mUninstallDropTarget);
        dragController.addDropTarget(mLocationDropTarget);
        dragController.addDropTarget(mDismissfolderDropTarget);

        mInfoDropTarget.setLauncher(launcher);
        mDeleteDropTarget.setLauncher(launcher);
        mUninstallDropTarget.setLauncher(launcher);
        mLocationDropTarget.setLauncher(launcher);
        mDismissfolderDropTarget.setLauncher(launcher);
    }
    ...
    protected void onFinishInflate() {
        ...
        mLocationDropTarget = (ButtonDropTarget) mDropTargetBar.findViewById(R.id.logcation_target_text);
        mDismissfolderDropTarget = (ButtonDropTarget) mDropTargetBar.findViewById(R.id.dismmiss_folder_target_text);


        mInfoDropTarget.setSearchDropTargetBar(this);
        mDeleteDropTarget.setSearchDropTargetBar(this);
        mUninstallDropTarget.setSearchDropTargetBar(this);
        mLocationDropTarget.setSearchDropTargetBar(this);
        mDismissfolderDropTarget.setSearchDropTargetBar(this);
