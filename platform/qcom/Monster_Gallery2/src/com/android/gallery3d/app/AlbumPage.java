    ...
    public class AlbumPageSynchronizedHandler extends SynchronizedHandler {
        ...
        public void handleMessage(Message message) {
            ...
            case MSG_LOAD_WHOLE_BITMAP_THUMBNAIL_DONE: {
                ...
                boolean isGif = GifTexture.isGif(item.getFilePath());
                boolean isBmp = item.getMimeType().toLowerCase().endsWith("bmp");
                boolean isEditable = ! isGif && ! isBmp;
                enteringBitmapInfo.isEditable = isEditable;
