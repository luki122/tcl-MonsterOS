...
final class Config {
    ...
    public static class AlbumPage {
        ...
        private AlbumPage(Context context) {
            ...
            slotViewSpec.slotGapForTwoColumns = r.getDimensionPixelSize(R.dimen.mst_album_slot_gap_2);
            slotViewSpec.slotGapForThreeColumns = r.getDimensionPixelSize(R.dimen.mst_album_slot_gap_3);
            slotViewSpec.slotGapForFourColumns = r.getDimensionPixelSize(R.dimen.mst_album_slot_gap_4);
            slotViewSpec.slotGapForFiveColumns = r.getDimensionPixelSize(R.dimen.mst_album_slot_gap_5);
            slotViewSpec.slotGapForSixColumns = r.getDimensionPixelSize(R.dimen.mst_album_slot_gap_6);
            
            slotViewSpec.slotAreaLeftPadding = 0; //r.getDimensionPixelSize(R.dimen.mst_album_slot_area_left_padding);
            slotViewSpec.slotAreaTopPadding = r.getDimensionPixelSize(R.dimen.mst_album_slot_area_top_padding);
            slotViewSpec.slotAreaRightPadding = r.getDimensionPixelSize(R.dimen.mst_album_slot_area_right_padding);
            slotViewSpec.slotAreaBottomPadding = r.getDimensionPixelSize(R.dimen.mst_album_slot_area_bottom_padding);
            
            slotViewSpec.slotGroupGap = r.getDimensionPixelSize(R.dimen.mst_album_group_gap);
            
            slotViewSpec.slotDateAreaWidth = r.getDimensionPixelSize(R.dimen.mst_date_container_width);
