...
public class ImageCurves extends ImageShow {
    ...
    // [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-10,PR1038964 begin
    private boolean mIsLoad = false;
    // [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-10,PR1038964 end
    ...
    public void nextChannel() {
        ...
        mIsLoad = false;// [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-10,PR1038964
        invalidate();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        // [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-10,PR1038964 begin
        if (!mIsLoad && getFilteredImage() != null) {
            new ComputeHistogramTask().execute();
        }
        // [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-10,PR1038964 end
    ...
    // [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-10,PR1038964 begin
    class ComputeHistogramTask extends AsyncTask<Void, Void, int[]> {
        @Override
