...
public class EditorPanel extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        //[ALM][BUGFIX]-Add by TCTNJ,jun.xie-nb, 2016-5-9,ALM-2120332 begin
        if(mEditor != null  ) {
            mEditor.attach(); //MODIFIED by jian.pan1, 2016-04-08,BUG-1170847
        }
        //[ALM][BUGFIX]-Add by TCTNJ,jun.xie-nb, 2016-5-9,ALM-2120332 end
    }
