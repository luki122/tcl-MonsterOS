...
public class FilterColorBorderRepresentation extends FilterRepresentation {
    ...
    // [BUGFIX]-Modified by TCTNJ,xiangyu.liu, 2016-03-10,PR1431013 begin
    // new BasicParameterInt(PARAM_RADIUS, 2, 0, 100) to new BasicParameterInt(PARAM_RADIUS, 2, 0, 50)
    private BasicParameterInt mParamRadius = new BasicParameterInt(PARAM_RADIUS, 2, 0, 50);
    // [BUGFIX]-Modified by TCTNJ,xiangyu.liu, 2016-03-10,PR1431013 end
    ...
    public ParameterColor getColorParam() {
        return mParamColor;
    }
