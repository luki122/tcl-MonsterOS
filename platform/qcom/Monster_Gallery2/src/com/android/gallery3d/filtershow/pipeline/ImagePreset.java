...
public class ImagePreset {
    ...
    public void addFilter(FilterRepresentation representation) {
        if (representation instanceof FilterUserPresetRepresentation) {
            ...
            */
            // Modify To:
            // we will accumulate the effect of several matrix transformations
            // so we do not remove previous TYPE_GEOMETRY filters.
            // TCL ShenQianfeng End on 2016.08.25
            if (!representation.isNil()) {
                mFilters.addElement(representation);
            }
    ...
    public FilterRepresentation getRepresentation(FilterRepresentation filterRepresentation) {
        ...
        // we need to add mirror and rotate into ImagePreset, to overlap the effect. 
