...
public class MasterImage implements RenderingRequestCaller {
    ...
    private boolean mFilterSharpen = false;
    ...
    private Rect mOriginalBounds = null; //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-08-28, PR1076569
    ...
    // [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-17,PR1044901 begin
    public boolean isFilterSharpen() {
        return mFilterSharpen;
    }

    public void setFilterSharpen(boolean mFilterSharpen) {
        this.mFilterSharpen = mFilterSharpen;
    }
    // [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-17,PR1044901 end
    ...
    public boolean loadBitmap(Uri uri, int size) {
        ...
        int sh = (int) (sw * (float) mOriginalBitmapLarge.getHeight() / mOriginalBitmapLarge
                .getWidth());
        // [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-13,PR1042082 begin
        if (sh <= 0) {
            return false;
        }
        // [BUGFIX]-Add by TCTNJ,jian.pan1, 2015-07-13,PR1042082 end
    ...
    public void onHistoryItemClick(int position) {
        ...
        if (historyItem == null || historyItem.getImagePreset() == null) return;
        //modify end
    ...
    //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-05-14,PR999739 begin
    public void setAnimRotation(float rotation) {
        mAnimRotationValue = rotation;
        notifyObservers();
    }
    //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-05-14,PR999739 end
    ...
    public void onNewLook(FilterRepresentation newRepresentation) {
        ...
        if (newRepresentation instanceof FilterRotateRepresentation) {
            ...
            // Modify To:
            FilterRotateRepresentation rotateRep = (FilterRotateRepresentation)newRepresentation;
            if(rotateRep.isCounterClockwise() ) {
                mAnimator = ValueAnimator.ofFloat(0, -90);
            } else {
                mAnimator = ValueAnimator.ofFloat(0, 90);
            }
    ...
    public void setImageShowSize(int w, int h) {
        //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-06-19, PR1027295 begin
        if (mOriginalBounds == null) {
            return;
        }
        //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-06-19, PR1027295 end
    ...
    public Matrix computeImageToScreen(Bitmap bitmapToDraw,
        ...
        if (applyGeometry) {
        //[BUGFIX]-Add by TCTNJ,qiang.ding1, 2015-02-9,PR926999  begin
            if(mPreset==null){
               return null;
            }
         //[BUGFIX]-Add by TCTNJ,qiang.ding1, 2015-02-9,PR926999  end
    ...
    public Bitmap getTemporaryThumbnailBitmap() {
        ...
        Utils.debugBitmap(mTemporaryThumbnail, "1222.png");
    ...
    public boolean hasTinyPlanet() {
        //[BUGFIX]-Add by TCTNJ,jialiang.ren, 2015-01-19,PR900038 begin
        if(mPreset != null) {
            return mPreset.contains(FilterRepresentation.TYPE_TINYPLANET);
        } else {
            return false;
        }
        //[BUGFIX]-Add by TCTNJ,jialiang.ren, 2015-01-19,PR900038 end
    }
}
