...
public class InfoPanel extends DialogFragment {
    ...
    private String createStringFromIfFound(ExifTag exifTag, int tag, int str) {
        ...
        if (tagId == ExifInterface.getTrueTagKey(tag)) {
            ...
            //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-01-20,PR902073 begin
            exifString += "<b><font color=\"#ffffff\">" + label + ": </font></b>";
            exifString += "<font color=\"#ffffff\">"+exifTag.forceGetValueAsString()+"</font>";
            exifString += "<br>";
            //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-01-20,PR902073 end
        }
        return exifString;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-06-16, PR1025469 begin
        if (bitmap != null) {
            histogramView.setBitmap(bitmap);
        }
        //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-06-16, PR1025469 end
        ...
        //[BUGFIX]-Add by TCTNJ,jialiang.ren, 2015-07-08,PR1038732 begin
        if(originalBounds != null)
            mImageSize.setText("" + originalBounds.width() + " x " + originalBounds.height());
        //[BUGFIX]-Add by TCTNJ,jialiang.ren, 2015-07-08,PR1038732 end
