...
public class ExportDialog extends DialogFragment implements View.OnClickListener,
    ...
    /* MODIFIED-BEGIN by hao.yin, 2016-05-10,BUG-2116050*/
    public ExportDialog() {
        super();
    }
    /* MODIFIED-END by hao.yin,BUG-2116050*/
    //[ALM][BUGFIX]-Add by TCTNJ,jun.xie-nb, 2015-4-12,ALM-1941392 begin
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.done:
                ...
                //[ALM][BUGFIX]-Add by TCTNJ,jun.xie-nb, 2015-5-10,ALM-2118211 begin
                if (MasterImage.getImage().getPreset() != null) {
                    Intent processIntent = ProcessingService.getSaveIntent(
                            activity, MasterImage.getImage().getPreset(), dest,
                            activity.getSelectedImageUri(), sourceUri, true,
                            mSeekBar.getProgress(), scaleFactor, false);
                    activity.startService(processIntent);
                }
                //[ALM][BUGFIX]-Add by TCTNJ,jun.xie-nb, 2015-5-10,ALM-2118211 end
                dismiss();
                break;
        }
    }
