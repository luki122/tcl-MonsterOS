...
public class FilterRepresentation {
    ...
    private int mSelectedOverlayId = 0;
    private int mSelectedBorderOverlayId = 0;
    private boolean mHighlightCategoryText;
    ...
    // TCL ShenQianfeng Begin on 2016.09.05
    public void setSelectedOverlayId(int overlayId) {
        mSelectedOverlayId = overlayId;
    }
    
    public int getSelectedOverlayId() {
        return mSelectedOverlayId;
    }
    
    public void setSelectedBorderOverlayId(int overlayId) {
        mSelectedBorderOverlayId = overlayId;
    }
    
    public int getSelectedBorderOverlayId() {
        return mSelectedBorderOverlayId;
    }
    
    public boolean shouldHighlightCategoryText() {
        return mHighlightCategoryText;
    }

    public void setHighlightCategoryText(boolean highlight) {
        mHighlightCategoryText = highlight;
    }
    // TCL ShenQianfeng End on 2016.09.05
