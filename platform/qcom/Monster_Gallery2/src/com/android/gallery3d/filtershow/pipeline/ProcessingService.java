...
public class ProcessingService extends Service {
    ...
    public void onDestroy() {
        mRenderingRequestTask.stop(); //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-05-05, PR988861
        tearDownPipeline();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
      ...
      //[BUGFIX]-Add by TCTNJ,xinrong.wang, 2016-03-22,PR1824021 begin
        //return START_REDELIVER_INTENT;
        return START_NOT_STICKY;
      //[BUGFIX]-Add by TCTNJ,xinrong.wang, 2016-03-22,PR1824021 end
    }
    ...
    public void completePreviewSaveImage(Uri result, boolean exit) {
        if (exit && !mNeedsAlive && !mFiltershowActivity.isSimpleEditAction()) {
            mFiltershowActivity.SaveImagePreview(result); // MODIFIED by lina.tang, 2016-08-16,BUG-2255033
    ...
    public void completeSaveImage(Uri result, boolean exit) {
        ...
        if (mNeedsAlive) {
            ...
            // terminate now
            //[BUGFIX]-Add by TCTNJ,chengbin.du, 2015-02-10,PR926402 begin
            try {
                mFiltershowActivity.completeSaveImage(result);
            } catch (NullPointerException e) {
                Log.e(LOGTAG, "completeSaveImage", e);
            }
            //[BUGFIX]-Add by TCTNJ,chengbin.du, 2015-02-10,PR926402 end
        }
    ...
    private void setupPipeline() {
        ...
        filtersManager.addCrops(this);
        filtersManager.addRotate(this);
        ...
        filtersManager.addEffects(this);

        FiltersManager highresFiltersManager = FiltersManager.getHighresManager();
        // TCL ShenQianfeng Begin on 2016.08.22
        highresFiltersManager.addCrops(this);
        highresFiltersManager.addRotate(this);
        // TCL ShenQianfeng End on 2016.08.22
        ...
        highresFiltersManager.addEffects(this);
    }
