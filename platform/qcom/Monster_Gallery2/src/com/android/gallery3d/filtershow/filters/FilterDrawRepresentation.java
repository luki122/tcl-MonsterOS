...
public class FilterDrawRepresentation extends FilterRepresentation {
    ...
    // [ALM][BUGFIX]-Add by TCTNJ,jian.pan1, 2015-12-16,Defect:1170771 begin
    private BasicParameterInt mParamSize = new BasicParameterInt(PARAM_SIZE, 10, 2, 300);
    // [ALM][BUGFIX]-Add by TCTNJ,jian.pan1, 2015-12-16,Defect:1170771 end
    private BasicParameterStyle mParamStyle = new BasicParameterStyle(PARAM_STYLE, 5);
    public static int DEFAULT_MENU_COLOR1 = 0xFFFF1744;
    public static int DEFAULT_MENU_COLOR2 = 0xFFC6FF00;
    public static int DEFAULT_MENU_COLOR3 = 0xFF00B0FF;
    public static int DEFAULT_MENU_COLOR4 = 0xFF000000;
    public static int DEFAULT_MENU_COLOR5 = 0xFFFFFFFF;
    ...
    public FilterDrawRepresentation() {
        ...
        setOverlayId(R.drawable.ic_edit_draw);
        setOverlayOnly(true);
    }
    ...
    public void undo() {
        ...
        if (mDrawing != null && mDrawing.size() > 0) {
            ...
            Log.e(LOGTAG, "FilterDrawRepresentation mDrawing is NULL.");
        }
    }
