...
public final class ImageLoader {
    ...
    //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-03-03,PR937876 begin
    public static String getMimeTypeForExif(Uri src) {
        String postfix = getFileExtensionFromUrl(src.toString());
        Log.i(LOGTAG, "getMimeType  postfix:" + postfix);
        String ret = null;
        if (postfix != null) {
            ret = MimeTypeMap.getSingleton().getMimeTypeFromExtension(postfix);
        }
    ...
    //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-03-03,PR937876 end

    public static String getLocalPathFromUri(Context context, Uri uri) {
        if (null == uri) return null; //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-09-01, PR1077623

      //[BUGFIX]-Modified by TCTNJ,qiang.ding1, 2014-12-17,PR871604 begain
        Cursor cursor = null;
        try {
          ...
          //[BUGFIX]-Add-BEGIN by TCTNJ.ye.chen, 2015/1/3 PR-887493.
        }catch (Exception e)
        {
            return uri.toString();
        }
      ...
      //[BUGFIX]-Add-END by TCTNJ.ye.chen, 2015/1/3 PR-887493.
      //[BUGFIX]-Modified by TCTNJ,qiang.ding1, 2014-12-17,PR871604 end
    }

    /* MODIFIED-BEGIN by dongliang.feng, 2016-03-22,BUG-1850791 */
    public static long getIdFromUri(Context context, Uri uri) {
        if (null == uri) return -1;
    ...
    //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2016-02-02, ALM-1544920 begin
    public static String getDisplayName(Context context, Uri uri) {
        ...
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(uri, new String[] { MediaStore.Images.Media.DISPLAY_NAME }, null, null, null);
            if (cursor != null && cursor.moveToFirst()) {
    ...
    public static Bitmap loadRegionBitmap(Context context, BitmapCache cache,
        ...
        int w = 0;
        int h = 0;
        if (options.inSampleSize != 0 || uri == null) {
            return null;
        }
        try {
            is = context.getContentResolver().openInputStream(uri);
    ...
    public static Bitmap loadBitmap(Context context, Uri uri,
      ...
      //[ALM][BUGFIX]-Add by TCTNJ,qiang.ding1, 2015-04-23,PR186130 begin
        ...
        if (DrmManager.mCurrentDrm == DrmManager.MTK_DRM) {
            ...
            boolean index_Drm = false;
            boolean isDrm = false;
            String filePath = null;
            filePath = getFilePath(context, uri);
            //[ALM][BUGFIX]-Add by TCTNJ,jun.xie-nb, 2015-3-11,ALM-1644779 begin
            try {
                isDrm = DrmManager.isDrmFileExt(filePath);
            //[ALM][BUGFIX]-Add by TCTNJ,jun.xie-nb, 2015-3-11,ALM-1644779 end
                if (null != uri && null != uri.getPath() && isDrm) {
                    // check if this file is drm and can get decrypted buffer
                    byte[] buffer = DrmManager
                            .forceDecryptFile(filePath, false);
                    if (buffer != null) {
                        result = BitmapFactory.decodeByteArray(buffer, 0,
                                buffer.length, o);
                    } else {
                        return null;
                    }
            ...
            //[ALM][BUGFIX]-Add by TCTNJ,jun.xie-nb, 2015-3-11,ALM-1644779 begin
                ...
                Log.e(LOGTAG, "NullPointerException for ", e);
            //[ALM][BUGFIX]-Add by TCTNJ,jun.xie-nb, 2015-3-11,ALM-1644779 end
            } finally {
                Utils.closeSilently(is);
            }
            ...
            try {
                ...
                Log.e(LOGTAG, "IllegalArgumentException for " + uri, e);
  ...
  //[BUGFIX]-add by TCTNJ,qiang.ding1, 2015-04-21,PR186236 begain
    @SuppressLint("NewApi")
    public static String getFilePath(Context context, Uri uri) {
        ...
        try {
            // get file path from ringtone/notification/alarm alert
            ...
            if (scheme == null) {
                ...
                path = changeDrmFileSuffix(path);// [BUGFIX]-ADDED-BEGIN by TCTNB.hua.wang1, 06/05/2014, CR-687688
            }
          //[BUGFIX]-Add by TCTNJ,long.chen, 2014-06-05,PR687673 Begin
          ...
          //[BUGFIX]-Add by TCTNJ,long.chen, 2014-06-05,PR687673 end
    ...
    public static String changeDrmFileSuffix(String filePath) {
  ...
  //[BUGFIX]-add by TCTNJ,qiang.ding1, 2015-04-21,PR186236 end
