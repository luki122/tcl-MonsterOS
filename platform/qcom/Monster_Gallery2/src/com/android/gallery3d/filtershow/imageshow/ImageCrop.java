...
public class ImageCrop extends ImageShow {
    ...
    /* MODIFIED-BEGIN by caihong.gu-nb, 2016-05-10,BUG-2105073*/
    ...
    public ImageCrop(Context context, AttributeSet attrs, int defStyle) {
        ...
        setup(context);
        mContext = context;
        /* MODIFIED-END by caihong.gu-nb,BUG-2105073*/
    }

    private void setup(Context context) {
        Resources rsc = context.getResources();
        mCropIndicator = new Drawable[4];
        mCropIndicator[0] = rsc.getDrawable(R.drawable.camera_crop_left_top);
        mCropIndicator[1] = rsc.getDrawable(R.drawable.camera_crop_right_top);
        mCropIndicator[2] = rsc.getDrawable(R.drawable.camera_crop_left_bottom);
        mCropIndicator[3] = rsc.getDrawable(R.drawable.camera_crop_right_bottom);
    ...
    public void setFilterCropRepresentation(FilterCropRepresentation crop) {
        mLocalRep = (crop == null) ? new FilterCropRepresentation(mContext.getString(R.string.crop)) : crop; // MODIFIED by caihong.gu-nb, 2016-05-10,BUG-2105073
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mDisplayCropMatrix == null || mDisplayMatrix == null || mDisplayMatrixInverse == null) {
            ...
            //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-10-13, PR677893 begin
             /*MODIFIED-BEGIN by jian.pan1, 2016-04-01,BUG-1864148*/
...
/*            
            ...
            int delta = Math.min(canvas.getWidth(), canvas.getHeight()) / 8;
            ...
            //[BUGFIX]-Modify by TCTNJ, dongliang.feng, 2015-10-13, PR677893 end
            mCropObj.selectEdge(CropObject.MOVE_NONE);
*/			 
        }
        // Draw actual bitmap
        ...
        RectF outer = mCropObj.getOuterBounds();
        //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-05-21,PR1006757 begin
        internallyUpdateLocalRep(mScreenCropBounds, outer);
        //[BUGFIX]-Add by TCTNJ,jian.pan1, 2015-05-21,PR1006757 end
        ...
        if (mDisplayCropMatrix.mapRect(mScreenCropBounds)) {
             ...
             */
            // Modify To:
            Log.e("ImageCrop", "indicatorSize is " + mIndicatorSize);
            CropDrawingUtils.drawIndicators(canvas, mCropIndicator, mIndicatorSize,
                    mScreenCropBounds, mCropObj.isFixedAspect(),
                    decode(mCropObj.getSelectState(), mGeometry.rotation));
