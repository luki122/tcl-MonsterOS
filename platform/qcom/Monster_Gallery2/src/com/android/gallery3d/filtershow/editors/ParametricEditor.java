...
public class ParametricEditor extends Editor {
    ...
    public void reflectCurrentFilter() {
      ...
      //[BUGFIX]-Modify by TCTNJ,xinrong.wang, 2016-03-03,PR1718259 begin
        if (mControl!=null&&getLocalRepresentation() != null
                && getLocalRepresentation() instanceof FilterBasicRepresentation) {
            FilterBasicRepresentation interval = (FilterBasicRepresentation) getLocalRepresentation();
            mControl.setPrameter(interval);
        }
       //[BUGFIX]-Modify by TCTNJ,xinrong.wang, 2016-03-03,PR1718259 end
    }
    ...
    public void setUtilityPanelUI(View actionButton, View editControl) {
        ...
        if (param != null) {
            ...
            SeekBar mSeekBar = new SeekBar(editControl.getContext());
            LayoutParams lp = new LinearLayout.LayoutParams(
                    LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
            mSeekBar.setLayoutParams(lp);
            if (editControl instanceof FrameLayout)
                    ((FrameLayout) editControl).addView(mSeekBar);
            else
