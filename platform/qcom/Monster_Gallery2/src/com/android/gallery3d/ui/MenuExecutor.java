...
public class MenuExecutor {
    ...
    // TCL ShenQianfeng Begin on 2016.07.11
    private static final int MSG_ON_MEDIA_ITEM_DELETE = 100;
    // TCL ShenQianfeng End on 2016.07.11
    ...
    // TCL ShenQianfeng Begin on 2016.07.11
    public class OnDeleteInfo {
        public ProgressListener mListener;
        public MediaItem mMediaItem;
        public OnDeleteInfo(ProgressListener listener, MediaItem mediaItem) {
            mListener = listener;
                ...
                switch (message.what) {
                    ...
                    case MSG_TASK_COMPLETE: {
                        ...
                        if (message.obj != null) {
                            ...
                            // Modify To:
                            listener.onProgressComplete(message.arg1, message.arg2);
                            // TCL ShenQianfeng End on 2016.11.01
    ...
    */
    // Modify To:
    private void onProgressComplete(int result, int action, ProgressListener listener) {
        mHandler.sendMessage(mHandler.obtainMessage(MSG_TASK_COMPLETE, result, action, listener));
    }
    // TCL ShenQianfeng End on 2016.11.01

    
    // TCL ShenQianfeng Begin on 2016.07.11
    private void onDeleteMediaItem(ProgressListener listener, MediaItem mediaItem) {
        OnDeleteInfo info = new OnDeleteInfo(listener, mediaItem);
        mHandler.sendMessage(mHandler.obtainMessage(MSG_ON_MEDIA_ITEM_DELETE, info));
    }
    // TCL ShenQianfeng End on 2016.07.11
    ...
    // Modify To:
    //public class ConfirmDialogListener ...
    // TCL ShenQianfeng End on 2016.07.07
    public class ConfirmDialogListener implements OnClickListener, OnCancelListener {
    ...
    public void onMenuClicked(Item menuItem, String confirmMsg,
    ...
    private boolean execute(
        ...
        switch (cmd) {
            case R.id.action_delete:
                //LogUtil.d(TAG, "MenuExecutor::execute -->R.id.action_delete  path:" + path);
                manager.delete(path);
                break;
            case R.id.action_rotate_cw:
        ...
        public Void run(JobContext jc) {
            ...
            try {
                ...
                for (Path id : mItems) {
                    ...
                    // TCL ShenQianfeng Begin on 2016.07.11
                    /*
                    if(mOperation == R.id.action_delete) {
                        MediaObject object = manager.getMediaObject(id);
                        if(object instanceof MediaItem) {
                           MediaItem item = (MediaItem)object;
                           onDeleteMediaItem(mListener, item);
                        }
                    }
                    */
                    // TCL ShenQianfeng End on 2016.07.11
               ...
               // Modify To:
               onProgressComplete(result, mOperation, mListener);
               // TCL ShenQianfeng End on 2016.11.01
            }
            return null;
        }
