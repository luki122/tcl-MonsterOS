...
public class TiledTexture implements Texture {
    // TCL ShenQianfeng Begin on 2016.10.14
    // Original:
    ...
    // TCL ShenQianfeng End on 2016.10.14
        ...
        protected Bitmap onGetBitmap() {
            ...
            if (localBitmapRef != null) {
                ...
                */
                ...
                /*
                LogUtil.d("Tile", "------------------------------------------------------------------------");
                LogUtil.d("Tile", "Tile onGetBitmap offsetX:" + (offsetX));
                LogUtil.d("Tile", "Tile onGetBitmap offsetY:" + (offsetY));
                LogUtil.d("Tile", "Tile onGetBitmap x>0:" + (x > 0) + " x:" + x);
                LogUtil.d("Tile", "Tile onGetBitmap y>0:" + (y > 0) + " y:" + y);
                LogUtil.d("Tile", "Tile onGetBitmap r < CONTENT_SIZE: " + (r < CONTENT_SIZE));
                LogUtil.d("Tile", "Tile onGetBitmap b < CONTENT_SIZE: " + (b < CONTENT_SIZE));
                */
            }
    ...
    public static void prepareResources() {
        ...
        sBitmapPaint = new Paint(Paint.FILTER_BITMAP_FLAG); /* | Paint.ANTI_ALIAS_FLAG */
    ...
    public void draw(GLCanvas canvas, int x, int y, int width, int height) {
        ...
        synchronized (mTiles) {
            for (int i = 0, n = mTiles.length; i < n; ++i) {
                ...
                //LogUtil.d("TiledTexture", "TiledTexture::draw x:" + x + " y:" + y + " mSrcRect:" + mSrcRect + " mDestRect:" + mDestRect);
            }
        }
    }
