...
public abstract class UploadedTexture extends BasicTexture {
    ...
    // for .gif images
    protected boolean mAlwaysUpdate = false;
    ...
    public void updateContent(GLCanvas canvas) {
        //LogUtil.i2(TAG, "UploadedTexture::updateContent");
        if (!isLoaded()) {
    ...
    private void uploadToCanvas(GLCanvas canvas) {
        ...
        if (bitmap != null && !bitmap.isRecycled()) {
            try {
                ...
                //LogUtil.d(TAG, "bWidth:" + bWidth + " bHeight:" + bHeight + " width:" + width + " height:" + height + " texWidth:" + texWidth + " texHeight:" + texHeight);
