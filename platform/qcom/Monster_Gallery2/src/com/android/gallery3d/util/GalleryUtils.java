...
public class GalleryUtils {
    ...
    public static int floatARGBArrayToIntColor(float[] array) {
        int a = (int)(array[0] * 255);
        int r = (int)(array[1] * 255);
        int g = (int)(array[2] * 255);
        int b = (int)(array[3] * 255);
        //LogUtil.d(TAG, " a: " + a + " r: " + r + " g: " + g + " b: " + b);
    ...
    public static boolean isChineseLocale(Configuration config) {
