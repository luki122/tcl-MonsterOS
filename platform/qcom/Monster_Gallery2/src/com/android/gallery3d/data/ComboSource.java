...
class ComboSource extends MediaSource {
    ...
    public MediaObject createMediaObject(Path path) {
        ...
        switch (mMatcher.match(path)) {
            ...
            case COMBO_ALBUM:
               //TCL ShenQianfeng Begin on 2016.06.14
               //Original: 
               /*
               ...
               */
                //Modify To:
                //There was no SortedComboAlbum in the world. It was me who created it. So, I'm its God!
                return new SortedComboAlbum(path,
                        dataManager.getMediaSetsFromString(segments[2]), segments[1]);
              //TCL ShenQianfeng End on 2016.06.14
