...
public abstract class MediaItem extends MediaObject {
    ...
    //public static final int TYPE_WHOLE_ = 3;
    ...
    public static final String MIME_TYPE_BMP = "image/x-ms-bmp";
    ...
    private static final int TARGET_SIZE_THUMBNAIL = 600;
    private static final int TARGET_SIZE_MICRO_THUMBNAIL = 200;
    ...
    // Modify To:
    private static int sThumbnailTargetSize = TARGET_SIZE_THUMBNAIL;
    private static int sMicrothumbnailTargetSize = TARGET_SIZE_MICRO_THUMBNAIL;
    // TCL ShenQianfeng End on 2016.08.04
