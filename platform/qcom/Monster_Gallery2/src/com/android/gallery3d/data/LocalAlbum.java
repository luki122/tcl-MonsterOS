...
public class LocalAlbum extends MediaSet {
    ...
    public LocalAlbum(Path path, GalleryApp application, int bucketId,
        ...
        if (isImage) {
            ...
            // Modify To:
            mWhereClause = ImageColumns.DATA + " LIKE '" + MediaSetUtils.getFilePathByBucketId(bucketId) + "/%'";
            ...
            // Modify To:
            mWhereClause =  VideoColumns.DATA + " LIKE '" + MediaSetUtils.getFilePathByBucketId(bucketId) + "/%' AND (" + 
                                                    VideoColumns.DISPLAY_NAME + " LIKE '%.mp4'" + " OR " + 
                                                    VideoColumns.DISPLAY_NAME + " LIKE '%.3gp'" + " OR " + 
                                                    VideoColumns.DISPLAY_NAME + " LIKE '%.ts'" + " OR " + 
                                                    VideoColumns.DISPLAY_NAME + " LIKE '%.mkv'" + " OR " + 
                                                    VideoColumns.DISPLAY_NAME + " LIKE '%.webm'" + " OR " +
                                                    VideoColumns.DISPLAY_NAME + " LIKE '%.avi'" + " OR " +
                                                    VideoColumns.DISPLAY_NAME + " LIKE '%.mkv'" + " ) " ;
            // TCL ShenQianfeng End on 2016.11.22
    ...
    public static String getLocalizedName(Resources res, int bucketId,
        ...
        } else if (bucketId == MediaSetUtils.SCREENSHOTS_BUCKET_ID) {
