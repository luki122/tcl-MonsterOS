...
public class ApiHelper {
    ...
    public static interface VERSION_CODES {
      ...
      //int a = Build.VERSION_CODES.KITKAT;
        ...
        public static final int MARSHMALLOW = 23; //6.0
        // TCL ShenQianfeng End on 2016.08.04
        
    }
	
	//[BUGFIX]-Add by TCTNJ,caihong.gu-nb, 2016/01/21,PR1238666 begin
    public static final boolean CAN_SET_STATUS_BAR_COLOR = Build.VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP;
    //[BUGFIX]-Add by TCTNJ,caihong.gu-nb, 2016/01/21,PR1238666 end
    ...
    // TCL ShenQianfeng Begin on 2016.08.04
    public static final boolean HAS_SYSTEM_UI_FLAG_LIGHT_STATUS_BAR  = 
            Build.VERSION.SDK_INT >= VERSION_CODES.MARSHMALLOW; 
    // TCL ShenQianfeng End on 2016.08.04
