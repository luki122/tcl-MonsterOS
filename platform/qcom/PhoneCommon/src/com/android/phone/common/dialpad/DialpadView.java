...
public class DialpadView extends LinearLayout {
	...
	private static final double DURATION_MULTIPLIER = 0.6;
	...
	public void setmDigits(EditText mDigits) {
	...
	protected void onFinishInflate() {
		...
		mFold=findViewById(R.id.mst_fold_dialpad);
