...
public class AddBlackByNumber extends MstActivity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    mList.setEmptyView(findViewById(R.id.empty_calllog_view_layout_id));
...
//				safeQuitDeleteMode();
	...
	private void initActionBar(boolean flag) {
		showActionMode(flag);
		mBottomNavigationView.setVisibility((flag && !mIsEmpty) ? View.VISIBLE : View.GONE);
	}
