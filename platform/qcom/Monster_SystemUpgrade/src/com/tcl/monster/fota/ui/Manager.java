...
/*                final int actionBarContainerId = Resources.getSystem().getIdentifier(
                ...
                if (actionBarContainer != null) {
                    ...
                    ((ViewGroup.MarginLayoutParams) params).topMargin =  (int) (42 * scale);
                }*/
                float scale = activity.getResources().getDisplayMetrics().density;
                ((ViewGroup.MarginLayoutParams) params).topMargin =  (int) (42 * scale);
...
//                }
    ...
    private void handleTranslucentActionBar(ViewGroup.MarginLayoutParams params, Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            /*
             * Checks whether translucent status is enabled for this window. If
             * true, sets the top margin to show the crouton just below the
             * action bar.
             */
    ...
    protected void removeCrouton(Crouton crouton) {
        ...
        if (null != croutonParentView) {
            ...
            sendMessageDelayed(crouton, Messages.DISPLAY_CROUTON, 500);
        }
    }
