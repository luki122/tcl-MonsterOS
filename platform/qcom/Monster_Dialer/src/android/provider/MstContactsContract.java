 ...
 * <h3>Overview</h3>
 * <p>
 * MstContactsContract defines an extensible database of contact-related
...
public final class MstContactsContract {
     ...
     * Example usage:
     * <pre>
     * Uri profileUri = MstContactsContract.Profile.CONTENT_VCARD_URI;
     * Bundle uriBundle = new Bundle();
     * uriBundle.putParcelable(MstContactsContract.Authorization.KEY_URI_TO_AUTHORIZE, uri);
     * Bundle authResponse = getContext().getContentResolver().call(
     *         MstContactsContract.AUTHORITY_URI,
     *         MstContactsContract.Authorization.AUTHORIZATION_METHOD,
     *         null, // String arg, not used.
     *         uriBundle);
     * if (authResponse != null) {
     *     Uri preauthorizedProfileUri = (Uri) authResponse.getParcelable(
     *             MstContactsContract.Authorization.KEY_AUTHORIZED_URI);
     ...
     * expected to support at least {@link MstContactsContract.Contacts#CONTENT_FILTER_URI
     ...
     * if MstContactsContract is extended with new fields in the future.
     * </p>
     * <p>
    ...
    /**
     * Columns of {@link MstContactsContract.Contacts} that track the user's
     * preferences for, or interactions with, the contact.
     *
     * @see Contacts
     * @see RawContacts
     * @see MstContactsContract.Data
     * @see PhoneLookup
     * @see MstContactsContract.Contacts.AggregationSuggestions
     */
    ...
    /**
     * Columns of {@link MstContactsContract.Contacts} that refer to intrinsic
    ...
    protected interface ContactsColumns {
         ...
         * {@link MstContactsContract.DisplayPhoto#CONTENT_URI} to create a URI to the photo.
         ...
         * {@link MstContactsContract.DisplayPhoto#CONTENT_URI}.  Otherwise, this will
    ...
    protected interface ContactNameColumns {
         ...
         * <p>
         *
         * @see MstContactsContract.ContactNameColumns#DISPLAY_NAME_ALTERNATIVE
         */
    ...
    interface ContactCounts {
         ...
         * Example:
         *
         * import android.provider.MstContactsContract.Contacts;
         *
     ...
     * address, nickname, etc, use a query against the {@link MstContactsContract.Data} table.
     ...
     * <td>{@link #PHOTO_ID}</td>
     * <td>read-only</td>
     * <td>Reference to the row in the {@link MstContactsContract.Data} table holding the photo.
    ...
    public static class Contacts implements BaseColumns, ContactsColumns,
        ...
        */
         ...
         * given {@link MstContactsContract.Contacts#_ID} and {@link #LOOKUP_KEY}.
         * <p>
         ...
         * {@link MstContactsContract.Data}, filtered to include only starred contacts
         ...
         * {@link MstContactsContract.Data} rows.  This directory can be used either
         ...
         * {@link MstContactsContract.RawContacts} as well as
         * {@link MstContactsContract.Data} rows. To access this directory append
         ...
         * <p>
         * A sub-directory of a single contact that contains all of the constituent raw contact
         * {@link MstContactsContract.StreamItems} rows.  This directory can be used either
         * with a {@link #CONTENT_URI} or {@link #CONTENT_LOOKUP_URI}.
         * </p>
         * <p>
        ...
        public static final class AggregationSuggestions implements BaseColumns, ContactsColumns,
             ...
             * {@link android.provider.MstContactsContract.Contacts#CONTENT_FILTER_URI}.
             */
         ...
         * {@link MstContactsContract.Contacts#openContactPhotoInputStream(ContentResolver, Uri, boolean)}
        ...
        public static final class Photo implements BaseColumns, DataColumnsWithJoins {
             ...
             * See {@link MstContactsContract.DisplayPhoto}.
             * <p>
             * Type: NUMBER
             */
        ...
        public static InputStream openContactPhotoInputStream(ContentResolver cr, Uri contactUri,
            ...
            Cursor cursor = cr.query(photoUri,
                    new String[] {
                        MstContactsContract.CommonDataKinds.Photo.PHOTO
                    }, null, null, null);
            try {
    ...
    protected interface DeletedContactsColumns {
        ...
        /**
         * A reference to the {@link MstContactsContract.Contacts#_ID} that was deleted.
         * <P>Type: INTEGER</P>
         */
    ...
    protected interface RawContactsColumns {
        /**
         * A reference to the {@link MstContactsContract.Contacts#_ID} that this
         * data belongs to.
         * <P>Type: INTEGER</P>
         */
        public static final String CONTACT_ID = "contact_id";
         ...
         * {@link MstContactsContract.RawContacts#ACCOUNT_TYPE} and
         * {@link MstContactsContract.RawContacts#DATA_SET} directly.
         */
         ...
         * {@link MstContactsContract#CALLER_IS_SYNCADAPTER} query parameter to finalize
         * the data removal.
         * <P>Type: INTEGER</P>
         */
         ...
         * deleted except by a sync adapter.  See {@link MstContactsContract#CALLER_IS_SYNCADAPTER}.
         * <P>Type: INTEGER</P>
         */
     ...
     *          .build());
     *
     * getContentResolver().applyBatch(MstContactsContract.AUTHORITY, ops);
     * </pre>
     * </p>
     * <p>
     ...
     * again and passing the {@link MstContactsContract#CALLER_IS_SYNCADAPTER} query parameter.<p>
     ...
     * <td>read-only</td>
     * <td>The ID of the row in the {@link MstContactsContract.Contacts} table
     ...
     * {@link MstContactsContract.Contacts#markAsContacted}.</td>
     * </tr>
     * <tr>
     * <td>long</td>
     * <td>{@link #LAST_TIME_CONTACTED}</td>
     ...
     * should be set at the time the raw contact is inserted.
     * After that, this value is typically updated via
     * {@link MstContactsContract.Contacts#markAsContacted}.
     * </td>
     * </tr>
     * <tr>
     * <td>int</td>
     ...
     * ringtone on a contact, use the field {@link MstContactsContract.Contacts#CUSTOM_RINGTONE
     ...
     * {@link MstContactsContract#CALLER_IS_SYNCADAPTER} query parameter specified.
    ...
    public static final class RawContacts implements BaseColumns, RawContactsColumns,
        ...
        /**
         * Build a {@link android.provider.MstContactsContract.Contacts#CONTENT_LOOKUP_URI}
         * style {@link Uri} for the parent {@link android.provider.MstContactsContract.Contacts}
         ...
         * {@link MstContactsContract.Data} rows. To access this directory
         ...
         * <p>
         * A sub-directory of a single raw contact that contains all of its
         * {@link MstContactsContract.StreamItems} rows. To access this directory append
         * {@link RawContacts.StreamItems#CONTENT_DIRECTORY} to the raw contact URI. See
         * {@link MstContactsContract.StreamItems} for a stand-alone table containing the
         * same data.
         * </p>
         * <p>
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public android.content.Entity getEntityAndIncrementCursor(Cursor cursor)
                ...
                do {
                    ...
                    contact.addSubValue(MstContactsContract.Data.CONTENT_URI, cv);
                } while (cursor.moveToNext());
     ...
     * Users of this API can query {@link MstContactsContract.StreamItems#CONTENT_LIMIT_URI} to
     ...
     * </pre>
     * </dd>
     * <dt>Via {@link MstContactsContract.StreamItems#CONTENT_PHOTO_URI}:</dt>
     * <dd>
     * <pre>
     * values.clear();
    ...
    public static final class StreamItems implements BaseColumns, StreamItemsColumns {
        ...
        /**
         * Queries to {@link MstContactsContract.StreamItems#CONTENT_LIMIT_URI} will
     ...
     *
     * @see MstContactsContract.StreamItems
     * @deprecated - Do not use. This will not be supported in the future. In the future,
     * cursors returned from related queries will be empty.
     *
     * @hide
    ...
    protected interface StreamItemsColumns {
        /**
         * A reference to the {@link android.provider.MstContactsContract.Contacts#_ID}
        ...
        /**
         * A reference to the {@link android.provider.MstContactsContract.Contacts#LOOKUP_KEY}
         * that this stream item belongs to.
         *
         * <p>Type: TEXT</p>
         * <p>read-only</p>
     ...
     * </pre>
     * </dd>
     * <dt>Via the {@link MstContactsContract.StreamItems#CONTENT_PHOTO_URI} URI:</dt>
     * <dd>
     * <pre>
     * ContentValues values = new ContentValues();
     * values.put(StreamItemPhotos.STREAM_ITEM_ID, streamItemId);
     ...
     * can be used in conjunction with the {@link MstContactsContract.DisplayPhoto} API to
     ...
     *
     * @see MstContactsContract.StreamItemPhotos
     * @deprecated - Do not use. This will not be supported in the future. In the future,
     * cursors returned from related queries will be empty.
     *
     * @hide
     ...
     *
     * @see MstContactsContract.PhotoFiles
     *
     * @hide
     */
    ...
    /**
     * Combines all columns returned by {@link MstContactsContract.Data} table queries.
     *
     * @see MstContactsContract.Data
     */
     ...
     * </p>
     * <p>
     * MstContactsContract defines a small number of pre-defined data kinds, e.g.
     ...
     * {@link MstContactsContract.Data Data.DATA1}.
     * </p>
     * <p>
     ...
     * <table class="jd-sumtable">
     * <tr>
     * <th colspan='4'>Join with {@link MstContactsContract.RawContacts}</th>
     * </tr>
     * <tr>
     * <td style="width: 7em;">long</td>
     ...
     * {@link MstContactsContract.Contacts} is available
     ...
     * <table class="jd-sumtable">
     * <tr>
     * <th colspan='4'>Join with {@link MstContactsContract.Contacts}</th>
     * </tr>
     * <tr>
     * <td style="width: 7em;">String</td>
     * <td style="width: 20em;">{@link #LOOKUP_KEY}</td>
     * <td style="width: 5em;">read-only</td>
     * <td>See {@link MstContactsContract.Contacts}</td>
     * </tr>
     * <tr>
     * <td>String</td>
    ...
    public final static class Data implements DataColumnsWithJoins, ContactCounts {
        ...
        */
         ...
         * Build a {@link android.provider.MstContactsContract.Contacts#CONTENT_LOOKUP_URI}
         * style {@link Uri} for the parent {@link android.provider.MstContactsContract.Contacts}
         * entry of the given {@link MstContactsContract.Data} entry.
         * </p>
         * <p>
     ...
     * <td>{@link #MIMETYPE}</td>
     * <td>read-only</td>
     * <td>See {@link MstContactsContract.Data}.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     * <td>{@link #IS_PRIMARY}</td>
    ...
    public static final class PhoneLookup implements BaseColumns, PhoneLookupColumns,
         ...
         *     {@link MstContactsContract.Contacts#isEnterpriseContactId(long)}.
         *     </li>
         *     <li>
         ...
         * {@link MstContactsContract.Contacts#getLookupUri(long, String)}
         * with an {@link #_ID} and a {@link #LOOKUP_KEY} returned by this API can be passed to
         * {@link MstContactsContract.QuickContact#showQuickContact} even if a contact is from the
         * corp profile.
         * </p>
         *
         * <pre>
     ...
     * back to specific {@link MstContactsContract.Data#_ID} entries.
     *
     * @see StatusUpdates
     */
    protected interface PresenceColumns {
         ...
         * {@link MstContactsContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}.  Should be null or
         * omitted if {@link #PROTOCOL} value is not
         * {@link MstContactsContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}.
         *
         * <p>Type: NUMBER</p>
         */
    ...
    /**
     * <p>
     * A status update is linked to a {@link MstContactsContract.Data} row and captures
     ...
     * {@link MstContactsContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}.  Should be null or
     * omitted if {@link #PROTOCOL} value is not
     * {@link MstContactsContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     ...
     * {@link MstContactsContract.Contacts#CONTENT_FILTER_URI Contacts.CONTENT_FILTER_URI} explaining
     ...
     * if (extras.getBoolean(MstContactsContract.DEFERRED_SNIPPETING)) {
    ...
    public static class SearchSnippets {
         ...
         * {@link MstContactsContract#DEFERRED_SNIPPETING} in the cursor. If it exists, the client
    ...
    /**
     * Container for definitions of common data types stored in the {@link MstContactsContract.Data}
     * table.
     */
    public static final class CommonDataKinds {
         ...
         * columns defined for {@link MstContactsContract.Data} as well as the following aliases.
         *
        ...
        public static final class StructuredName implements DataColumnsWithJoins, ContactCounts {
             ...
             * See {@link MstContactsContract.FullNameStyle}.
             */
            public static final String FULL_NAME_STYLE = DATA10;

            /**
             * The alphabet used for capturing the phonetic name.
             * See MstContactsContract.PhoneticNameStyle.
             * @hide
             */
         ...
         * </p>
         * <p>
         * You can use all columns defined for {@link MstContactsContract.Data} as well as the
         * following aliases.
         * </p>
         *
         * <h2>Column aliases</h2>
         ...
         * </p>
         * <p>
         * You can use all columns defined for {@link MstContactsContract.Data} as
        ...
        public static final class Organization implements DataColumnsWithJoins, CommonColumns,
            ...
            /**
             * The alphabet used for capturing the phonetic name.
             * See {@link MstContactsContract.PhoneticNameStyle}.
             * @hide
             */
         ...
         * pass. A common pattern is to use columns {@link MstContactsContract.Data#SYNC1}
         * through {@link MstContactsContract.Data#SYNC4} to store temporary
    ...
    protected interface GroupsColumns {
         ...
         * {@link MstContactsContract#CALLER_IS_SYNCADAPTER} query parameter to
     ...
     * this time setting the the {@link MstContactsContract#CALLER_IS_SYNCADAPTER}
     ...
     * {@link MstContactsContract.Contacts#CONTENT_FILTER_URI},
     * {@link MstContactsContract.CommonDataKinds.Email#CONTENT_FILTER_URI},
     * {@link MstContactsContract.CommonDataKinds.Phone#CONTENT_FILTER_URI}, and users can benefit
    ...
    public static final class PinnedPositions {
        ...
        public static void undemote(ContentResolver contentResolver, long contactId) {
            contentResolver.call(MstContactsContract.AUTHORITY_URI, PinnedPositions.UNDEMOTE_METHOD,
    ...
    public static final class QuickContact {
         ...
         * {@link MstContactsContract.Data} rows under that contact, and may also
         ...
         * @param lookupUri A {@link MstContactsContract.Contacts#CONTENT_LOOKUP_URI} style
         ...
         * @param lookupUri A
         *            {@link MstContactsContract.Contacts#CONTENT_LOOKUP_URI} style
         *            {@link Uri} that describes a specific contact to feature
         *            in this dialog.
         * @param mode Any of {@link #MODE_SMALL}, {@link #MODE_MEDIUM}, or
         *            {@link #MODE_LARGE}, indicating the desired dialog size,
        ...
        public static void showQuickContact(Context context, View target, Uri lookupUri,
            ...
            // values defined in MstContactsContract only affect very old implementations
            // of QuickContacts.
     ...
     * {@link MstContactsContract.ContactsColumns#PHOTO_FILE_ID})
     * </dt>
     * <dd>
     * <pre>
    ...
    public static final class DisplayPhoto {
        ...
        /**
         * Queries to {@link MstContactsContract.DisplayPhoto#CONTENT_MAX_DIMENSIONS_URI} will
