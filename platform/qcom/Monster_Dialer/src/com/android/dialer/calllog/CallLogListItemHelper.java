...
/* package */class CallLogListItemHelper {
	...
	public void setScrollStauts(int scrollStauts) {
		mPhoneCallDetailsHelper.setScrollStauts(scrollStauts);
	}
    /**
    ...
    public void setPhoneCallDetails(
        ...
        mPhoneCallDetailsHelper.setPhoneCallDetails(views.phoneCallDetailsViews, details,views);

        // Set the accessibility text for the contact badge
//        if(views.quickContactView!=null) views.quickContactView.setContentDescription(getContactBadgeDescription(details));
