...
VoicemailPlaybackPresenter.OnVoicemailDeletedListener {
	...
	public void updateActionMode(){
		...
		bottomBar.setVisibility(isNoneSelect()?View.GONE:View.VISIBLE);
	}
...
//			Toast.makeText(mContext, "删除成功", Toast.LENGTH_LONG);
	...
	private void bindCallLogListViewHolder(ViewHolder viewHolder, int position) {
		...
		if(is_editor_mode) {
			...
			views.slider.setLockDrag(true);
		}else {
			views.checkBox.setVisibility(View.GONE);
			views.primaryActionButtonViewParent.setVisibility(View.VISIBLE);
			views.slider.setLockDrag(false);
		}

		if(views.slider.isOpened()){
			views.slider.close(false);
		}

		views.slider.setSwipeListener(new SwipeListener(){
