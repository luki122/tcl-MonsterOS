...
/*<<<<<<< HEAD
    ...
    private CheckBoxPreferenceSwitchPreference mVibrateWhenRinging;
    private CheckBoxPreferenceSwitchPreference mPlayDtmfTone;
=======*/
...
//                    mRingtonePreference.setSummary((CharSequence) msg.obj);
                    mRingtonePreference.setDetail(((CharSequence) msg.obj).toString());
                    break;
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        context =SoundSettingsActivity.this;
        
        Toolbar toolbar = getToolbar();
        toolbar.setTitle(getResources().getString(R.string.sounds_and_vibration_title));

//<<<<<<< HEAD
//        mRingtonePreference = findPreference(context.getString(R.string.ringtone_preference_key));
//=======
        mRingtonePreference = (DefaultRingtonePreference)findPreference(context.getString(R.string.ringtone_preference_key));
    ...
    private boolean shouldVibrateWhenRinging() {
        int vibrateWhenRingingSetting = Settings.System.getInt(context.getContentResolver(),
                Settings.System.VIBRATE_WHEN_RINGING,
    ...
    private boolean shouldPlayDtmfTone() {
        int dtmfToneSetting = Settings.System.getInt(context.getContentResolver(),
                Settings.System.DTMF_TONE_WHEN_DIALING,
                PLAY_DTMF_TONE);
