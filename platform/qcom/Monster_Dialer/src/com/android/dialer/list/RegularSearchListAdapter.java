...
import com.android.dialer.list.DialerPhoneNumberListAdapter.ViewHolder;
...
public class RegularSearchListAdapter extends DialerPhoneNumberListAdapter {
    private static final String TAG = "RegularSearchListAdapter";
    ...
    public RegularSearchListAdapter(Context context) {
        ...
        setShortcutEnabled(SHORTCUT_DIRECT_CALL,false);
        headerBackgroundColor=context.getResources().getColor(R.color.contact_main_background);
    }

    @Override
	protected View newView(Context context, int partition, Cursor cursor, int position,
			ViewGroup parent) {
    	View view=super.newView(context, partition, cursor, position, parent);
    	ViewHolder viewHolder=(ViewHolder)view.getTag();
    	viewHolder.header.setBackgroundColor(headerBackgroundColor);
    	return view;
    }
