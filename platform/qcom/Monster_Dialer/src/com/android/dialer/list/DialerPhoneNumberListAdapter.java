				...
				public void onClick(View view) {
					...
					if(null == CallLogAdapter.popupWindow || !CallLogAdapter.popupWindow.isShowing()){  
						...
						sendMessageView.setOnClickListener(new View.OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								context.startActivity(IntentUtil.getSendSmsIntent(name));
							}
						});
						...
						CallLogAdapter.popupWindow = new PopupWindow(contentView, DensityUtil.dip2px(context, 150), 
						...
						CallLogAdapter.popupWindow.showAtLocation(view, Gravity.TOP | Gravity.RIGHT,
								DensityUtil.dip2px(context, 20), location[1]+DensityUtil.dip2px(context, 20));
