...
public class PrivacyUtils {
	...
	private static final String TAG = "Dial-PrivacyUtils";
                ...
                public void run() {
                    ...
                    if (mPrivacyManSer != null && mIsServiceConnected) {
                        try {
                            ...
                            mPrivacyManSer.setPrivacyNum("com.android.dialer", calssName, number, accountId);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
	...
	public static void killPrivacyActivity() {
		try {
			if (DialerApplication.mPrivacyActivityList != null) {
				for (Activity ac : DialerApplication.mPrivacyActivityList) {
					ac.finish();
				}
			}
		} catch (Exception e) {
