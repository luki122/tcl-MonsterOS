...
public class PrivacyDataUtils {
    ...
    public static int[] getPrivateData(Uri uri) {
        ...
        if (url.startsWith("content://com.android.contacts/contacts/lookup/")
            ...
            long RawContactId = queryForRawContactId(DialerApplication.getInstance().getContentResolver(), Long.parseLong(uri
                    .getLastPathSegment()));
            ...
            Cursor c = DialerApplication.getInstance()
                    .getContentResolver()
            ...
            Cursor cursor = DialerApplication.getInstance()
                    .getContentResolver()
                    .query(uri,
    ...
    public static long getDataIdByRawContactId(long rawContactId) {
        ...
        Cursor cursor = DialerApplication.getInstance().getContentResolver().query(Data.CONTENT_URI,
                new String[] {Data._ID},
    ...
    public static String getPrivateRingNotificationText(long accountId) {
        ...
        String defaultText = DialerApplication.getInstance()
