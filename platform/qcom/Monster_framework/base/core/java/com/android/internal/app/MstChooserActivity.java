...
public class MstChooserActivity extends MstResolverActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        overridePendingTransition(com.mst.R.anim.activity_open_enter, com.mst.R.anim.activity_open_exit) ;
...
//        MetricsLogger.action(this, MetricsLogger.ACTION_ACTIVITY_CHOOSER_SHOWN);
    ...
    public int getLayoutResource() {
        return com.mst.R.layout.chooser_grid;
    }
...
//        }
    ...
    final class ChooserTargetInfo implements TargetInfo {
        ...
        public ChooserTargetInfo(DisplayResolveInfo sourceInfo, ChooserTarget chooserTarget,
            ...
            mDisplayIcon = icon != null ? icon.loadDrawable(MstChooserActivity.this) : null;
    ...
    public class ChooserListAdapter extends ResolveListAdapter {
        ...
        private final List<TargetInfo> mFirstLineTargets = new ArrayList<>();
        private final List<TargetInfo> mTempTargets = new ArrayList<>();
...
//                        ri.activityInfo.name,
                    ...
                    Log.d("chooser", "componentName--->"+ri.activityInfo.name);
                    if(inFirstLine(ri.activityInfo.name)){
                        DisplayResolveInfo dri = new DisplayResolveInfo(ii, ri,
                                ri.loadLabel(pm), null, ii);
                        dri.mIndexInFirstLine = indexInFirstLine(ri.activityInfo.name);
                        mFirstLineTargets.add(dri);
                    }else{
                    	mTempTargets.add(new DisplayResolveInfo(ii, ri,
	                            ri.loadLabel(pm), null, ii));
                    }
                }
                mCallerTargets.addAll(mFirstLineTargets);
                mCallerTargets.addAll(mTempTargets);
                mFirstLineTargets.clear();
                mTempTargets.clear();
            }
        }
        ...
        public View onCreateView(ViewGroup parent) {
            return mInflater.inflate(
                    com.mst.R.layout.resolve_grid_item, parent, false);
        }
    ...
    static class RowScale {
        ...
        public RowScale(@NonNull BaseAdapter adapter, float from, float to) {
            mAdapter = adapter;
            mScale = from;
            if (from == to) {
                mAnimator = null;
    ...
    class ChooserRowAdapter extends BaseAdapter {
        ...
        public ChooserRowAdapter(ChooserListAdapter wrappedAdapter) {
            ...
            mLayoutInflater = LayoutInflater.from(MstChooserActivity.this);

            mInterpolator = AnimationUtils.loadInterpolator(MstChooserActivity.this,
        ...
        RowViewHolder createViewHolder(ViewGroup parent) {
            final ViewGroup row = (ViewGroup) mLayoutInflater.inflate(com.mst.R.layout.chooser_row,
                    parent, false);
            ...
            for (int i = 0; i < mColumnCount; i++) {
                ...
                v.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                    	Log.d("click", "position-->"+holder.itemIndices[column]);
...
//                });
        ...
        void bindViewHolder(int rowPosition, RowViewHolder holder) {
            ...
            if (startType == ChooserListAdapter.TARGET_SERVICE) {
                holder.row.setBackgroundColor(
                        getColor(com.android.internal.R.color.chooser_service_row_background_color));
            } else {
    ...
    static class ChooserTargetServiceConnection implements ServiceConnection {
        ...
        private MstChooserActivity mChooserActivity;
        ...
        public ChooserTargetServiceConnection(MstChooserActivity chooserActivity,
    ...
    static class RefinementResultReceiver extends ResultReceiver {
        ...
        public RefinementResultReceiver(MstChooserActivity host, TargetInfo target,
                Handler handler) {
            super(handler);
