...
public class AlertController extends com.android.internal.app.AlertController{
    ...
    private View.OnClickListener mOnIconClickListener;//add by caizhongting
    private boolean noTitleBar = false;//add by caizhongting
    private boolean noNavigationBar = false;//add by caizhongting
    private boolean hasScrollIndicators = false;//add by caizhongting
    ...
    public AlertController(Context context, DialogInterface di, Window window) {
        ...
        mAlertDialogLayout = a.getResourceId(
                R.styleable.AlertDialog_layout, com.mst.R.layout.alert_dialog_material);
        mButtonPanelSideLayout = a.getResourceId(
                R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        mListLayout = a.getResourceId(
                R.styleable.AlertDialog_listLayout, com.mst.R.layout.select_dialog_material);

        mMultiChoiceItemLayout = a.getResourceId(
                R.styleable.AlertDialog_multiChoiceItemLayout,
                com.mst.R.layout.select_dialog_multichoice_material);
        mSingleChoiceItemLayout = a.getResourceId(
                R.styleable.AlertDialog_singleChoiceItemLayout,
                com.mst.R.layout.select_dialog_singlechoice_material);
        mListItemLayout = a.getResourceId(
                R.styleable.AlertDialog_listItemLayout,
                com.mst.R.layout.select_dialog_item_material);

         //add by caizhongting
         noTitleBar = a.getBoolean(
                R.styleable.AlertDialog_noTitleBar,true);

         noNavigationBar = a.getBoolean(
                R.styleable.AlertDialog_noNavigationBar,true);

         hasScrollIndicators = a.getBoolean(
	       R.styleable.AlertDialog_hasScrollIndicators,true);
         android.util.Log.d("cai","AlertController -> AlertController : noTitleBar = "+noTitleBar+";noNavigationBar = "+noNavigationBar);
         //end add
	...
	installContent(noTitleBar,noNavigationBar);
    }

    public void installContent(boolean notitle, boolean ingnoreSystemUI) {
    ...
    public void setTitleFontFamily(String family,int style) {
        mTitleFontFamily = family;
        mTitleFontStyle = style;
        if (mTitleView != null) {
            mTitleView.setTypeface(Typeface.create(family,style));
        }
    }

    public void setTitleDividerColor(int color) {
        mTitleDividerColor = color;
    ...
    public void setTitleBackground(int color) {
        mTitleBackground = color;
        if (mTitleTemplate != null) {
            mTitleTemplate.setBackgroundColor(color);
        }
    }
    ...
    private void setupDecor() {
        ...
        final View parent = mWindow.findViewById(com.android.internal.R.id.parentPanel);
    ...
    private void setupView() {
        final View parentPanel = mWindow.findViewById(com.android.internal.R.id.parentPanel);
        final View defaultTopPanel = parentPanel.findViewById(com.android.internal.R.id.topPanel);
        final View defaultContentPanel = parentPanel.findViewById(com.android.internal.R.id.contentPanel);
        final View defaultButtonPanel = parentPanel.findViewById(com.android.internal.R.id.buttonPanel);

        // Install custom content before setting up the title or buttons so
        // that we can handle panel overrides.
        final ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(com.android.internal.R.id.customPanel);
        setupCustomContent(customPanel);

        final View customTopPanel = customPanel.findViewById(com.android.internal.R.id.topPanel);
        final View customContentPanel = customPanel.findViewById(com.android.internal.R.id.contentPanel);
        final View customButtonPanel = customPanel.findViewById(com.android.internal.R.id.buttonPanel);
        ...
        if (!hasButtonPanel) {
            if (contentPanel != null) {
                final View spacer = contentPanel.findViewById(com.android.internal.R.id.textSpacerNoButtons);
                if (spacer != null) {
        ...
        View textSpacerNoTitle = parentPanel.findViewById(com.mst.internal.R.id.space1);
        if (hasTopPanel) {
            if(textSpacerNoTitle != null) {
                textSpacerNoTitle.setVisibility(View.GONE);
            }
            ...
            if (mMessage != null || mListView != null || hasCustomPanel) {
                divider = topPanel.findViewById(com.android.internal.R.id.titleDivider);
            } else {
                divider = topPanel.findViewById(com.android.internal.R.id.titleDividerTop);
            }
            ...
            if(textSpacerNoTitle != null) {
                textSpacerNoTitle.setVisibility(View.VISIBLE);
            }
        }

        // Update scroll indicators as needed.
        if (!hasCustomPanel && hasScrollIndicators) {
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            final FrameLayout custom = (FrameLayout) mWindow.findViewById(com.android.internal.R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (mCustomTitleView != null) {
            ...
            mTitleTemplate = mWindow.findViewById(com.android.internal.R.id.title_template);
            mTitleTemplate.setVisibility(View.GONE);
        } else {
            mIconView = (ImageView) mWindow.findViewById(com.android.internal.R.id.icon);

            final boolean hasTextTitle = !TextUtils.isEmpty(mTitle);
            boolean hasIcon = true;//add by caizhongting
            if (hasTextTitle) {
                // Display the title if a title is supplied, else hide it.
                mTitleView = (TextView) mWindow.findViewById(com.android.internal.R.id.alertTitle);
                ...
                if(mTitleFontFamily != null && !"".equals(mTitleFontFamily)){
                    mTitleView.setTypeface(Typeface.create(mTitleFontFamily,mTitleFontStyle));
                }

                mTitleDivider = mWindow.findViewById(com.android.internal.R.id.divider);
                if(mTitleDividerColor != 0){
                    mTitleDivider.setBackgroundColor(mTitleDividerColor);
                }
                mTitleTemplate = mWindow.findViewById(com.android.internal.R.id.title_template);
                if(mTitleBackground != 0){
                    mTitleTemplate.setBackgroundColor(mTitleBackground);
                }
                ...
                if (mIconId != 0) {
                    ...
                    mIconView.setVisibility(View.GONE);
                    hasIcon = false;//add by caizhongting
                }

                //add by caizhongting
                if(hasIcon){
               	 mIconView.setOnClickListener(mOnIconClickListener);
                }
                //end add
            } else {
                // Hide the title template
    ...
    private void setupContent(ViewGroup contentPanel) {
        mScrollView = (ScrollView) contentPanel.findViewById(com.android.internal.R.id.scrollView);
        mScrollView.setFocusable(false);

        // Special case for users that only want to display a String
        mMessageView = (TextView) contentPanel.findViewById(com.android.internal.R.id.message);
        if (mMessageView == null) {
            return;
        }
    ...
    private void setupButtons(ViewGroup buttonPanel) {
        ...
        int whichButtons = 0;
        boolean SHOW_POSITIVE = false;
        boolean SHOW_NEGATIVE = false;
        boolean SHOW_NEUTRAL = false;
        mFirstDivider = buttonPanel.findViewById(com.mst.internal.R.id.dialog_button_divider1);
        mSecondDivider = buttonPanel.findViewById(com.mst.internal.R.id.dialog_button_divider2);
        mButtonPositive = (Button) buttonPanel.findViewById(com.android.internal.R.id.button1);
        ...
        mButtonNegative = (Button) buttonPanel.findViewById(com.android.internal.R.id.button2);
        ...
        mButtonNeutral = (Button) buttonPanel.findViewById(com.android.internal.R.id.button3);
        ...
        if(hasButtons){
        	if(SHOW_NEGATIVE && SHOW_POSITIVE && SHOW_NEUTRAL){
        		mFirstDivider.setVisibility(View.VISIBLE);
        		mSecondDivider.setVisibility(View.VISIBLE);
        	}
        	
        	if(SHOW_POSITIVE && SHOW_NEGATIVE && !SHOW_NEUTRAL){
    ...
    private void centerButton(Button button) {
        ...
        mFirstDivider.setVisibility(View.GONE);
		mSecondDivider.setVisibility(View.GONE);
        View leftSpacer = mWindow.findViewById(com.android.internal.R.id.leftSpacer);
        if (leftSpacer != null) {
            leftSpacer.setVisibility(View.VISIBLE);
        }
        View rightSpacer = mWindow.findViewById(com.android.internal.R.id.rightSpacer);
        if (rightSpacer != null) {
    ...
    private void setBackground(TypedArray a, View topPanel, View contentPanel, View customPanel,
        ...
        final boolean needsDefaultBackgrounds = a.getBoolean(
                R.styleable.AlertDialog_needsDefaultBackgrounds, false);
        if(DEBUG){
        	 Log.d(TAG,"needs Default Background -->"+needsDefaultBackgrounds);
        }
    ...
    public static class AlertParams {
        ...
        public void apply(AlertController dialog) {
            ...
            if(mOnIconClickListener != null){
                dialog.setOnIconClickListener(mOnIconClickListener);
            }
            //end add
            if(mTitleTextColor != 0) {
            ...
            if(mTitleFontFamily != null && !"".equals(mTitleFontFamily)) {
                dialog.setTitleFontFamily(mTitleFontFamily,mTitleFontStyle);
            }
            if(mTitleDividerColor != 0) {
                dialog.setTitleDividerColor(mTitleDividerColor);
            }
            if(mTitleBackground != 0) {
                dialog.setTitleBackground(mTitleBackground);
            }
        ...
        private void createListView(final AlertController dialog) {
            RecycleListView templistView = (RecycleListView) dialog.mListView;
            if(templistView == null){
                templistView = 
                        (RecycleListView) mInflater.inflate(dialog.mListLayout, null);
            }
            final RecycleListView listView = templistView;
            final ListAdapter adapter;

            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                            mContext, dialog.mMultiChoiceItemLayout, com.android.internal.R.id.text1, mItems) {
                        @Override
                    ...
                    adapter = new CursorAdapter(mContext, mCursor, false) {
                        ...
                        public void bindView(View view, Context context, Cursor cursor) {
                            CheckedTextView text = (CheckedTextView) view.findViewById(com.android.internal.R.id.text1);
                ...
                if (mCursor != null) {
                    adapter = new SimpleCursorAdapter(mContext, layout, mCursor,
                            new String[] { mLabelColumn }, new int[] { com.android.internal.R.id.text1 });
                } else if (mAdapter != null) {
                    adapter = mAdapter;
                } else {
                    adapter = new CheckedItemAdapter(mContext, layout, com.android.internal.R.id.text1, mItems);
                }
            }
