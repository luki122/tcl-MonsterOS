...
public class MstMenuBuilder implements Menu{
    ...
    */
   private ArrayList<MstMenuItemImpl> mActionItems;
   /**
    * Contains items that should NOT appear in the Action Bar, if present.
    */
   private ArrayList<MstMenuItemImpl> mNonActionItems;
   ...
   private ArrayList<MstMenuItemImpl> mTempShortcutItemList = new ArrayList<MstMenuItemImpl>();

   private CopyOnWriteArrayList<WeakReference<MstMenuPresenter>> mPresenters =
           new CopyOnWriteArrayList<WeakReference<MstMenuPresenter>>();

   /**
    * Currently expanded menu item; must be collapsed when we clear.
    */
   private MstMenuItemImpl mExpandedItem;
   ...
   public MstMenuBuilder(Context context) {
       mContext = context;
       mResources = context.getResources();
       
       mItems = new ArrayList<MstMenuItemImpl>();
       
       mVisibleItems = new ArrayList<MstMenuItemImpl>();
       mIsVisibleItemsStale = true;
       
       mActionItems = new ArrayList<MstMenuItemImpl>();
       mNonActionItems = new ArrayList<MstMenuItemImpl>();
       mIsActionItemsStale = true;
       
       setShortcutsVisibleInner(true);
   }
   
   public MstMenuBuilder setDefaultShowAsAction(int defaultShowAsAction) {
    ...
    */
   public void addMenuPresenter(MstMenuPresenter presenter) {
    ...
    */
   public void addMenuPresenter(MstMenuPresenter presenter, Context menuContext) {
       mPresenters.add(new WeakReference<MstMenuPresenter>(presenter));
    ...
    */
   public void removeMenuPresenter(MstMenuPresenter presenter) {
       for (WeakReference<MstMenuPresenter> ref : mPresenters) {
           final MstMenuPresenter item = ref.get();
   ...
   private void dispatchPresenterUpdate(boolean cleared) {
       ...
       for (WeakReference<MstMenuPresenter> ref : mPresenters) {
           final MstMenuPresenter presenter = ref.get();
           if (presenter == null) {
               mPresenters.remove(ref);
           } else {
   ...
   private boolean dispatchSubMenuSelected(MstSubMenuBuilder subMenu,
		   MstMenuPresenter preferredPresenter) {
   ...
   public void saveActionViewStates(Bundle outStates) {
       ...
       for (int i = 0; i < itemCount; i++) {
           ...
           if (item.hasSubMenu()) {
               final MstSubMenuBuilder subMenu = (MstSubMenuBuilder) item.getSubMenu();
   ...
   public MenuItem addInternal(int group, int id, int categoryOrder, CharSequence title) {
       ...
       final MstMenuItemImpl item = createNewMenuItem(group, id, categoryOrder, ordering, title,
   ...
   private MstMenuItemImpl createNewMenuItem(int group, int id, int categoryOrder, int ordering,
           CharSequence title, int defaultShowAsAction) {
       return new MstMenuItemImpl(this, group, id, categoryOrder, ordering, title,
               defaultShowAsAction);
   }
   ...
   public SubMenu addSubMenu(int group, int id, int categoryOrder, CharSequence title) {
       ...
       final MstSubMenuBuilder subMenu = new MstSubMenuBuilder(mContext, this, item);
   ...
   void setExclusiveItemChecked(MenuItem item) {
       ...
       for (int i = 0; i < N; i++) {
    	   MstMenuItemImpl curItem = mItems.get(i);
   ...
   public void setGroupCheckable(int group, boolean checkable, boolean exclusive) {
       ...
       for (int i = 0; i < N; i++) {
    	   MstMenuItemImpl item = mItems.get(i);
   ...
   public int findGroupIndex(int group, int start) {
       ...
       for (int i = start; i < size; i++) {
           final MstMenuItemImpl item = mItems.get(i);
   ...
   private static int findInsertIndex(ArrayList<MstMenuItemImpl> items, int ordering) {
       for (int i = items.size() - 1; i >= 0; i--) {
    	   MstMenuItemImpl item = items.get(i);
   ...
   public boolean performShortcut(int keyCode, KeyEvent event, int flags) {
       final MstMenuItemImpl item = findItemWithShortcutForKey(keyCode, event);
    ...
    * with the keyCode.
    */
   void findItemsWithShortcutForKey(List<MstMenuItemImpl> items, int keyCode, KeyEvent event) {
       ...
       for (int i = 0; i < N; i++) {
    	   MstMenuItemImpl item = mItems.get(i);
           if (item.hasSubMenu()) {
               ((MstMenuBuilder)item.getSubMenu()).findItemsWithShortcutForKey(items, keyCode, event);
           }
    ...
    */
   MstMenuItemImpl findItemWithShortcutForKey(int keyCode, KeyEvent event) {
       // Get all items that can be associated directly or indirectly with the keyCode
       ArrayList<MstMenuItemImpl> items = mTempShortcutItemList;
       items.clear();
   ...
   public boolean performItemAction(MenuItem item, MstMenuPresenter preferredPresenter, int flags) {
	   MstMenuItemImpl itemImpl = (MstMenuItemImpl) item;
       ...
       if (itemImpl.hasCollapsibleActionView()) {
           ...
           if (!itemImpl.hasSubMenu()) {
               itemImpl.setSubMenu(new MstSubMenuBuilder(getContext(), this, itemImpl));
           }

           final MstSubMenuBuilder subMenu = (MstSubMenuBuilder) itemImpl.getSubMenu();
    ...
    */
   void onItemVisibleChanged(MstMenuItemImpl item) {
    ...
    */
   void onItemActionRequestChanged(MstMenuItemImpl item) {
       // Notify of items being changed
       mIsActionItemsStale = true;
       onItemsChanged(true);
   }
   
   public ArrayList<MstMenuItemImpl> getVisibleItems() {
   ...
   public void flagActionItems() {
       ...
       final ArrayList<MstMenuItemImpl> visibleItems = getVisibleItems();
   ...
   public ArrayList<MstMenuItemImpl> getActionItems() {
       flagActionItems();
       return mActionItems;
   }
   
   public ArrayList<MstMenuItemImpl> getNonActionItems() {
       flagActionItems();
    ...
    */
   protected MstMenuBuilder setHeaderTitleInt(CharSequence title) {
    ...
    * @return This MenuBuilder so additional setters can be called.
    */
   protected MstMenuBuilder setHeaderTitleInt(int titleRes) {
    ...
    * @return This MenuBuilder so additional setters can be called.
    */
   protected MstMenuBuilder setHeaderIconInt(Drawable icon) {
    ...
    * @return This MenuBuilder so additional setters can be called.
    */
   protected MstMenuBuilder setHeaderIconInt(int iconRes) {
    ...
    * @return This MenuBuilder so additional setters can be called.
    */
   protected MstMenuBuilder setHeaderViewInt(View view) {
   ...
   public MstMenuItemImpl getExpandedItem() {
