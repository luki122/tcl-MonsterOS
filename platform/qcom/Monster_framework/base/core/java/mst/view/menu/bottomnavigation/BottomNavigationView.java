...
public class BottomNavigationView extends LinearLayout  {
    ...
    private static final int MENU_ITEM_LAYOUT = com.mst.R.layout.bottom_navigation_menu_item;
    ...
    private void enableItemWidget(boolean enabled,View itemParent){
    	...
    	View iconParent =  itemParent.findViewById(com.mst.internal.R.id.menu_item_parent);
    	if(iconParent != null){
    		iconParent.setEnabled(enabled);
    	}
    	if(iconView != null){
...
//    	super.setVisibility(visibility);
     ...
     void updateMenuView(ArrayList<MstMenuItemImpl>  menuItems){
    	if(menuItems != null && menuItems.size() > 0){
    		...
    		for(int i = 0 ;i < itemCount ; i++){
    			View itemView = mInflater.inflate(MENU_ITEM_LAYOUT,this,false);
    			...
    			itemView.findViewById(com.mst.internal.R.id.menu_item_parent).setOnClickListener(new OnClickListener() {
    ...
    private void setupMenuItem(MenuItem item,View itemView){
    	...
    	if(icon != null){
	    	...
	    	icon.setTintList(mIconColorTintList);
