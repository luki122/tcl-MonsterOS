...
public class PopupMenu implements MstMenuBuilder.Callback, MstMenuPresenter.Callback{
    private final Context mContext;
    private final MstMenuBuilder mMenu;
    private final View mAnchor;
    private final MstMenuPopupHelper mPopup;
    ...
    public PopupMenu(Context context, View anchor, int gravity, int popupStyleAttr,
        ...
        mAnchor = anchor;
        mPopup = new MstMenuPopupHelper(context, mMenu, anchor, false, popupStyleAttr, popupStyleRes);
    ...
    public boolean onOpenSubMenu(MstMenuBuilder subMenu) {
        ...
        new MstMenuPopupHelper(mContext, subMenu, mAnchor).show();
        return true;
    }
