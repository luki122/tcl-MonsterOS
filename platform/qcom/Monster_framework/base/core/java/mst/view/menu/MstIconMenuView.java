 ...
 * @hide
 */
public final class MstIconMenuView extends ViewGroup implements ItemInvoker, MstMenuView, Runnable {
     ...
     */
    public MstIconMenuView(Context context, AttributeSet attrs) {
        super(context, attrs);

        TypedArray a = 
            context.obtainStyledAttributes(attrs, R.styleable.IconMenuView, 0, 0);
        ...
        mItemBackground = a.getDrawable(R.styleable.MenuView_itemBackground);
        mHorizontalDivider = a.getDrawable(R.styleable.MenuView_horizontalDivider);
        mHorizontalDividerRects = new ArrayList<Rect>();
        mVerticalDivider =  a.getDrawable(R.styleable.MenuView_verticalDivider);
     ...
     */
    MstIconMenuItemView createMoreItemView() {
        Context context = getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        
        final MstIconMenuItemView itemView = (MstIconMenuItemView) inflater.inflate(
                R.layout.icon_menu_item_layout, null);
        
        Resources r = context.getResources();
        itemView.initialize(r.getText(R.string.more_item_label), mMoreIcon);
    ...
    private void positionChildren(int menuWidth, int menuHeight) {
        ...
        int itemPos = 0;
        View child;
        MstIconMenuView.LayoutParams childLayoutParams = null; 
        ...
        for (int row = 0; row < numRows; row++) {
            ...
            for (int itemPosOnRow = 0; itemPosOnRow < numItemsForRow[row]; itemPosOnRow++) {
                ...
                childLayoutParams = (MstIconMenuView.LayoutParams) child.getLayoutParams();
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        View child;
        MstIconMenuView.LayoutParams childLayoutParams;
        
        for (int i = getChildCount() - 1; i >= 0; i--) {
            child = getChildAt(i);
            childLayoutParams = (MstIconMenuView.LayoutParams)child
                    .getLayoutParams();
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MstIconMenuView.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        // Override to allow type-checking of LayoutParams. 
        return p instanceof MstIconMenuView.LayoutParams;
    }
    ...
    private void setChildrenCaptionMode(boolean shortcut) {
        ...
        for (int i = getChildCount() - 1; i >= 0; i--) {
            ((MstIconMenuItemView) getChildAt(i)).setCaptionMode(shortcut);
        }
    }
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link MstIconMenuView#onSaveInstanceState()}
         */
