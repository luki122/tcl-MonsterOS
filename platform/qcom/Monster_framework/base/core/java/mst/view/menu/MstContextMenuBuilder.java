 ...
 */
public class MstContextMenuBuilder extends MstMenuBuilder implements ContextMenu {
    
    public MstContextMenuBuilder(Context context) {
        super(context);
    }
     ...
     *        menu's window.
     * @return If the context menu was shown, the {@link MstMenuDialogHelper} for
     *         dismissing it. Otherwise, null.
     */
    public MstMenuDialogHelper show(View originalView, IBinder token) {
        ...
        if (getVisibleItems().size() > 0) {
            ...
            MstMenuDialogHelper helper = new MstMenuDialogHelper(this); 
            helper.show(token);
