 ...
 */
public class MstListMenuItemView extends LinearLayout implements MstMenuView.ItemView {
    ...
    public MstListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public MstListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.menuViewStyle);
    }
