...
/**
 * The item view for each item in the {@link MstIconMenuView}.  
 */
public final class MstIconMenuItemView extends TextView implements MstMenuView.ItemView {
    
    private static final int NO_ALPHA = 0xFF;
    
    private MstIconMenuView mIconMenuView;
    ...
    public MstIconMenuItemView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mDisabledAlpha = a.getFloat(
                R.styleable.MenuView_itemIconDisabledAlpha, 0.8f);
    ...
    public MstIconMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public MstIconMenuItemView(Context context, AttributeSet attrs) {
    ...
    public void setItemData(MstMenuItemImpl data) {
        mItemData = data;
    }
    ...
    void setIconMenuView(MstIconMenuView iconMenuView) {
     ...
     */
    MstIconMenuView.LayoutParams getTextAppropriateLayoutParams() {
        MstIconMenuView.LayoutParams lp = (MstIconMenuView.LayoutParams) getLayoutParams();
        if (lp == null) {
            // Default layout parameters
            lp = new MstIconMenuView.LayoutParams(
                    MstIconMenuView.LayoutParams.MATCH_PARENT, MstIconMenuView.LayoutParams.MATCH_PARENT);
        }
