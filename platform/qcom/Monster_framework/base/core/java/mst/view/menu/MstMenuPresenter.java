...
public interface MstMenuPresenter {
	/**
     ...
     * This method is called by MstMenuBuilder when a presenter is
     * added. See {@link MstMenuBuilder#addMenuPresenter(MenuPresenter)}
     *
     ...
     * {@link #initForMenu(Context, MstMenuView)}.
     *
     ...
     * MstMenuBuilder during the normal course of operation.
     *
