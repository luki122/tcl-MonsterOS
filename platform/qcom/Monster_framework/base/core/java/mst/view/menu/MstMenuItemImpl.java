...
public final class MstMenuItemImpl implements MenuItem{
private static final String TAG = "MenuItemImpl";
     ...
     */
    MstMenuItemImpl(MstMenuBuilder menu, int group, int id, int categoryOrder, int ordering,
    ...
    public void setSubMenu(MstSubMenuBuilder subMenu) {
        mSubMenu = subMenu;
     ...
     *         prefers
     */
    CharSequence getTitleForItemView(MstMenuView.ItemView itemView) {
   ...
   public MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener clickListener) {
    ...
    public MenuItem setActionProvider(ActionProvider actionProvider) {
        if (mActionProvider != null) {
        	try{
        	Method resetMethod = mActionProvider.getClass().getDeclaredMethod("reset");
        	if(resetMethod != null){
        		resetMethod.setAccessible(true);
        		resetMethod.invoke(mActionProvider);
        	}
        	}catch(Exception e){
        		Log.d(TAG, "Invoker ActionProvider's method reset failure");
        	}
        }
        mActionView = null;
        ...
        if (mActionProvider != null) {
            mActionProvider.setVisibilityListener(new ActionProvider.VisibilityListener() {
                @Override public void onActionProviderVisibilityChanged(boolean isVisible) {
                    mMenu.onItemVisibleChanged(MstMenuItemImpl.this);
                }
            });
        }
        return this;
