...
import mst.widget.MstNavigationMenuItemView;
...
public class MstNavigationMenuPresenter implements MstMenuPresenter {

    private static final String STATE_HIERARCHY = "android:menu:list";
    private static final String STATE_ADAPTER = "android:menu:adapter";

    private MstNavigationMenuView mMenuView;
    ...
    public MstMenuView getMenuView(ViewGroup root) {
        if (mMenuView == null) {
            mMenuView = (MstNavigationMenuView) mLayoutInflater.inflate(
                    R.layout.navigation_menu, root, false);
            if (mAdapter == null) {
                mAdapter = new NavigationMenuAdapter();
            }
            mHeaderLayout = (LinearLayout) mLayoutInflater
                    .inflate(R.layout.navigation_item_header,
                            mMenuView, false);
    ...
    private static class NormalViewHolder extends ViewHolder {
        ...
        public NormalViewHolder(LayoutInflater inflater, ViewGroup parent,
            ...
            super(inflater.inflate(R.layout.navigation_item, parent, false));
    ...
    private static class SubheaderViewHolder extends ViewHolder {
        ...
        public SubheaderViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.navigation_item_subheader, parent, false));
        }
    ...
    private static class SeparatorViewHolder extends ViewHolder {
        ...
        public SeparatorViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.navigation_item_separator, parent, false));
        }
    ...
    private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            MstNavigationMenuItemView itemView = (MstNavigationMenuItemView) v;
            setUpdateSuspended(true);
            MstMenuItemImpl item = itemView.getItemData();
            boolean result = mMenu.performItemAction(item, MstNavigationMenuPresenter.this, 0);
    ...
    private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            switch (getItemViewType(position)) {
                case VIEW_TYPE_NORMAL: {
                	MstNavigationMenuItemView itemView = (MstNavigationMenuItemView) holder.itemView;
        ...
        public void onViewRecycled(ViewHolder holder) {
            if (holder instanceof NormalViewHolder) {
                ((MstNavigationMenuItemView) holder.itemView).recycle();
            }
        }
