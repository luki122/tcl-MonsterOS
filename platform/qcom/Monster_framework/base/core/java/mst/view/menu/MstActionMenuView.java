...
public class MstActionMenuView extends LinearLayout implements MstMenuBuilder.ItemInvoker, MstMenuView{
	 private static final String TAG = "ActionMenuView";
	    ...
	    private MstActionMenuPresenter mPresenter;
	    ...
	    private int mActionMenuItemMargin;
	    private int mLastItemPaddingRight;
	    private int mLastMenuItemMarginRight;
	    private OnMenuItemClickListener mOnMenuItemClickListener;

	    public MstActionMenuView(Context context) {
	        this(context, null);
	    }
	    
	    public MstActionMenuView(Context context, AttributeSet attrs) {
	        super(context, attrs);
	        mActionMenuItemMargin = getResources().getDimensionPixelSize(R.dimen.action_bar_action_menu_margin);
	        ...
	        mPopupTheme = 0;
	        mLastItemPaddingRight =  getResources().getDimensionPixelSize(com.mst.R.dimen.toolbar_nav_icon_margin_right);
	        mLastMenuItemMarginRight = getResources().getDimensionPixelSize(com.mst.R.dimen.toolbar_menu_view_margin_right);
	    }
	     ...
	     * @hide
	     */
	    public void setPresenter(MstActionMenuPresenter presenter) {
	    ...
	    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
	        ...
	        if (mFormatItems && childCount > 0) {
				...
				if (childCount > 1) {
					if (i == 0) {
						lp.leftMargin = 0;
						lp.rightMargin = mActionMenuItemMargin;
					} else if (i == childCount - 1) {
						lp.leftMargin = mActionMenuItemMargin;
						lp.rightMargin = mLastMenuItemMarginRight;
						resetLastItemPadding(child);
					}else{
						lp.leftMargin = lp.rightMargin = mActionMenuItemMargin;
					}
				}else {
	                	lp.leftMargin = 0;
	                	lp.rightMargin = mLastMenuItemMarginRight;
	    ...
	    private void resetLastItemPadding(View lastItemView){
//	    	if(!(lastItemView instanceof MstActionMenuItemView)){
//	    		lastItemView.setPadding(lastItemView.getPaddingLeft(), lastItemView.getPaddingTop()
//						, mLastItemPaddingRight, lastItemView.getPaddingBottom());
//			}
	    }
	    ...
	    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
	        ...
	        for (int i = 0; i < childCount; i++) {
	            ...
	            final boolean isGeneratedItem = child instanceof MstActionMenuItemView;
	            visibleItemCount++;
	            ...
	            lp.leftMargin = 0;
	            lp.rightMargin = 0;
	            lp.preventEdgeOffset = isGeneratedItem && ((MstActionMenuItemView) child).hasText();
	        ...
	        if (cellsRemaining > 0 && smallestItemsAt != 0 &&
	            ...
	            for (int i = 0; i < childCount; i++) {
	                ...
	                final View child = getChildAt(i);
	                final LayoutParams lp = (LayoutParams) child.getLayoutParams();
	                if (child instanceof MstActionMenuItemView) {
	    ...
	    static int measureChildForCells(View child, int cellSize, int cellsRemaining,
	        ...
	        final MstActionMenuItemView itemView = child instanceof MstActionMenuItemView ?
	                (MstActionMenuItemView) child : null;
	    ...
	    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
	        ...
	        int dividerW = 0;
	        boolean isLayoutR = false;
	        try{
	        Class<?> clz = LinearLayout.class;
	        Method getDividerWidthMethod = clz.getDeclaredMethod("getDividerWidth");
	        Method isLayoutRtlMethod = clz.getDeclaredMethod("isLayoutRtl");
	        if(getDividerWidthMethod != null){
	        	getDividerWidthMethod.setAccessible(true);
	        	dividerW= (int) getDividerWidthMethod.invoke(this);
	        }
	        if(isLayoutRtlMethod != null){
	        	isLayoutRtlMethod.setAccessible(true);
	        	isLayoutR =(boolean) isLayoutRtlMethod.invoke(this);
	        }
	        }catch(Exception e){
	        	
	        }
	       
	        final int dividerWidth = dividerW;
	        int overflowWidth = 0;
	        int nonOverflowWidth = 0;
	        int nonOverflowCount = 0;
	        int widthRemaining = right - left - getPaddingRight() - getPaddingLeft();
	        boolean hasOverflow = false;
	        final boolean isLayoutRtl = isLayoutR;
	        for (int i = 0; i < childCount; i++) {
	    ...
	    public Menu getMenu() {
	        if (mMenu == null) {
	            ...
	            mMenu = new MstMenuBuilder(context);
	            mMenu.setCallback(new MenuBuilderCallback());
	            mPresenter = new MstActionMenuPresenter(context);
	     ...
	     */
	    public MstMenuBuilder peekMenu() {
	        return mMenu;
	    }
	    ...
	    private class MenuBuilderCallback implements MstMenuBuilder.Callback {
	        @Override
	    ...
	    private class ActionMenuPresenterCallback implements MstActionMenuPresenter.Callback {
	        @Override
