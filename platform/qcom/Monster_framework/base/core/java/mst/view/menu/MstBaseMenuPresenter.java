 ...
 */
public abstract class MstBaseMenuPresenter implements MstMenuPresenter {
    protected Context mSystemContext;
    protected Context mContext;
    protected MstMenuBuilder mMenu;
    ...
    protected MstMenuView mMenuView;
     ...
     */
    public MstBaseMenuPresenter(Context context, int menuLayoutRes, int itemLayoutRes) {
    ...
    public MstMenuView getMenuView(ViewGroup root) {
        if (mMenuView == null) {
            mMenuView = (MstMenuView) mSystemInflater.inflate(mMenuLayoutRes, root, false);
    ...
    public void updateMenuView(boolean cleared) {
        ...
        if (mMenu != null) {
            ...
            ArrayList<MstMenuItemImpl> visibleItems = mMenu.getVisibleItems();
            final int itemCount = visibleItems.size();
            for (int i = 0; i < itemCount; i++) {
            	MstMenuItemImpl item = visibleItems.get(i);
                if (shouldIncludeItem(childIndex, item)) {
                    final View convertView = parent.getChildAt(childIndex);
                    final MstMenuItemImpl oldItem = convertView instanceof MstMenuView.ItemView ?
                            ((MstMenuView.ItemView) convertView).getItemData() : null;
     ...
     */
    public MstMenuView.ItemView createItemView(ViewGroup parent) {
        return (MstMenuView.ItemView) mSystemInflater.inflate(mItemLayoutRes, parent, false);
    }
     ...
     */
    public View getItemView(MstMenuItemImpl item, View convertView, ViewGroup parent) {
        MstMenuView.ItemView itemView;
        if (convertView instanceof MstMenuView.ItemView) {
            itemView = (MstMenuView.ItemView) convertView;
        } else {
     ...
     */
    public abstract void bindItemView(MstMenuItemImpl item, MstMenuView.ItemView itemView);
    ...
    public boolean onSubMenuSelected(MstSubMenuBuilder menu) {
        if (mCallback != null) {
