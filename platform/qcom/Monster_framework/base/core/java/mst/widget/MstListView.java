...
public class MstListView extends ListView{
	...
	public MstListView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		init();
	}

	public MstListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init();
	}

	public MstListView(Context context, AttributeSet attrs, int defStyleAttr) {
