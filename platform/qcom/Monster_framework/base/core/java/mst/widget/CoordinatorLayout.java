...
import mst.widget.impl.NestedScrollingParent;
import mst.widget.impl.NestedScrollingParentHelper;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CoordinatorLayout,
                defStyleAttr, R.style.Widget_CoordinatorLayout);
    ...
    public void setStatusBarBackgroundResource(int resId) {
        setStatusBarBackground(resId != 0 ? getContext().getDrawable(resId) : null);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (lp.keyline >= 0 && widthMode != MeasureSpec.UNSPECIFIED) {
                ...
                final int keylineGravity = Gravity.getAbsoluteGravity(
        ...
        final int width = resolveSizeAndState(widthUsed, widthMeasureSpec,
                childState & View.MEASURED_STATE_MASK);
        final int height = resolveSizeAndState(heightUsed, heightMeasureSpec,
                childState << View.MEASURED_HEIGHT_STATE_SHIFT);
        setMeasuredDimension(width, height);
    }

    private void dispatchChildApplyWindowInsets(WindowInsets insets) {
    ...
    static class ViewElevationComparator implements Comparator<View> {
        @Override
        public int compare(View lhs, View rhs) {
            final float lz = lhs.getZ();
            final float rz = rhs.getZ();
            if (lz > rz) {
                return -1;
            } else if (lz < rz) {
                return 1;
    ...
    public static abstract class Behavior<V extends View> {
         ...
         */
        public WindowInsets onApplyWindowInsets(CoordinatorLayout coordinatorLayout,
                V child, WindowInsets insets) {
            return insets;
        }
