 ...
 *
 * <pre>
 * &lt;mst.widget.CoordinatorLayout
 *         xmlns:android=&quot;http://schemas.android.com/apk/res/android&quot;
 *         xmlns:app=&quot;http://schemas.android.com/apk/res-auto&quot;
 *         android:layout_width=&quot;match_parent&quot;
 *         android:layout_height=&quot;match_parent&quot;&gt;
 *
 *     &lt;mst.widget.NestedScrollView
 *             android:layout_width=&quot;match_parent&quot;
 *             android:layout_height=&quot;match_parent&quot;
 ...
 *     &lt;/mst.widget.AppBarLayout&gt;
 *
 * &lt;/mst.widget.widget.CoordinatorLayout&gt;
 * </pre>
 *
...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        ViewUtil.setBoundsViewOutlineProvider(this);

        mListeners = new ArrayList<>();

        setElevation( mTargetElevation);
     ...
     *                 be fully collapsed
     *
     * @attr ref com.mst.R.styleable#AppBarLayout_expanded
     */
    public void setExpanded(boolean expanded) {
        setExpanded(expanded, this.isLaidOut());
    }
        ...
        for (int i = getChildCount() - 1; i >= 0; i--) {
            ...
            if ((flags & LayoutParams.FLAG_QUICK_RETURN) == LayoutParams.FLAG_QUICK_RETURN) {
                ...
                if ((flags & LayoutParams.SCROLL_FLAG_ENTER_ALWAYS_COLLAPSED) != 0) {
                    ...
                    range += childHeight - child.getMinimumHeight();
                } else {
    ...
    final int getMinimumHeightForVisibleOverlappingContent() {
        ...
        return childCount >= 1
                ? (getChildAt(childCount - 1).getMinimumHeight() * 2) + topInset
                : 0;
    }
    ...
    private void setWindowInsets(WindowInsets insets) {
        ...
        for (int i = 0, z = getChildCount(); i < z; i++) {
            final View child = getChildAt(i);
            insets = child.dispatchApplyWindowInsets(insets);
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
         ...
         * @see #getScrollFlags()
         *
         * @attr ref com.mst.R.styleable#AppBarLayout_LayoutParams_layout_scrollFlags
         */
         ...
         *
         * @attr ref com.mst.R.styleable#AppBarLayout_LayoutParams_layout_scrollInterpolator
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        public boolean onStartNestedScroll(CoordinatorLayout parent, AppBarLayout child,
            ...
            final boolean started = (nestedScrollAxes & View.SCROLL_AXIS_VERTICAL) != 0
            ...
            if (offsetChild != null) {
                ...
                if ((lp.getScrollFlags() & LayoutParams.FLAG_SNAP) == LayoutParams.FLAG_SNAP) {
                    ...
                    if ((lp.getScrollFlags() & LayoutParams.SCROLL_FLAG_EXIT_UNTIL_COLLAPSED)
                        ...
                        childBottom += offsetChild.getMinimumHeight();
                    }
            ...
            for (int i = 0, count = appBarLayout.getChildCount(); i < count; i++) {
                ...
                if (child.getTop() + offset <= 0 && visBottom >= 0) {
                    ...
                    ss.firstVisibileChildAtMinimumHeight =
                            visBottom == child.getMinimumHeight();
