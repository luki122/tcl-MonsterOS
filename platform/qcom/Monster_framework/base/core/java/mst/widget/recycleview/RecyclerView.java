...
import mst.widget.recycleview.AdapterHelper.Callback;
import mst.widget.recycleview.AdapterHelper.UpdateOp;
import mst.widget.recycleview.RecyclerView.ItemAnimator;
import mst.widget.recycleview.RecyclerView.SmoothScroller;
...
public class RecyclerView  extends ViewGroup implements ScrollingView, NestedScrollingChild {
     ...
     * this criteria.
     */
    private static final boolean FORCE_INVALIDATE_DISPLAY_LIST = true;
    ...
    static private void bindTempDetach() {
        try {
    ...
    static  public void dispatchStartTemporaryDetach(View view) {
        if (!mTempDetachBound) {
            bindTempDetach();
        }
    ...
    static  public void dispatchFinishTemporaryDetach(View view) {
        if (!mTempDetachBound) {
            bindTempDetach();
        }
     ...
     * displayed by a {@link mst.widget.ViewPager ViewPager}.
     *
     ...
     * {@link mst.widget.recycleview.RecyclerView.LayoutManager#scrollToPosition(int)}
     * @param position Scroll to this adapter position
     * @see mst.widget.recycleview.RecyclerView.LayoutManager#scrollToPosition(int)
     */
     ...
     * @see mst.widget.recycleview.RecyclerView.LayoutManager#computeHorizontalScrollOffset
     ...
     * @see mst.widget.recycleview.RecyclerView.LayoutManager#computeVerticalScrollOffset
     * (RecyclerView.Adapter)
     */
    @Override
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.getOverScrollMode() !=
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
         ...
         * {@link mst.widget.recycleview.RecyclerView.AdapterDataObserver#onChanged()
    ...
    public static abstract class LayoutManager {
        ...
        private void detachViewInternal(int index, View view) {
            if (DISPATCH_TEMP_DETACH) {
                dispatchStartTemporaryDetach(view);
            }
        ...
        public void onInitializeAccessibilityEvent(Recycler recycler, State state,
            ...
            final AccessibilityRecord record = event;
         ...
         * {@link AccessibilityNodeInfo.CollectionInfoCompat#SELECTION_MODE_NONE},
         * {@link AccessibilityNodeInfo.CollectionInfoCompat#SELECTION_MODE_SINGLE} or
         * {@link AccessibilityNodeInfo.CollectionInfoCompat#SELECTION_MODE_MULTIPLE}.
         * <p>
         ...
         *
         * @attr ref com.mst.R.styleable#RecyclerView_android_orientation
         * @attr ref com.mst.R.styleable#RecyclerView_spanCount
         * @attr ref com.mst.R.styleable#RecyclerView_reverseLayout
         * @attr ref com.mst.R.styleable#RecyclerView_stackFromEnd
         *
