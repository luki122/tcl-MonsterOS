...
final class CollapsingTextHelper {
    ...
    void setCollapsedTextAppearance(int resId) {
        TypedArray a = mView.getContext().obtainStyledAttributes(resId, R.styleable.TextHelperTextAppearance);
        if (a.hasValue(R.styleable.TextHelperTextAppearance_android_textColor)) {
            mCollapsedTextColor = a.getColor(
                    R.styleable.TextHelperTextAppearance_android_textColor, mCollapsedTextColor);
        }
        if (a.hasValue(R.styleable.TextHelperTextAppearance_android_textSize)) {
            mCollapsedTextSize = a.getDimensionPixelSize(
                    R.styleable.TextHelperTextAppearance_android_textSize, (int) mCollapsedTextSize);
        }
        mCollapsedShadowColor = a.getInt(R.styleable.TextHelperTextAppearance_android_shadowColor, 0);
        mCollapsedShadowDx = a.getFloat(R.styleable.TextHelperTextAppearance_android_shadowDx, 0);
        mCollapsedShadowDy = a.getFloat(R.styleable.TextHelperTextAppearance_android_shadowDy, 0);
        mCollapsedShadowRadius = a.getFloat(R.styleable.TextHelperTextAppearance_android_shadowRadius, 0);
        a.recycle();
    ...
    void setExpandedTextAppearance(int resId) {
        ...
        if (a.hasValue(R.styleable.TextHelperTextAppearance_android_textColor)) {
            mExpandedTextColor = a.getColor(
                    R.styleable.TextHelperTextAppearance_android_textColor, mExpandedTextColor);
        }
        if (a.hasValue(R.styleable.TextHelperTextAppearance_android_textSize)) {
            mExpandedTextSize = a.getDimensionPixelSize(
                    R.styleable.TextHelperTextAppearance_android_textSize, (int) mExpandedTextSize);
        }
        mExpandedShadowColor = a.getInt(R.styleable.TextHelperTextAppearance_android_shadowColor, 0);
        mExpandedShadowDx = a.getFloat(R.styleable.TextHelperTextAppearance_android_shadowDx, 0);
        mExpandedShadowDy = a.getFloat(R.styleable.TextHelperTextAppearance_android_shadowDy, 0);
        mExpandedShadowRadius = a.getFloat(R.styleable.TextHelperTextAppearance_android_shadowRadius, 0);
        a.recycle();
    ...
    private void calculateBaseOffsets() {
        ...
        final int collapsedAbsGravity = Gravity.getAbsoluteGravity(mCollapsedTextGravity,
                mIsRtl ? View.LAYOUT_DIRECTION_RTL : View.LAYOUT_DIRECTION_LTR);
        ...
        width = mTextToDraw != null
                ? mTextPaint.measureText(mTextToDraw, 0, mTextToDraw.length()) : 0;
        final int expandedAbsGravity = Gravity.getAbsoluteGravity(mExpandedTextGravity,
                mIsRtl ? View.LAYOUT_DIRECTION_RTL : View.LAYOUT_DIRECTION_LTR);
    ...
    private boolean calculateIsRtl(CharSequence text) {
        final boolean defaultIsRtl = mView.getLayoutDirection()
