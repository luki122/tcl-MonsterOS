...
public abstract class AbsActionModeView extends ViewGroup {
    ...
    protected MstActionMenuView mMenuView;
    protected MstActionMenuPresenter mActionMenuPresenter;
    ...
    public AbsActionModeView(Context context) {
        this(context, null);
    }

    public AbsActionModeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AbsActionModeView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public AbsActionModeView(
