...
public class MstLinearLayoutCompat extends ViewGroup {
    ...
    public MstLinearLayoutCompat(Context context) {
        this(context, null);
    }

    public MstLinearLayoutCompat(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MstLinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setDividerDrawable(a.getDrawable(R.styleable.LinearLayoutCompat_android_divider));
    ...
    public int getBaseline() {
        ...
        MstLinearLayoutCompat.LayoutParams lp = (MstLinearLayoutCompat.LayoutParams) child.getLayoutParams();
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            childState = ViewUtil.combineMeasuredStates(childState,
        ...
        if (useLargestChild &&
            ...
            for (int i = 0; i < count; ++i) {
                ...
                final MstLinearLayoutCompat.LayoutParams lp = (MstLinearLayoutCompat.LayoutParams)
        ...
        if (skippedMeasure || delta != 0 && totalWeight > 0.0f) {
            ...
            if (useLargestChild && heightMode != MeasureSpec.EXACTLY) {
                for (int i = 0; i < count; i++) {
                    ...
                    final MstLinearLayoutCompat.LayoutParams lp =
                            (MstLinearLayoutCompat.LayoutParams) child.getLayoutParams();
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MstLinearLayoutCompat.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof MstLinearLayoutCompat.LayoutParams;
    }

    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        if (Build.VERSION.SDK_INT >= 14) {
            super.onInitializeAccessibilityEvent(event);
            event.setClassName(MstLinearLayoutCompat.class.getName());
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        if (Build.VERSION.SDK_INT >= 14) {
            ...
            info.setClassName(MstLinearLayoutCompat.class.getName());
        }
    }
