 ...
 */
public class Toolbar extends /*ViewGroup*/android.widget.Toolbar {
    private static final String TAG = "Toolbar";

    private MstActionMenuView mMenuView;
    ...
    private Paint mBottonDividerPaint;
    ...
    private ArrayMap<String, Method> mMethodMap = new ArrayMap<String, Method>();

    private final MstActionMenuView.OnMenuItemClickListener mMenuViewItemClickListener =
            new MstActionMenuView.OnMenuItemClickListener() {
                @Override
    ...
    private MstActionMenuPresenter mOuterActionMenuPresenter;
    private ExpandedActionViewMenuPresenter mExpandedMenuPresenter;
    private MstMenuPresenter.Callback mActionMenuPresenterCallback;
    private MstMenuBuilder.Callback mMenuBuilderCallback;
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mShowBottomDivider = a.getBoolean(R.styleable.Toolbar_showBottomDivider, false);
        mBottomDividerColor = a.getColor(R.styleable.Toolbar_bottomDividerColor, Color.parseColor("#f7f7f7"));
        mBottonDividerPaint = new Paint();
        mBottonDividerPaint.setAntiAlias(true);
        mBottonDividerPaint.setColor(mBottomDividerColor);
        ...
        final Drawable logo = a.getDrawable(R.styleable.Toolbar_android_logo);
        if (logo != null) {
            setLogo(logo);
        }
        ...
        final Drawable background = a.getDrawable(R.styleable.Toolbar_android_background);
        if(background != null){
        	Log.d(TAG, "setBackground");
        	setBackground(background);
        }
        
        if(a.hasValue(R.styleable.Toolbar_android_background)){
        	setBackground(a.getDrawable(R.styleable.Toolbar_android_background));
        }
        a.recycle();
    }
    ...
    public boolean canShowOverflowMenu() {
        return getVisibility() == View.VISIBLE ;/*&& mMenuView != null && mMenuView.isOverflowReserved();*/
    }
    ...
    public void setMenu(MstMenuBuilder menu, MstActionMenuPresenter outerPresenter) {
        if (menu == null && mMenuView == null) {
            return;
        }

        ensureMenuView();
        final MstMenuBuilder oldMenu = mMenuView.peekMenu();
        if (oldMenu == menu) {
            return;
        }
    ...
    public void collapseActionView() {
        final MstMenuItemImpl item = mExpandedMenuPresenter == null ? null :
        ...
        if (!TextUtils.isEmpty(title)) {
            if (mTitleTextView != null) {
                ...
                if (mTitleTextAppearance != 0) {
                    mTitleTextView.setTextAppearance(mContext,mTitleTextAppearance);
                }
        ...
        if (!TextUtils.isEmpty(subtitle)) {
            if (mSubtitleTextView == null) {
                ...
                if (mSubtitleTextAppearance != 0) {
                    mSubtitleTextView.setTextAppearance(mContext,mSubtitleTextAppearance);
                }
            ...
            if (!isChildOrHidden(mSubtitleTextView)) {
            	addSubTitle(mSubtitleTextView, true);
            }
    ...
    public void setSubtitleTextAppearance(Context context, int resId) {
        ...
        if (mSubtitleTextView != null) {
            mSubtitleTextView.setTextAppearance(mContext,resId);
        }
    }
    ...
    public Drawable getOverflowIcon() {
        ensureMenu();
        return /*mMenuView.getOverflowIcon()*/null;
    }
    ...
    private void ensureMenu() {
        ...
        if (mMenuView.peekMenu() == null) {
            ...
            final MstMenuBuilder menu = (MstMenuBuilder) mMenuView.getMenu();
            if (mExpandedMenuPresenter == null) {
                mExpandedMenuPresenter = new ExpandedActionViewMenuPresenter();
            }
    ...
    private void ensureMenuView() {
        if (mMenuView == null) {
            mMenuView = new MstActionMenuView(getContext());
            mMenuView.setPopupTheme(mPopupTheme);
            mMenuView.setOnMenuItemClickListener(mMenuViewItemClickListener);
            mMenuView.setMenuCallbacks(mActionMenuPresenterCallback, mMenuBuilderCallback);
            final LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = Gravity.END | (mButtonGravity & Gravity.VERTICAL_GRAVITY_MASK);
//            lp.rightMargin = - getResources().getDimensionPixelSize(com.mst.R.dimen.toolbar_menu_view_margin_right);
    ...
    private void ensureCollapseButtonView() {
    	Log.d(TAG, "ensureCollapseButtonView");
    ...
    private void addSubTitle(View v,boolean allowHide){
    	final ViewGroup.LayoutParams vlp = v.getLayoutParams();
        final LayoutParams lp;
        if (vlp == null) {
            lp = generateDefaultLayoutParams();
        ...
        lp.mViewType = LayoutParams.SYSTEM;
        lp.topMargin = getResources().getDimensionPixelSize(com.mst.internal.R.dimen.toolbar_subtitle_margin_top);
        if (allowHide && mExpandedActionView != null) {
            v.setLayoutParams(lp);
            mHiddenViews.add(v);
        } else {
    ...
    protected void onDraw(Canvas canvas) {
    	...
    	if(mShowBottomDivider){
    		canvas.drawLine(getLeft(), getBottom()-1, getWidth(), getBottom(), mBottonDividerPaint);
    	}
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean isLayoutRtlBool = false;
        try{
        if(mMethodMap.get("isLayoutRtl") == null){
        	Class<?> clz = ViewGroup.class;
        	Method isLayoutRtlMethod = clz.getDeclaredMethod("isLayoutRtl");
        	if(isLayoutRtlMethod != null){
        		isLayoutRtlMethod.setAccessible(true);
        	}
        	mMethodMap.put("isLayoutRtl", isLayoutRtlMethod);
        }
        Method isLayoutRtl = mMethodMap.get("isLayoutRtl");
        isLayoutRtlBool = (Boolean) isLayoutRtl.invoke(this);
        }catch(Exception e){
        	isLayoutRtlBool = false;
        }
        if (isLayoutRtlBool) {
            marginStartIndex = 1;
            marginEndIndex = 0;
     ...
     */
    public void setMenuCallbacks(MstMenuPresenter.Callback pcb, MstMenuBuilder.Callback mcb) {
...
//
     ...
     */
    MstActionMenuPresenter getOuterActionMenuPresenter() {
    ...
    public static class LayoutParams extends android.widget.Toolbar.LayoutParams {
        ...
        public LayoutParams(MarginLayoutParams source) {
            ...
            try{
            Class<?> clz = ViewGroup.class;
            Method copyMarginsFromMethod = clz.getDeclaredMethod("copyMarginsFrom", MarginLayoutParams.class);
            if(copyMarginsFromMethod != null){
            	copyMarginsFromMethod.setAccessible(true);
            	copyMarginsFromMethod.invoke(this, source);
            }
    ...
    private class ExpandedActionViewMenuPresenter implements MstMenuPresenter {
    	MstMenuBuilder mMenu;
    	MstMenuItemImpl mCurrentExpandedItem;
