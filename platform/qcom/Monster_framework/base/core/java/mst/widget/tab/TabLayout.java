 ...
 * <p>
 * If you're using a {@link mst.widget.ViewPager} together
...
public class TabLayout extends HorizontalScrollView {
    ...
    private final ArrayList<Tab> mTabs = new ArrayList<>();  // huliang
...
//        ThemeUtils.checkAppCompatTheme(context);
        ...
        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.TabLayout_tabIndicatorColor, 0)); //   设置指示条颜色 huliang
     ...
     * part of a scrolling container such as {@link mst.widget.ViewPager}.
     * <p>
    ...
    /**
     * Set the {@link mst.widget.tab.TabLayout.OnTabSelectedListener} that will
     ...
     * labels. This mode is commonly used with a {@link mst.widget.ViewPager}.</li>
     * </ul>
     *
    ...
    private void addTabView(Tab tab, boolean setSelected) { //huliang
        ...
        public TabView(Context context) {
            ...
            if (mTabBackgroundResId != 0) {
                setBackgroundDrawable(
                		context.getDrawable(mTabBackgroundResId));
            }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ValueAnimator animator = mIndicatorAnimator = ViewUtil.createAnimator();
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                int abs = (mIndicatorLeft + mIndicatorRight) /2; // huliang 
            	
                canvas.drawRect(/*mIndicatorLeft*/abs - 18, getHeight() - mSelectedIndicatorHeight,
                		/*mIndicatorRight*/abs + 18, getHeight(), mSelectedIndicatorPaint);
            }
        }
    }
