...
public class MstForegroundLinearLayout extends MstLinearLayoutCompat {
    ...
    public MstForegroundLinearLayout(Context context) {
        this(context, null);
    }

    public MstForegroundLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MstForegroundLinearLayout(Context context, AttributeSet attrs, int defStyle) {
