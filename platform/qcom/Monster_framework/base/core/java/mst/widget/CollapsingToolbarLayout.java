...
import mst.utils.ViewOffsetHelper;
 ...
 *
 * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_collapsedTitleTextAppearance
 * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_expandedTitleTextAppearance
 * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_contentScrim
 * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_expandedTitleMargin
 * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_expandedTitleMarginStart
 * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_expandedTitleMarginEnd
 * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_expandedTitleMarginBottom
 * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_statusBarScrim
 * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_toolbarId
 */
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                ...
                R.style.Widget_CollapsingToolbar);
        ...
        mCollapsingTextHelper.setExpandedTextAppearance(
                R.style.TextAppearance_CollapsingToolbar_Expanded);
        mCollapsingTextHelper.setCollapsedTextAppearance(
                R.style.TextAppearance_CollapsingToolbar_CollapseAppreance);
        ...
        this.setOnApplyWindowInsetsListener(
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mCollapsingTitleEnabled && mDummyView != null) {
            ...
            if (mDrawCollapsingTitle) {
                ...
                final boolean isRtl = this.getLayoutDirection()
        ...
        for (int i = 0, z = getChildCount(); i < z; i++) {
            ...
            if (mLastInsets != null && !child.getFitsSystemWindows()) {
    ...
    public void setScrimsShown(boolean shown) {
        setScrimsShown(shown, this.isLaidOut() && !isInEditMode());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (mScrimAnimator == null) {
            mScrimAnimator = ViewUtil.createAnimator();
     ...
     * the title itself.
     *
     * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_collapsedTitleGravity
     */
     ...
     * the title itself.
     *
     * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_expandedTitleGravity
     */
     ...
     * @attr ref com.mst.R.styleable#CollapsingToolbarLayout_expandedTitleMarginTop
     */
    ...
    final int getScrimTriggerOffset() {
        return 2 * this.getMinimumHeight();
    }
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ...
            final int expandRange = getHeight() - CollapsingToolbarLayout.this.getMinimumHeight(
                    ) - insetTop;
            ...
            if (Math.abs(verticalOffset) == scrollRange) {
            	...
            	layout.setElevation(layout.getTargetElevation());
            } else {
