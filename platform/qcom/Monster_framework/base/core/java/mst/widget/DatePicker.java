...
public class DatePicker extends FrameLayout{
    ...
    public DatePicker(Context context, AttributeSet attrs) {
        this(context, attrs, com.mst.R.attr.datePickerStyle);
    }
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final int mode = a.getInt(com.mst.internal.R.styleable.DatePicker_datePickerMode, MODE_SPINNER);
        final int firstDayOfWeek = a.getInt(com.mst.internal.R.styleable.DatePicker_android_firstDayOfWeek, 0);
        a.recycle();
        ...
        */
        ...
        DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs,
            ...
            final TypedArray attributesArray = context.obtainStyledAttributes(attrs,
            		com.mst.internal.R.styleable.DatePicker, defStyleAttr, defStyleRes);
            boolean spinnersShown = attributesArray.getBoolean(com.mst.internal.R.styleable.DatePicker_spinnersShown,
                    DEFAULT_SPINNERS_SHOWN);
            boolean calendarViewShown = attributesArray.getBoolean(
            		com.mst.internal.R.styleable.DatePicker_calendarViewShown, DEFAULT_CALENDAR_VIEW_SHOWN);
            int startYear = attributesArray.getInt(com.mst.internal.R.styleable.DatePicker_startYear,
                    DEFAULT_START_YEAR);
            int endYear = attributesArray.getInt(com.mst.internal.R.styleable.DatePicker_endYear, DEFAULT_END_YEAR);
            String minDate = attributesArray.getString(com.mst.internal.R.styleable.DatePicker_minDate);
            String maxDate = attributesArray.getString(com.mst.internal.R.styleable.DatePicker_maxDate);
            int layoutResourceId = attributesArray.getResourceId(
            		com.mst.internal.R.styleable.DatePicker_legacyLayout, com.mst.internal.R.layout.date_picker_legacy);
            mMiddleMargin = attributesArray.getDimensionPixelOffset(com.mst.internal.R.styleable.DatePicker_middleMargin,0);

            mNormalTextSize         = attributesArray.getDimensionPixelSize(com.mst.internal.R.styleable.DatePicker_normalTextSize,0          );
            mSelectorTextSize       = attributesArray.getDimensionPixelSize(com.mst.internal.R.styleable.DatePicker_selectionTextSize,0       );
            mSelectorTextColor      = attributesArray.getColor(com.mst.internal.R.styleable.DatePicker_selectionTextColor,0      );
            mSelectorLabelTextSize  = attributesArray.getDimensionPixelSize(com.mst.internal.R.styleable.DatePicker_selectionLabelTextSize,0  );
            mSelectorLabelTextColor = attributesArray.getColor(com.mst.internal.R.styleable.DatePicker_selectionLabelTextColor,0 );
            mSecondTextSize         = attributesArray.getDimensionPixelSize(com.mst.internal.R.styleable.DatePicker_secondTextSize,0          );
            mSecondTextColor        = attributesArray.getColor(com.mst.internal.R.styleable.DatePicker_secondTextColor,0         );
            mLabelFontFamily        = attributesArray.getString(com.mst.internal.R.styleable.DatePicker_labelFontFamily         );
            mLabelSpace1             = attributesArray.getDimensionPixelSize(com.mst.internal.R.styleable.DatePicker_labelspace1,0             );
            mLabelSpace2             = attributesArray.getDimensionPixelSize(com.mst.internal.R.styleable.DatePicker_labelspace2,0             );
            mLabelSpace3             = attributesArray.getDimensionPixelSize(com.mst.internal.R.styleable.DatePicker_labelspace3,0             );
            mLabelTextStyle         = attributesArray.getDimensionPixelSize(com.mst.internal.R.styleable.DatePicker_labelTextStyle,0          );
            mFontFamily             = attributesArray.getString(com.mst.internal.R.styleable.DatePicker_android_fontFamily      );
            mTextStyle              = attributesArray.getDimensionPixelSize(com.mst.internal.R.styleable.DatePicker_android_textStyle,0       );
            ...
            if(mLabelSpace3 != 0)                    mDaySpinner.setLabelSpace(mLabelSpace3);
            ...
            if(mNormalTextSize != 0)                 mMonthSpinner.setNormalTextSize(mNormalTextSize);
            if(mSelectorTextSize != 0)               mMonthSpinner.setSelectorTextSize(mSelectorTextSize);
            if(mSelectorTextColor != 0)              mMonthSpinner.setSelectorTextColor(mSelectorTextColor);
            if(mSelectorLabelTextSize != 0)          mMonthSpinner.setSelectorLabelTextSize(mSelectorLabelTextSize);
            if(mSelectorLabelTextColor != 0)         mMonthSpinner.setSelectorLabelTextColor(mSelectorLabelTextColor);
            if(mSecondTextSize != 0)                 mMonthSpinner.setSecondTextSize(mSecondTextSize);
            if(mSecondTextColor != 0)                mMonthSpinner.setSecondTextColor(mSecondTextColor);
            if(!TextUtils.isEmpty(mLabelFontFamily)) mMonthSpinner.setSelectorLabelFontFamily(mLabelFontFamily,mLabelTextStyle);
            if(mLabelSpace2 != 0)                    mMonthSpinner.setLabelSpace(mLabelSpace2);
            if(!TextUtils.isEmpty(mFontFamily))      mMonthSpinner.setFontFamily(mFontFamily,mTextStyle);
            ...
            if(mNormalTextSize != 0)                 mYearSpinner.setNormalTextSize(mNormalTextSize);
            if(mSelectorTextSize != 0)               mYearSpinner.setSelectorTextSize(mSelectorTextSize);
            if(mSelectorTextColor != 0)              mYearSpinner.setSelectorTextColor(mSelectorTextColor);
            if(mSelectorLabelTextSize != 0)          mYearSpinner.setSelectorLabelTextSize(mSelectorLabelTextSize);
            if(mSelectorLabelTextColor != 0)         mYearSpinner.setSelectorLabelTextColor(mSelectorLabelTextColor);
            if(mSecondTextSize != 0)                 mYearSpinner.setSecondTextSize(mSecondTextSize);
            if(mSecondTextColor != 0)                mYearSpinner.setSecondTextColor(mSecondTextColor);
            if(!TextUtils.isEmpty(mLabelFontFamily)) mYearSpinner.setSelectorLabelFontFamily(mLabelFontFamily,mLabelTextStyle);
            if(mLabelSpace1 != 0)                    mYearSpinner.setLabelSpace(mLabelSpace1);
            if(!TextUtils.isEmpty(mFontFamily))      mYearSpinner.setFontFamily(mFontFamily,mTextStyle);
        ...
        private boolean usingNumericMonths() {
            return true;//Character.isDigit(mShortMonths[Calendar.JANUARY].charAt(0));
        }
