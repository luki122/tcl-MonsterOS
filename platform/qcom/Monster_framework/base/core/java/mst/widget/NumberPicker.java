...
public class NumberPicker extends LinearLayout {
    ...
    /**
     * Select Divider is not draw by default.
     */
    private boolean mDrawSelectDivider = false;
    
    /**
     * Label to show Value type
     */
    ...
    private int mMaxDisplayWidth = 0;
    ...
    private int mSelectionTextSize;
    private int mSelectionTextColor;
    private int mEditTextTextPosition = -1;

    private final String DEFAULT_FONT_FAMILY = "monster-normal";
    private final int DEFAULT_FONT_STYLE = Typeface.NORMAL;
    ...
    public NumberPicker(Context context, AttributeSet attrs) {
        this(context, attrs, com.mst.internal.R.attr.numberPickerStyle);
    }
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final int layoutResId = attributesArray.getResourceId(
                com.mst.internal.R.styleable.NumberPicker_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);

        mHasSelectorWheel = (layoutResId != DEFAULT_LAYOUT_RESOURCE_ID);


        mSolidColor = attributesArray.getColor(com.mst.internal.R.styleable.NumberPicker_solidColor, 0);

        final Drawable selectionDivider = attributesArray.getDrawable(
        		com.mst.internal.R.styleable.NumberPicker_selectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
        		com.mst.internal.R.styleable.NumberPicker_selectionDividerHeight, defSelectionDividerHeight);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
        		com.mst.internal.R.styleable.NumberPicker_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
        		com.mst.internal.R.styleable.NumberPicker_internalMinHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
        		com.mst.internal.R.styleable.NumberPicker_internalMaxHeight, SIZE_UNSPECIFIED);

        isAutoWidth = attributesArray.getBoolean(
        		com.mst.internal.R.styleable.NumberPicker_autoWidth, true);
        if (mMinHeight != SIZE_UNSPECIFIED && mMaxHeight != SIZE_UNSPECIFIED
                && mMinHeight > mMaxHeight) {
            throw new IllegalArgumentException("minHeight > maxHeight");
        }
        
        mDrawSelectDivider = attributesArray.getBoolean(com.mst.internal.R.styleable.NumberPicker_drawSelectionDivider, false);
        
        String label = attributesArray.getString(com.mst.internal.R.styleable.NumberPicker_selectionLabel);

        mMinWidth = attributesArray.getDimensionPixelSize(
        		com.mst.internal.R.styleable.NumberPicker_internalMinWidth, SIZE_UNSPECIFIED);

        mMaxWidth = attributesArray.getDimensionPixelSize(
        		com.mst.internal.R.styleable.NumberPicker_internalMaxWidth, SIZE_UNSPECIFIED);
        ...
        mVirtualButtonPressedDrawable = attributesArray.getDrawable(
        		com.mst.internal.R.styleable.NumberPicker_virtualButtonPressedDrawable);

        int normalTextSize = attributesArray.getDimensionPixelSize(
                com.mst.internal.R.styleable.NumberPicker_normalTextSize,-1);

        mSecondTextSize = attributesArray.getDimensionPixelSize(
                com.mst.internal.R.styleable.NumberPicker_secondTextSize,-1);
        mSecondTextColor = attributesArray.getColor(
                com.mst.internal.R.styleable.NumberPicker_secondTextColor,0);

        mSelectionTextSize = attributesArray.getDimensionPixelSize(
                com.mst.internal.R.styleable.NumberPicker_selectionTextSize,-1);
        mSelectionTextColor = attributesArray.getColor(
                com.mst.internal.R.styleable.NumberPicker_selectionTextColor,0);

        int labelTextSize = attributesArray.getDimensionPixelSize(
                com.mst.internal.R.styleable.NumberPicker_selectionLabelTextSize,-1);
        int labelTextColor = attributesArray.getColor(
                com.mst.internal.R.styleable.NumberPicker_selectionLabelTextColor,Color.RED);
        mLabelSpace = attributesArray.getDimensionPixelSize(
                com.mst.internal.R.styleable.NumberPicker_labelspace,0);

        mLabelFontFamily = attributesArray.getString(
                com.mst.internal.R.styleable.NumberPicker_labelFontFamily);
        if(mLabelFontFamily == null || "".equals(mLabelFontFamily)){
            mLabelFontFamily = DEFAULT_FONT_FAMILY;
        }
        mLabelTextStyle = attributesArray.getInt(
                com.mst.internal.R.styleable.NumberPicker_labelTextStyle,DEFAULT_FONT_STYLE);
        mFontFamily = attributesArray.getString(
                com.mst.internal.R.styleable.NumberPicker_android_fontFamily);
        if(mFontFamily == null || "".equals(mFontFamily)){
            mFontFamily = DEFAULT_FONT_FAMILY;
        }
        mTextStyle = attributesArray.getInt(
                com.mst.internal.R.styleable.NumberPicker_android_textStyle,DEFAULT_FONT_STYLE);
        ...
        if (!mHasSelectorWheel) {
            mIncrementButton = (ImageButton) findViewById(com.android.internal.R.id.increment);
        ...
        // decrement button
        if (!mHasSelectorWheel) {
            mDecrementButton = (ImageButton) findViewById(com.android.internal.R.id.decrement);
        ...
        // input text
        mInputText = (EditText) findViewById(com.android.internal.R.id.numberpicker_input);
        ...
        if(normalTextSize == -1){
            ...
            mTextSize = normalTextSize;
        }

        if(mSelectionTextSize != -1){
            mInputText.setTextSize(TypedValue.COMPLEX_UNIT_PX,mSelectionTextSize);
        }else{
            mInputText.setTextSize(TypedValue.COMPLEX_UNIT_PX,mTextSize);
        }

        if(mSelectionTextColor != 0){
            mInputText.setTextColor(mSelectionTextColor);
        }
        mInputText.setTypeface(Typeface.create(mFontFamily,mTextStyle));
        ...
        int color = mSecondTextColor == 0 ? colors.getColorForState(ENABLED_STATE_SET, Color.WHITE) : mSecondTextColor;
        paint.setColor(color);
        mSelectorWheelPaint = paint;
        
        //create the label paint
        Paint labelPaint = new Paint();
        labelPaint.setAntiAlias(true);
        labelPaint.setTextAlign(Align.CENTER);
        labelPaint.setTextSize(labelTextSize == -1 ? mTextSize : labelTextSize);
        labelPaint.setColor(labelTextColor);
        labelPaint.setTypeface(Typeface.create(mLabelFontFamily,mLabelTextStyle));
        mLabelPaint = labelPaint;
    ...
    public void setSelectorTextSize(int size){
        mSelectionTextSize = size;
        if(mInputText != null){
            mInputText.setTextSize(TypedValue.COMPLEX_UNIT_PX,mSelectionTextSize);
        }
    }
    ...
    public void setSelectorLabelTextSize(int size){
        if(mLabelPaint != null){
            mLabelPaint.setTextSize(size);
        }
    }

    public void setSelectorLabelTextColor(int color){
        if(mLabelPaint != null){
            mLabelPaint.setColor(color);
        }
    }

    public void setSelectorLabelFontFamily(String family ,int style){
        mLabelFontFamily = family;
        mLabelTextStyle = style;
        if(mLabelPaint != null){
            mLabelPaint.setTypeface(Typeface.create(family,style));
        }
    }

    public void setFontFamily(String family,int style){
        mFontFamily = family;
        mTextStyle = style;
        if(mInputText != null){
            mInputText.setTypeface(Typeface.create(family,style));
        }
        if(mSelectorWheelPaint != null){
            mSelectorWheelPaint.setTypeface(Typeface.create(family,style));
        }
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        final int inptTxtTop = (msrdHght - inptTxtMsrdHght - (mSelectionTextSize == -1 ? 0 : (mSelectionTextSize - mTextSize))) / 2;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthSize = resolveSizeAndStateRespectingMinSize(mMinWidth, getMeasuredWidth(),
                widthMeasureSpec);
        if(isAutoWidth) {
            if(mMaxDisplayWidth != 0) {
                widthSize = (int) (mMaxDisplayWidth + 2 * mLabelSpace + 2 * mLabelWidth);
            }
        }
    ...
    /**
     * Draw selection divider or not
     * @param draw
     */
    public void drawSelectionDivider(boolean draw){
    	mDrawSelectDivider = draw;
    }
    
    /**
     * Sets the value label to show it's data type
     * @param label
     */
    public void setSelectionLabel(String label){
    	mSelectionLabel = label;
    	if(!TextUtils.isEmpty(label)){
    		mLabelWidth = mLabelPaint.measureText(label);
    	}
    ...
    public void setMinValue(int minValue) {
        ...
        if (mDisplayedValues == null && isAutoWidth && mMaxValue > mMinValue) {
            String text = "";
            Paint paint = mInputText.getPaint();
            for(int i=mMinValue;i<=mMaxValue;i++) {
                text = formatNumber(i);
                int old = mMaxDisplayWidth;
                mMaxDisplayWidth = Math.max(old,(int)paint.measureText(text,0,text.length()));
            }
        }
        updateWrapSelectorWheel();
        initializeSelectorWheelIndices();
    ...
    public void setDisplayedValues(String[] displayedValues) {
        ...
        if (mDisplayedValues != null && isAutoWidth) {
            String text = "";
            Paint paint = mInputText.getPaint();
            for(int i=0;i<mDisplayedValues.length;i++){
                text = mDisplayedValues[i];
                int old = mMaxDisplayWidth;
                mMaxDisplayWidth = Math.max(old,(int)paint.measureText(text,0,text.length()));
            }
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final boolean showSelectorWheel =  true;
        ...
        int middleOffset = mInitialScrollOffset + SELECTOR_MIDDLE_ITEM_INDEX * mSelectorElementHeight;
        int[] selectorIndices = mSelectorIndices;
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if ((showSelectorWheel && i != SELECTOR_MIDDLE_ITEM_INDEX) ||
                ...
                if(mSelectionTextSize != -1 || mSecondTextSize != -1){
                    int selectSize = mSelectionTextSize != -1 ? mSelectionTextSize : mTextSize;
                    int secondSize = mSecondTextSize != -1 ? mSecondTextSize : mTextSize;
                    if (Math.abs(y - middleOffset) < mSelectorElementHeight) {
                        int fTextSize = (int) ((selectSize - secondSize) * Math.abs(y - middleOffset) / (float) mSelectorElementHeight);
                        mSelectorWheelPaint.setTextSize(selectSize - fTextSize);
                    } else if(Math.abs(y - middleOffset) < 2*mSelectorElementHeight && Math.abs(y - middleOffset) >= mSelectorElementHeight) {
                        int fTextSize = (int) ((secondSize - mTextSize) * (Math.abs(y - middleOffset) - mSelectorElementHeight) / (float) mSelectorElementHeight);
                        mSelectorWheelPaint.setTextSize(secondSize - fTextSize);
                    } else {
                        mSelectorWheelPaint.setTextSize(mTextSize);
                    }
                }
                if(mSelectionTextColor != mSecondTextColor){
                    if (Math.abs(y - middleOffset) < mSelectorElementHeight/2) {
                        mSelectorWheelPaint.setColor(mSelectionTextColor);
                    } else {
                        mSelectorWheelPaint.setColor(mSecondTextColor);
                    }
                }
                canvas.drawText(scrollSelectorValue, x, y, mSelectorWheelPaint);
            }
//            if(i == SELECTOR_MIDDLE_ITEM_INDEX && mLabelTop == 0){
//            	mLabelTop = y;
//            }
        ...
        if (showSelectorWheel && mSelectionDivider != null && mDrawSelectDivider) {
        ...
        if(!TextUtils.isEmpty(mSelectionLabel)){
            mLabelTop = middleOffset;
        	 int topOfLabel = (int) mLabelTop;
        	canvas.drawText(mSelectionLabel, getWidth() - mLabelWidth/2 - (isAutoWidth?0:mLabelSpace), topOfLabel, mLabelPaint);
        }
    }
    ...
    private void initializeSelectorWheel() {
        ...
        // mInputText
        mEditTextTextPosition = mInputText.getBaseline() + mInputText.getTop();
        mInitialScrollOffset = mEditTextTextPosition
    ...
    class SetSelectionCommand implements Runnable {
        ...
        public void run() {
            if(mInputText.getText().toString().length()>=mSelectionEnd) {
