...
import mst.widget.recycleview.NestedScrollingChild;
import mst.widget.recycleview.NestedScrollingChildHelper;
...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent,
   ...
   private static final AccessibilityDelegate ACCESSIBILITY_DELEGATE = new AccessibilityDelegateInternal();
   ...
   public boolean onInterceptTouchEvent(MotionEvent ev) {
       ...
       */
        ...
        */
       if (getScrollY() == 0 && !this.canScrollVertically(1)) {
           return false;
       }
       ...
       if ((event.getSource() & InputDevice.SOURCE_CLASS_POINTER) != 0) {
           switch (event.getAction()) {
               case MotionEvent.ACTION_SCROLL: {
                   if (!mIsBeingDragged) {
                       final float vscroll = event.getAxisValue(
   ...
   private void ensureGlows() {
       if (this.getOverScrollMode() != View.OVER_SCROLL_NEVER) {
           if (mEdgeGlowTop == null) {
   ...
   static class AccessibilityDelegateInternal extends AccessibilityDelegate {
       @Override
       ...
       public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
           ...
           final AccessibilityEvent record = event;
