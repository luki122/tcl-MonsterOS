...
import com.android.internal.app.MstResolverActivity;
...
public class DrawerActivityLayout extends ViewGroup {
    private static final String TAG = "DrawerActivityLayout";
    ...
    private MstResolverActivity mResolverActivity;
    
    public void setResolverActivity(MstResolverActivity activity) {
    	mResolverActivity = activity;
    }
    ...
    public DrawerActivityLayout(Context context) {
        this(context, null);
    }

    public DrawerActivityLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DrawerActivityLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        final TypedArray a = context.obtainStyledAttributes(attrs, com.mst.internal.R.styleable.DrawerActivityLayout,
                defStyleAttr, 0);
        mMaxWidth = a.getDimensionPixelSize(com.mst.internal.R.styleable.DrawerActivityLayout_android_maxWidth, -1);
        mMaxCollapsedHeight = a.getDimensionPixelSize(
        		com.mst.internal.R.styleable.DrawerActivityLayout_maxCollapsedHeight, 0);
        mMaxCollapsedHeightSmall = a.getDimensionPixelSize(
        		com.mst.internal.R.styleable.DrawerActivityLayout_maxCollapsedHeightSmall,
                mMaxCollapsedHeight);
        a.recycle();
    ...
    private float performDrag(float dy) {
        ...
        if (mResolverActivity.mbHasMore == true ) {
            return 0;
        }
        // end add by huliang
    ...
    public void smoothScrollTo(int yOffset, float velocity, int duration) {
        abortAnimation();
        final int sy = (int) mCollapseOffset;
        int dy = yOffset - sy;
        if (dy == 0) {
    ...
    private boolean isDescendantClipped(View child) {
        ...
        // DrawerActivityLayout lays out vertically in child order;
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            final TypedArray a = c.obtainStyledAttributes(attrs,
            		com.mst.internal.R.styleable.DrawerActivityLayout_LayoutParams);
            alwaysShow = a.getBoolean(
            		com.mst.internal.R.styleable.DrawerActivityLayout_LayoutParams_layout_alwaysShow,
                    false);
            ignoreOffset = a.getBoolean(
            		com.mst.internal.R.styleable.DrawerActivityLayout_LayoutParams_layout_ignoreOffset,
                    false);
            a.recycle();
        }
    ...
    public void resetMaxCollapsedHeight ( ){
    	mMaxCollapsedHeight = mMaxCollapsedHeight + 18;
    }
}
