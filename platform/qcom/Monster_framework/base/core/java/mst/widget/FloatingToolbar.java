...
import mst.utils.Preconditions;
    ...
    private static final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View parent) {
            ...
            mMarginHorizontal = /*parent.getResources()
                    .getDimensionPixelSize(R.dimen.floating_toolbar_horizontal_margin)*/0;
            mMarginVertical = /*parent.getResources()
                    .getDimensionPixelSize(R.dimen.floating_toolbar_vertical_margin)*/0;
...
//            ViewGroup.LayoutParams
    ...
    private static ViewGroup createContentContainer(Context context) {
        ViewGroup contentContainer = (ViewGroup) LayoutInflater.from(context)
                .inflate(com.mst.internal.R.layout.floating_popup_container, null);
        contentContainer.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, /*ViewGroup.LayoutParams.WRAP_CONTENT*/context.getResources()
                .getDimensionPixelSize(com.mst.R.dimen.action_bar_default_height_material)));
