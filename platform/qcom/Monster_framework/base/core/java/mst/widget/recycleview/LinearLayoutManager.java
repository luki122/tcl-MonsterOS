...
import mst.widget.recycleview.helper.OrientationHelper;
import mst.widget.recycleview.helper.ScrollbarHelper;
...
import mst.widget.recycleview.helper.ItemTouchHelper;

/**
 * A {@link mst.widget.RecyclerView.LayoutManager} implementation which provides
...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements
    ...
    * */
    ...
    /**
     * Sets the orientation of the layout. {@link mst.widget.LinearLayoutManager}
     ...
     * When set to true, If {@link mst.widget.RecyclerView} is LTR, than it will
     * layout from RTL, if {@link mst.widget.RecyclerView}} is RTL, it will layout
     * from LTR.
     *
     ...
     * By default, {@link mst.widget.LinearLayoutManager} lays out 1 extra page of
     ...
     *
     * @param recycler Recycler instance of {@link mst.widget.RecyclerView}
     ...
     * @see #recycleViewsFromStart(mst.widget.RecyclerView.Recycler, int)
     * @see #recycleViewsFromEnd(mst.widget.RecyclerView.Recycler, int)
     * @see mst.widget.LinearLayoutManager.LayoutState#mLayoutDirection
     */
     ...
     * independent from the rest of the {@link mst.widget.LinearLayoutManager}
