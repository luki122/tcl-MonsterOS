...
public class MultiSelectListPreference extends DialogPreference {
    ...
    private SpinnerPopupDialog mDialog;
	...
	protected void onPrepareListDialog(SpinnerPopupDialog dialog) {
        ...
        boolean[] checkedItems = getSelectedItems();
        mDialog.setMultipleChoiceItems(mEntries, checkedItems,
                new DialogInterface.OnMultiChoiceClickListener() {
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                        if (isChecked) {
                            mPreferenceChanged |= mNewValues.add(mEntryValues[which].toString());
    ...
    protected void showDialog(Bundle state) {
    	// TODO Auto-generated method stub
    	   Dialog dialog = mDialog = new SpinnerPopupDialog(getContext());
           ...
           mDialog.setPositiveButton(this);
           mDialog.setNegativeButton(this);
           dialog.setOnDismissListener(this);
           dialog.show();
           onPrepareListDialog(mDialog);
    }
