 ...
 */
public abstract class PreferenceActivity extends MstListActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TypedArray sa = obtainStyledAttributes(null,
                com.mst.internal.R.styleable.PreferenceActivity,
                com.mst.R.attr.preferenceActivityStyle,
                0);

        final int layoutResId =  com.mst.R.layout.preference_list_content_material;

        mPreferenceHeaderItemResId = com.mst.R.layout.preference_header_item_material;
        		/*sa.getResourceId(
                com.mst.internal.R.styleable.PreferenceActivity_headerLayout,
                com.android.internal.R.layout.preference_header_item);*/
        mPreferenceHeaderRemoveEmptyIcon = sa.getBoolean(
                com.mst.internal.R.styleable.PreferenceActivity_headerRemoveIconIfEmpty,
                false);
        ...
        if (initialFragment != null && mSinglePane) {
            ...
            // of preferences" mode.
            setContentView(com.mst.R.layout.preference_list_content_single);
            mListFooter = (FrameLayout) findViewById(com.android.internal.R.id.list_footer);
    ...
    public void startPreferencePanel(String fragmentClass, Bundle args, @StringRes int titleRes,
        ...
        Log.d(TAG,"preference start panel-->"+"SinglePanel:"+mSinglePane+" fragmentClass:"+fragmentClass);
        if (mSinglePane) {
