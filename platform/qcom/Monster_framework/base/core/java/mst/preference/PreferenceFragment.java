...
import mst.preference.PreferenceManager.OnDisplayPreferenceDialogListener;
...
public abstract class PreferenceFragment extends Fragment implements
        PreferenceManager.OnPreferenceTreeClickListener,OnDisplayPreferenceDialogListener 
        ,DialogPreference.TargetFragment{

    private static final String PREFERENCES_TAG = "mst:preferences";
    private static final String DIALOG_FRAGMENT_TAG =
            "mst:preferences.PreferenceFragment.DIALOG";
    ...
    private int mLayoutResId = com.mst.R.layout.preference_list_fragment_material;
    
    private Drawable mDivider = null; // add by huliang
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        TypedArray a = getActivity().obtainStyledAttributes(null,
                ...
                com.mst.R.attr.preferenceFragmentStyle,
                0);
