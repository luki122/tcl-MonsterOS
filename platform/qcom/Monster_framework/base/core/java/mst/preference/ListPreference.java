...
public class ListPreference extends DialogPreference {
    ...
    public ListPreference(Context context, AttributeSet attrs) {
        this(context, attrs, com.mst.R.attr.dialogPreferenceStyle);
    }
    ...
    /**
     * Please use onPrepareListDialog(SpinnerPopupDialog dialog) 
     */
    @Deprecated 
    @Override
    ...
    protected void onPrepareListDialog(SpinnerPopupDialog dialog){
        ...
        dialog.setSingleChoiceItems(mEntries, mClickedDialogEntryIndex, 
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        mClickedDialogEntryIndex = which;
	...
	protected void showDialog(Bundle state) {
		...
		SpinnerPopupDialog dialog = new SpinnerPopupDialog(getContext());
		//We don't need positive button
	/*	if(!TextUtils.isEmpty(getPositiveButtonText())){
			dialog.setPositiveButton(this);
		}*/
		if(!TextUtils.isEmpty(getNegativeButtonText())){
			dialog.setNegativeButton(this);
		}
