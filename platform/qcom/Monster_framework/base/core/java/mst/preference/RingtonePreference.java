...
public class RingtonePreference extends Preference implements
    ...
    private static final String ACTIVITY_TITLE_TEXTCOLOR = "titleTextColor";
    private static final String ACTIVITY_TITLE_TEXTSIZE = "titleTextSize";
    private static final String ACTIVITY_TITLE_FONTFAMILY = "titleFontFamily";
    private static final String ACTIVITY_TITLE_FONTSTYLE = "titleFontStyle";
    private static final String ACTIVITY_TITLE_DIVIDERCOLOR = "titleDividerColor";
    private static final String ACTIVITY_TITLE_BACKGROUND = "titleBackground";
    ...
    private int titleDividerColor = 0;
    ...
    public RingtonePreference(Context context, AttributeSet attrs) {
        this(context, attrs, com.mst.R.attr.ringtonePreferenceStyle);
    }
    ...
    protected void onClick() {
        ...
        intent.putExtra(ACTIVITY_TITLE_TEXTCOLOR, titleTextColor);
        intent.putExtra(ACTIVITY_TITLE_TEXTSIZE, titleTextSize);
        intent.putExtra(ACTIVITY_TITLE_FONTFAMILY, titleFontFamily);
        intent.putExtra(ACTIVITY_TITLE_FONTSTYLE, titleFontStyle);
        intent.putExtra(ACTIVITY_TITLE_DIVIDERCOLOR, titleDividerColor);
        intent.putExtra(ACTIVITY_TITLE_BACKGROUND, titleBackground);
        // end add by huliang
