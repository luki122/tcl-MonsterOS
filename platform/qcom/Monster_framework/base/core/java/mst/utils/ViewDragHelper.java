...
public class ViewDragHelper {
    ...
    public static ViewDragHelper create(ViewGroup forParent, Callback cb) {
        return create(forParent, null, cb);
    }
    ...
    public static ViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final ViewDragHelper helper = create(forParent, null, cb);
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Interpolator interpolator, Callback cb) {
        ...
        Interpolator inter = sInterpolator;
        if(interpolator != null){
            inter = interpolator;
        }
        mScroller = new Scroller(context, inter);
    }
    ...
    private void saveLastMotion(MotionEvent ev) {
        ...
        for (int i = 0; i < pointerCount; i++) {
            ...
            if(pointerId >= 0 && pointerId < mLastMotionX.length) {
                mLastMotionX[pointerId] = x;
            }
            if(pointerId >= 0 && pointerId < mLastMotionY.length) {
    ...
    public void processTouchEvent(MotionEvent ev,boolean cancelActionDown){
