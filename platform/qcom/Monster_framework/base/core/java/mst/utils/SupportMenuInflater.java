...
import mst.view.menu.SupportMenu;
...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        private void setItem(MenuItem item) {
            ...
            final MstMenuItemImpl impl = item instanceof MstMenuItemImpl ? (MstMenuItemImpl) item : null;
            if (itemCheckable >= 2) {
                if (item instanceof MstMenuItemImpl) {
                    ((MstMenuItemImpl) item).setExclusiveCheckable(true);
                } 
            }
