...
public class MstSearchView extends LinearLayout implements CollapsibleActionView{
    ...
    private final ImageView mSearchHintIconView;
    ...
    private boolean mExpandedInActionView = true;
    ...
    public MstSearchView(Context context) {
        this(context, null);
    }

    public MstSearchView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.searchViewStyle);
    }

    public MstSearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public MstSearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final int layoutResId = a.getResourceId(
                R.styleable.SearchView_layout, com.mst.R.layout.search_view);
        ...
        mSearchHintIconView = (ImageView)findViewById(com.mst.R.id.search_hint_icon);
        ...
        mSuggestionRowLayout = a.getResourceId(R.styleable.SearchView_suggestionRowLayout,
        		com.mst.R.layout.search_dropdown_item_icons_2line);
        ...
        mSearchHintIconView.setOnClickListener(mOnClickListener);
        ...
        mSearchSrcTextView.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (mOnQueryTextFocusChangeListener != null) {
                    mOnQueryTextFocusChangeListener.onFocusChange(MstSearchView.this, hasFocus);
                }
            }
        });
    ...
    public void needHintIcon(boolean need){
    	mSearchHintIconView.setVisibility(need?View.VISIBLE:View.GONE);
    }
     ...
     * SearchView.
     *
     * @see #setQueryHintTextColor(ColorStateList)
     *
     */
    public void setQueryHintTextColor(@ColorInt int color){
     ...
     *
     * @see #setQueryHintTextColor(int)
     *
     */
    public void setQueryHintTextColor(ColorStateList colors){
    	mSearchSrcTextView.setHintTextColor(colors);
    }
...
//        mSearchSrcTextView.setCompoundDrawables(mSearchHintIcon, null, null, null);
...
//        ssb.append(hintText);
    ...
    private void updateSearchAutoComplete() {
        ...
        if (mSearchable.getSuggestAuthority() != null) {
            mSuggestionsAdapter = new MstSuggestionsAdapter(getContext(),
    ...
    private void onSubmitQuery() {
        ...
        if (query != null && TextUtils.getTrimmedLength(query) > 0) {
            ...
            mSearchSrcTextView.clearFocus(); // add by huliang for appstore
        }
    }
    ...
    private final OnItemSelectedListener mOnItemSelectedListener = new OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            MstSearchView.this.onItemSelected(position);
        }
    ...
    private TextWatcher mTextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start,
        	...
        	MstSearchView.this.onTextChanged(s);
        }
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        void setSearchView(MstSearchView searchView) {
