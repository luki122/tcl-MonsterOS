...
public class MstSpinner extends AbsSpinner implements OnClickListener {
     ...
     */
    public MstSpinner(Context context) {
        this(context, null);
    }
     ...
     * @see #MODE_DROPDOWN
     */
    public MstSpinner(Context context, int mode) {
     ...
     */
    public MstSpinner(Context context, AttributeSet attrs) {
     ...
     */
    public MstSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @see #MODE_DROPDOWN
     */
    public MstSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode) {
     ...
     * @see #MODE_DROPDOWN
     */
    public MstSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes,
            int mode) {
     ...
     * @see #MODE_DROPDOWN
     */
    public MstSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, int mode,
            Theme popupTheme) {
        super(context, attrs, defStyleAttr, defStyleRes);
        
        final TypedArray parentA = context.obtainStyledAttributes(
        ...
        final CharSequence[] entries = parentA.getTextArray(R.styleable.AbsSpinner_entries);
        if (entries != null) {
        	
            final ArrayAdapter<CharSequence> adapter = new ArrayAdapter<CharSequence>(
                    context, com.mst.R.layout.simple_spinner_item, entries);
            if(mode == MODE_DIALOG){
             adapter.setDropDownViewResource(com.mst.R.layout.spinner_bottom_wide_item);
            }else{
             adapter.setDropDownViewResource(com.mst.R.layout.simple_spinner_dropdown_item);
            }
            setAdapter(adapter);
        }
    ...
    private class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        private SpinnerPopupDialog mPopup;
        private ListAdapter mListAdapter;
        ...
        public void show(int textDirection, int textAlignment) {
            ...
            SpinnerPopupDialog builder = new SpinnerPopupDialog(getPopupContext());
            if (mPrompt != null) {
                builder.setTitle(mPrompt);
            }
            mPopup = builder;
            mPopup.show();
            mPopup.setSingleChoiceItems(mListAdapter,
                    getSelectedItemPosition(), this);
//            mPopup.setNegativeButton(this);
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(
            ...
            setAnchorView(MstSpinner.this);
            setModal(true);
            setPromptPosition(POSITION_PROMPT_ABOVE);
            setOnItemClickListener(new OnItemClickListener() {
                public void onItemClick(AdapterView parent, View v, int position, long id) {
                    MstSpinner.this.setSelection(position);
                    if (mOnItemClickListener != null) {
                        MstSpinner.this.performItemClick(v, position, mAdapter.getItemId(position));
                    }
                    dismiss();
                }
            });
        ...
        void computeContentWidth() {
            ...
            final int spinnerPaddingLeft = MstSpinner.this.getPaddingLeft();
            final int spinnerPaddingRight = MstSpinner.this.getPaddingRight();
            final int spinnerWidth = MstSpinner.this.getWidth();
        ...
        public void show(int textDirection, int textAlignment) {
            ...
            listView.setTextDirection(textDirection);
            listView.setTextAlignment(textAlignment);
            setSelection(MstSpinner.this.getSelectedItemPosition());
            ...
            if (vto != null) {
                final OnGlobalLayoutListener layoutListener = new OnGlobalLayoutListener() {
                    @Override
                    public void onGlobalLayout() {
                        if (!MstSpinner.this.isVisibleToUser()) {
                            dismiss();
                        } else {
                            computeContentWidth();
