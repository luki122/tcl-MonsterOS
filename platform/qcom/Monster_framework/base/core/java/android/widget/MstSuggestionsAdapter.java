...
public class MstSuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private final MstSearchView mSearchView;
    ...
    public MstSuggestionsAdapter(Context context, MstSearchView searchView, SearchableInfo searchable,
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        // Set up icon.
        final ImageView iconRefine = (ImageView) v.findViewById(com.android.internal.R.id.edit_query);
    ...
    private CharSequence formatUrl(Context context, CharSequence url) {
        if (mUrlColor == null) {
            ...
            context.getTheme().resolveAttribute(com.android.internal.R.attr.textColorSearchUrl, colorValue, true);
