...
public class SmsProvider extends ContentProvider {
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        } else if (qb.getTables().equals(VIEW_SMS_RESTRICTED)) {
            if(selectionEmpty) {
                selection = "reject = 0";
            } else {
                selection = selection + " AND reject = 0";
    ...
    private Uri insertInner(Uri url, ContentValues initialValues, int callerUid, String callerPkg) {
        ...
        //tangyisen add reject notification
        if (isReject) {
    ...
    //lichao add begin
    private static final int SMS_CAR_ALL = 33;
    private static final int SMS_CAR_ID = 34;
    //lichao add end
    ...
    static {
        ...
        //lichao add begin
        sURLMatcher.addURI("sms", "car", SMS_CAR_ALL);
        sURLMatcher.addURI("sms", "car/#", SMS_CAR_ID);
        //lichao add end
    }
}
