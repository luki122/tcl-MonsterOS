...
public class MediaFile {
    ...
    static {
        ...
        addFileType("3GPP", FILE_TYPE_3GPP, "video/*", MtpConstants.FORMAT_3GP_CONTAINER);//video/3gpp
        addFileType("3G2", FILE_TYPE_3GPP2, "video/*", MtpConstants.FORMAT_3GP_CONTAINER);//video/3gpp2
