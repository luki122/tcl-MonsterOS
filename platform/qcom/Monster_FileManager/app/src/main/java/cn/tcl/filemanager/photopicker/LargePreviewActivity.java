...
public class LargePreviewActivity extends FileBaseActionbarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionbarTitle(ImagePickerPlusActivity.getSizeStr(new File(filePath).length()));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (isJustPreview) {
            ...
            getMenuInflater().inflate(R.menu.main_choice, menu);
            return true;
        }
    }
