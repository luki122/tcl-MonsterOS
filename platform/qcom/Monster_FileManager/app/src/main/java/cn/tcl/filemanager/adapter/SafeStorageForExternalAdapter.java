...
public class SafeStorageForExternalAdapter extends BaseAdapter{
    ...
    public SafeStorageForExternalAdapter(Context mContext, FileManagerApplication mApplication, MountManager mMountPointManager) {
    ...
    public void setStorageInfo(String name, ViewHolder holder) {
        if (name.equals(context.getResources().getString(R.string.sd_card))) {
