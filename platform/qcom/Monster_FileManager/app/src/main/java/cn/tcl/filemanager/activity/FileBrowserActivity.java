...
public class FileBrowserActivity extends FileBaseActivity implements
    ...
    private String mTagMode = PHONE_TAG;
...
//	private PathProgressLayout usbPathLayout;
    ...
    private void getParameter() {
        ...
        mTagMode = editor.getString(PREF_CURR_TAG, PHONE_TAG);

        if(TextUtils.equals(mTagMode, PHONE_TAG)
                || TextUtils.equals(mTagMode, SDCARD_TAG)
                ||TextUtils.equals(mTagMode, USBOTG_TAG)) {
            setFirstTag(true);
        }
    ...
    public void onBackPressed() {
        ...
        LogUtils.d(TAG, "current_path:" + mApplication.mCurrentPath);
        LogUtils.d(TAG, "this is onbackpressed:" + mFileMode);
        if (mFileMode == FILE_MODE_EDIT) {
            LogUtils.d("BAR", "this is onbackpressed"); // MODIFIED by songlin.qi, 2016-06-01,BUG-2231253
        ...
        LogUtils.d(TAG, "currentMode:" + CategoryManager.mCurrentMode);
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.more_item:
                        ...
                        if (CategoryManager.mCurrentCagegory == CategoryManager.CATEGORY_SAFE) {
                            mEncryptBottomView.setTitle(getString(R.string.chip_decryption));
                        } else {
                            mEncryptBottomView.setTitle(getString(R.string.chip_encryption));
                        }
                        break;
                }
                return true;
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.menu_system_safe:
                        ...
                        if (SharedPreferenceUtils.isFristEnterSafe(FileBrowserActivity.this)) {
                            ...
                            SharedPreferenceUtils.setFristEnterSafe(FileBrowserActivity.this, true);
                            enterEncryptIntent.putExtra(FileEncryptWelcomeActivity.STATUS_KEY, FileEncryptWelcomeActivity.MORE_STATUS);
                            enterEncryptIntent.setClass(FileBrowserActivity.this, FileEncryptWelcomeActivity.class);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.add_encrypt_item:
                        ...
                        mActivityListener.clickEditBtn();
                        //modify by liaoah
                        mApplication.mEncryptTargePath = mApplication.mCurrentPath;
                        //modify end
...
//+fileBrowerList.mNextX+"mDisplayOffset is "+fileBrowerList.mDisplayOffset+"filebrowerList is"+fileBrowerList.getWidth()); //MODIFIED by haifeng.tang, 2016-04-07,BUG-1913438
        ...
        if (mApplication.mService != null) {
            mApplication.mService
                    .setListType(
                            ...
                            FileBrowserActivity.this.getClass().getName());
        }
    ...
    public void updateCopyFragment() {
        if (mMountPointManager.isSDCardMounted() || mMountPointManager.isOtgMounted()) {
            Intent intent = new Intent(FileBrowserActivity.this, SelectStorageActivity.class);
    ...
    public void addEncryptFileFragment() {
        LogUtils.e(TAG,"enter add EncryFileFragment function....");
        if(mMountPointManager.isSDCardMounted() || mMountPointManager.isOtgMounted()){
            Intent intent=new Intent(FileBrowserActivity.this,SelectStorageActivity.class);
            startActivityForResult(intent, STORAGE_SELECT_CODE);
        }else{
    ...
    protected void refreshPathAdapter(String path) {
        ...
        LogUtils.e(TAG,"refreshPathAdapter PATH " +path);
...
//                    updateFragment(CATEGORY_TAG);
    ...
    private void showChoiceResourceDialog(int type) {
        ...
        sortPop = new CustomPopupWindowBasedAnchor(
                sortmenu, sortpopwidth, LayoutParams.WRAP_CONTENT, FileBrowserActivity.this);
...
//                    mGlobalSearchView.setText("");
            ...
            case R.id.sd_external_size_parent:
                ...
                mIntent.setClass(FileBrowserActivity.this, SelectStorageForExternalActivity.class);
    ...
    private class SearchListener implements FileManagerService.OperationEventListener { // MODIFIED by haifeng.tang, 2016-05-09,BUG-2104433
        ...
        public void onTaskResult(int result) {
            ...
            LogUtils.e(TAG,"SearchListener onTaskResult updateAdapter");
            mActivityListener.updateAdapter();
        }
    ...
    public boolean onQueryTextChange(String queryString) {
        ...
        if (TextUtils.isEmpty(queryString)) {
            if (isSearchMode) {
                ...
                LogUtils.e(TAG,"Begin to enter refreshAdapter..");
...
/*MODIFIED-END by haifeng.tang,BUG-1913721*/
                ...
                case FILE_COPY_NORMAL:
                    if (null != mToolbar && null != mToolbar.getNavigationIcon()) {
                        mToolbar.getNavigationIcon().setAlpha(200);
                    }
                    showActionMode(false);
...
//        });
    ...
    public void switchDecryptDircetion(List<FileInfo> fileInfos) {
        ...
        //modify by liaoah modify text
        getActionMode().setPositiveText(getString(R.string.ok));
        //modify end
        setFileActionMode(FILE_ADD_DECRYPT);
...
//        mActivityListener.setHideInputMethod(mHideInputMethodListener);
    ...
    private void sortyByCategory(int category) {
        SharedPreferences prefs = PreferenceManager
                .getDefaultSharedPreferences(FileBrowserActivity.this);
...
//    }
    ...
    public void getPathBrowerText() {
        path = mMountPointManager
                .getDescriptionPath(mApplication.mCurrentPath);
        LogUtils.d("SHO", "path is path --111" + path+"------mApplication.mCurrentPath:"+mApplication.mCurrentPath);
...
//        }
    ...
    private SearchViewEX.OnQueryTextListener tbxSearch_TextChanged = new SearchViewEX.OnQueryTextListener() {
        ...
        public boolean onQueryTextChange(String newText) {
            ...
            LogUtils.e(TAG,"Text Search changed QueryText " + mQueryText);
...
//        }
    ...
    private void requestSearchFiles(String query) { //MODIFIED by haifeng.tang, 2016-04-09,BUG-1913721
        LogUtils.e(TAG,"Begin to request Search Files");
        ...
        if (requestCode == 100) {
            if (resultCode == RESULT_OK && mApplication.mIsSafeMove) {
                ...
                if(SharedPreferenceUtils.isFristEnterSafe(FileBrowserActivity.this)){
                    ...
                    enterCateEncryptIntent.setClass(FileBrowserActivity.this, FileEncryptWelcomeActivity.class);
...
//                }
            ...
            if (requestCode == STORAGE_SELECT_CODE && resultCode == STORAGE_SELECT_CODE) {
                ...
                mApplication.mCurrentPath = null;
                if (mSelectTag.equals(PHONE_TAG)) {
                    updateFragment(PHONE_TAG);
                }
                if (mSelectTag.equals(SDCARD_TAG)) {
                    updateFragment(SDCARD_TAG);
                }
                if (mSelectTag.equals(USBOTG_TAG)) {
                    updateFragment(USBOTG_TAG);
                }
                if (SelectStorageActivity.BACK.equals(mSelectTag)) {
                    if (mFileMode == FILE_COPY_NORMAL || mFileMode == FILE_ADD_ENCRYPT) {
                        mApplication.mFileInfoManager.clearPasteList();
                        setFileActionMode(FILE_MODE_NORMAL);
                        mActivityListener.clearChecked();
