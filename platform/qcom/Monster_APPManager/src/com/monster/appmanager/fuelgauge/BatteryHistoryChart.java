...
package com.monster.appmanager.fuelgauge;
...
public class BatteryHistoryChart extends View {
    ...
    public BatteryHistoryChart(Context context, AttributeSet attrs) {
        ...
        mPhoneSignalChart.setColors(com.monster.appmanager.Utils.BADNESS_COLORS);
    ...
    void setStats(BatteryStats stats, Intent broadcast) {
        ...
        mBatteryLevel = com.monster.appmanager.Utils.getBatteryLevel(mBatteryBroadcast);
        ...
        if (mBatteryBroadcast.getIntExtra(BatteryManager.EXTRA_PLUGGED, 0) == 0) {
            ...
            final String statusLabel = com.monster.appmanager.Utils.getBatteryStatus(getResources(),
                    mBatteryBroadcast);
        ...
        if (!com.monster.appmanager.Utils.isWifiOnly(getContext())) {
