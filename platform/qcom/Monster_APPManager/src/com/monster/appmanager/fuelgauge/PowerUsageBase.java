...
public abstract class PowerUsageBase extends SettingsPreferenceFragment {
    ...
    private boolean updateBatteryStatus(Intent intent) {
        if (intent != null) {
            String batteryLevel = com.monster.appmanager.Utils.getBatteryPercentage(intent);
            String batteryStatus = com.monster.appmanager.Utils.getBatteryStatus(getResources(),
                    intent);
