...
//        	mShowSystem = true;
        ...
        } else if(mListType == LIST_TYPE_STORAGE) {
        	mApplications.setOverrideFilter(FILTER_EVERYTHING);
        }
...
//					showSystemApps.setSelection(position);
    ...
    public static final AppFilter FILTER_THIRD_PARTY = new AppFilter() {
        ...
        @Override
        public boolean filterApp(AppEntry entry) {
        	return Utils.isThirdPartyApp(entry.info) && !Utils.isDisabledByUser(entry.info);
        }
    };
    ...
    public static final AppFilter FILTER_EVERYTHING = new AppFilter() {
        ...
        @Override
        public boolean filterApp(AppEntry entry) {
        	if(Utils.isThirdPartyAppDisabled(entry.info)) {
        		return false;
        	}
            return true;
        }
