...
import com.monster.appmanager.AppHeader;
...
public abstract class AppInfoWithHeader extends AppInfoBase {
    ...
    public static Intent infoIntent;
    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        AppHeader.createAppHeader(this, mPackageInfo.applicationInfo.loadIcon(mPm),
                mPackageInfo.applicationInfo.loadLabel(mPm), getInfoIntent(this, mPackageName), 0, mPackageInfo.versionName);
    }

    public static final String ACTION_APPLICATION_DETAILS_SETTINGS = "com.monster.appmanager.APPLICATION_DETAILS_SETTINGS";
    public static Intent getInfoIntent(Fragment fragment, String packageName) {
        ...
        if (showInfo) {
            infoIntent = new Intent(ACTION_APPLICATION_DETAILS_SETTINGS);
            infoIntent.setData(Uri.fromParts("package", packageName, null));
        }
        AppInfoWithHeader.infoIntent = infoIntent;
        return infoIntent;
    }
}
