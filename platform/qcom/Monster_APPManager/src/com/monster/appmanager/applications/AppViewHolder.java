...
//                    summary.setText(entry.externalSizeStr);
                    ...
                    summary.setText(com.monster.appmanager.Utils.formatFileSize(summary.getContext(), cacheSize));
                    break;
                default:
//                    summary.setText(entry.sizeStr);
                    summary.setText(com.monster.appmanager.Utils.formatFileSize(summary.getContext(), entry.size));
                    break;
            }
