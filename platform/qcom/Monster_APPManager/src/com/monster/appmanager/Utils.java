...
import com.monster.appmanager.UserAdapter.UserDetails;
import com.monster.appmanager.dashboard.DashboardTile;
import com.monster.appmanager.drawable.CircleFramedDrawable;
...
public final class Utils {
     ...
     */
    public static final String META_DATA_PREFERENCE_ICON = "com.monster.appmanager.icon";

    /**
     * Name of the meta-data item that should be set in the AndroidManifest.xml
     * to specify the title that should be displayed for the preference.
     */
    public static final String META_DATA_PREFERENCE_TITLE = "com.monster.appmanager.title";

    /**
     * Name of the meta-data item that should be set in the AndroidManifest.xml
     * to specify the summary text that should be displayed for the preference.
     */
    public static final String META_DATA_PREFERENCE_SUMMARY = "com.monster.appmanager.summary";
   ...
   private static boolean isProfileOf(UserManager um, UserHandle otherUser) {
    ...
    public static String formatFileSize(@Nullable Context context, long sizeBytes) {
        ...
        final BytesResult res = Utils.formatBytes(context.getResources(), sizeBytes);
        return Utils.bidiWrap(context, context.getString(com.android.internal.R.string.fileSizeSuffix,
                res.value, res.units));
    }
    ...
    public static BytesResult formatBytes(Resources res, long sizeBytes) {
    ...
    public static boolean isThirdPartyAppDisabled(ApplicationInfo info) {
    	if(isDisabledByUser(info) && isThirdPartyApp(info)) {
    		return true;
    	}
    	return false;
    }
    
    public static boolean isDisabledByUser(ApplicationInfo info) {
    ...
    public static boolean isThirdPartyApp(ApplicationInfo info) {
