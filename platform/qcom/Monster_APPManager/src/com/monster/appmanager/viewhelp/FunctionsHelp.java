...
public class FunctionsHelp implements OnClickListener {
	...
	public void initViews(LinearLayout functionGroup, Context context) {
		...
		int offset = 0;
		functionItems[0] = (TextView)linearLayout.getChildAt(0 *2+offset);
		functionItems[1] = (TextView)linearLayout.getChildAt(1*2+offset);
		functionItems[2] = (TextView)linearLayout.getChildAt(2*2+offset);
		functionItems[3] = (TextView)linearLayout.getChildAt(3*2+offset);
		linearLayout = (LinearLayout)functionGroup.getChildAt(1);
		functionItems[4] = (TextView)linearLayout.getChildAt(0*2+offset);
		functionItems[5] = (TextView)linearLayout.getChildAt(1*2+offset);
		functionItems[6] = (TextView)linearLayout.getChildAt(2*2+offset);
