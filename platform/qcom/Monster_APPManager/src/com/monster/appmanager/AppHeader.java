...
public class AppHeader {
    ...
    public static void createAppHeader(SettingsPreferenceFragment fragment, Drawable icon,
            CharSequence label, Intent settingsIntent, int tintColorRes, String versionName) {
        View bar = fragment.setPinnedHeaderView(R.layout.app_header);
        setupHeaderView(fragment.getActivity(), icon, label, settingsIntent, tintColorRes, bar, versionName);
    }
    ...
    private static View setupHeaderView(final Activity activity, Drawable icon, CharSequence label,
    	...
    	return setupHeaderView(activity, icon, label, settingsIntent, tintColorRes, bar, "");
    }

    private static View setupHeaderView(final Activity activity, Drawable icon, CharSequence label,
            final Intent settingsIntent, int tintColorRes, View bar, String versionName) {
        ...
        final TextView versionView = (TextView) bar.findViewById(R.id.app_version);
        versionView.setText(activity.getString(R.string.version_text, String.valueOf(versionName)));
