...
public final class AppPermissionGroup implements Comparable<AppPermissionGroup> {
    ...
    public static AppPermissionGroup create(Context context, PackageInfo packageInfo,
        ...
        if ((permissionInfo.protectionLevel != PermissionInfo.PROTECTION_DANGEROUS
                ...
                || (permissionInfo.flags & PermissionInfo.FLAG_REMOVED) != 0) && !Utils.isModernPermissionGroupSelf(permissionInfo.group)) {
            return null;
        }
    ...
    public static AppPermissionGroup create(Context context, PackageInfo packageInfo,
        ...
        for (int i = 0; i < permissionCount; i++) {
            ...
            if (requestedPermissionInfo.protectionLevel != PermissionInfo.PROTECTION_DANGEROUS && !Utils.isModernPermissionGroupSelf(requestedPermissionInfo.group)) {
                continue;
            }
