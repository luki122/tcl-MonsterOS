...
public class PermissionApps {
    ...
    public int[] getAllTypeCount(ArraySet<String> launcherPkgs) {
        ...
        for (PermissionApp app : mPermApps) {
            ...
            int index = PermissionsSelectPreference.setSelectedIndex(app.mAppPermissionGroup.areRuntimePermissionsGranted(), app.mAppPermissionGroup.isUserFixed());
            indexs[index]++;
        }
        return indexs;
    }
    ...
    private void loadGroupInfo() {
        ...
        try {
            ...
            try {
                ...
                if ((permInfo.protectionLevel != PermissionInfo.PROTECTION_DANGEROUS) && !Utils.isModernPermissionGroupSelf(permInfo.group)) {
    ...
    public static class PermissionApp implements Comparable<PermissionApp> {
        ...
        public final AppPermissionGroup mAppPermissionGroup;
        ...
        public int compareTo(PermissionApp another) {
        	int index1 = PermissionsSelectPreference.setSelectedIndex(mAppPermissionGroup.areRuntimePermissionsGranted(), mAppPermissionGroup.isUserFixed());
        	int index2 = PermissionsSelectPreference.setSelectedIndex(another.mAppPermissionGroup.areRuntimePermissionsGranted(), another.mAppPermissionGroup.isUserFixed());
