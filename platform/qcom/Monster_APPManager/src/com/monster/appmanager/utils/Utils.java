...
public class Utils {
    ...
    public static final String[] MODERN_PERMISSION_GROUPS = {
            ...
            Manifest.permission_group.INSTALL_SHORTCUT,*/
    };
    
    public static final String[] MODERN_PERMISSION_GROUPS_SELF = {
        /*Manifest.permission_group.SYSTEM_ALERT_WINDOW,
        Manifest.permission_group.INSTALL_SHORTCUT,*/
};
    ...
    public static boolean isModernPermissionGroupSelf(String name) {
        for (String modernGroup : MODERN_PERMISSION_GROUPS_SELF) {
            if (modernGroup.equals(name)) {
                return true;
            }
        }
...
//        icon.setTint(context.getColor(typedValue.resourceId));
    ...
    public static boolean hasPermissions(Context context, String pkg) {
    	int totalCount = 0;
        try {
