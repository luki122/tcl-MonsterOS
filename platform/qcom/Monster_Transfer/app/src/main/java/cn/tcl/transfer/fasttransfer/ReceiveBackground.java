...
public class ReceiveBackground extends RelativeLayout {
    ...
    public ReceiveBackground(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
    }

    public ReceiveBackground(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public ReceiveBackground(Context context) {
        super(context);
        mContext = context;
    }
    public void init(final Context context) {
        ...
        ValueAnimator arrowAnim1 = ObjectAnimator.ofFloat(mArrow, "translationY", -getHeight(), -getHeight()/3);
        arrowAnim1.setDuration(750);
        ValueAnimator arrowAnim2 = ObjectAnimator.ofFloat(mArrow, "translationY", -getHeight()/3, -getHeight()/3+getHeight() / 20);
        arrowAnim2.setDuration(250);
        ValueAnimator arrowAnim3 = ObjectAnimator.ofFloat(mArrow, "translationY", -getHeight()/3+getHeight() / 20, -getHeight()/3);
        arrowAnim3.setDuration(250);
        ValueAnimator arrowAnim4 = ObjectAnimator.ofFloat(mArrow, "translationY", -getHeight()/3, -getHeight()/3+getHeight() / 20);
        arrowAnim2.setDuration(250);
        ValueAnimator arrowAnim5 = ObjectAnimator.ofFloat(mArrow, "translationY", -getHeight()/3+getHeight() / 20, -getHeight()/3);
        arrowAnim3.setDuration(250);
        ValueAnimator arrowAnim6 = ObjectAnimator.ofFloat(mArrow, "translationY", -getHeight()/3, -getHeight()/3+getHeight() / 20);
        arrowAnim2.setDuration(250);
        ValueAnimator arrowAnim7 = ObjectAnimator.ofFloat(mArrow, "translationY", -getHeight()/3+getHeight() / 20, getHeight());
        arrowAnim4.setDuration(1000);
        arrowAnimList.clear();
