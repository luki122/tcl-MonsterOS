 ...
 */
public class LiveMusicItemLayout_v3 extends  LinearLayout{
    private static String TAG=LiveMusicItemLayout_v3.class.getSimpleName();
    private LiveMusicClickListener mImgClickListener;
    private int mViewWidth;
    private int mViewHeight;
    private Context mContext;

    public LiveMusicItemLayout_v3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        mContext = context;
    }
    ...
    public void bindChild(LiveItem data, int position, Activity activity){
        ...
        if(context!=null){
            if (!TextUtils.isEmpty(data.imgUrl)) {
                ...
                ((ImageView) item.getChildAt(0)).setImageDrawable(getContext().getDrawable(data.imgId));
            }
        }
    ...
    private void addItem(LinearLayout parentLayout, int pos){
        ...
        int pad =  Util.dip2px(getContext(), 6);
        ...
        itemParams.topMargin = mViewWidth + Util.dip2px(getContext(), 8);
