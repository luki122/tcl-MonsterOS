...
public final class MoreDjFeaturesBar extends LinearLayout {
...
//			}
	...
	public MoreDjFeaturesBar(Context context) {
		super(context);
		init(context, null);
	}
	public MoreDjFeaturesBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}
	public MoreDjFeaturesBar(Context context, AttributeSet attrs,
