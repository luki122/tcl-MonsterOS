 ...
 * 获取歌曲详情
 */
public class DownloadSongDetailTask extends RequestSongTask{
    ...
    private Context mcontext;
        public DownloadSongDetailTask(Context context, IDownloadData listener
    ...
    protected void onPostExecute(BaseSong baseSong) {
        ...
        if (mListener != null) {
            ...
            if(baseSong.returnCode == 0){
                ...
                mListener.onLoadSuccess(DataRequest.Type.TYPE_LIVE_SONG_DETAIL, list,isBatchDownload,isDownloadMusic);
            }
            else{
