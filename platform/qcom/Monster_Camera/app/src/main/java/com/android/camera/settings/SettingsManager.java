...
public class SettingsManager {
    ...
    /**
     * Retrieve the set of possible values from the DefaultsStore as a String[].
     */
    public String[] getStringPossibleValues(String key) {
        return mDefaultsStore.getPossibleValues(key);
    }
    ...
    public void setChosenFilterIndex(String scope, String key, int chosenFilterIndex) {
        SharedPreferences preferences = getPreferencesFromScope(scope);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt(key, chosenFilterIndex);
        editor.apply();
    }

    public int getChosenFilterIndex(String scope, String key, int defaultValue) {
        SharedPreferences preferences = getPreferencesFromScope(scope);
        try {
