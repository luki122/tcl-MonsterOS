...
public class DebugCameraProxy extends CameraAgent.CameraProxy {
    ...
    public void takePicture(Handler handler, CameraShutterCallback shutter, CameraPictureCallback raw, CameraPictureCallback postview, CameraPictureCallback jpeg, int filterIndex) {
        //dummy
    }
    ...
    public void setDisplayOrientation(int degrees) {
        log("setPostGestureRotation:" + degrees);
    ...
    public void burstShot(Handler handler, CameraShutterCallback shutter,
        ...
        log("takePicture");
        mProxy.burstShot(handler, shutter, raw, postview, jpeg);// MODIFIED by sichao.hu, 2016-08-16,BUG-2743263
    }
    ...
    public void initExtCamera(Context context) {
        mProxy.initExtCamera(context);
    }

    @Override
    public void setGestureCallback(final Handler handler, final CameraGDCallBack cb) {
        mProxy.setGestureCallback(handler, cb);
    }

    @Override
    public void startGestureDetection() {
        mProxy.startGestureDetection();
    }

    @Override
    public void stopGestureDetection() {
        mProxy.stopGestureDetection();
    }

    @Override
    public void startRama(final Handler handler, int num) {
        mProxy.startRama(handler, num);
    }

    @Override
    public void stopRama(final Handler handler, int isMerge) {
        mProxy.stopRama(handler, isMerge);
    }

    @Override
    public void setRamaCallback(final Handler handler, final CameraAgent.CameraPanoramaCallback cb) {
        mProxy.setRamaCallback(handler, cb);
    }

    @Override
    public void setRamaMoveCallback(final Handler handler, final CameraAgent.CameraPanoramaMoveCallback cb) {
        mProxy.setRamaMoveCallback(handler, cb);
    }
