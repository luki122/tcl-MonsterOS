 ...
 */
public class MT_FaceBeautyOption extends LinearLayout implements View.OnClickListener {
    protected static final String TAG = "MT_FaceBeautyOption";
    protected SeekBar mSeekBar;
    protected View mCustomSeekBar;
    protected RotateImageView mFacebeautyMenu;

    private ValueAnimator mHideSeekbarAnimator;
    private ValueAnimator mShowSeekbarAnmator;
    private String mKey;
    private int mProgress;
    public MT_FaceBeautyOption(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
