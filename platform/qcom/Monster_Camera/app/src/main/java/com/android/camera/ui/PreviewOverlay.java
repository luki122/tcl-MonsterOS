...
public class PreviewOverlay extends View
    ...
    private final ArrayList<OnPreviewTouchedListener>
            mOnPreviewTouchedListeners =
    ...
    protected void onFinishInflate() {
        ...
        mZoomBar=this.findViewById(R.id.zoom_bar);
    }
    ...
    public void resetZoom() {
        mZoomProcessor.resetZoom();
    }

    public void setRatio(float zoom) {
        mZoomProcessor.setZoom(zoom);
    }
    ...
    public boolean onTouchEvent(MotionEvent m) {
        ...
        if(!(mZoomProcessor.isVisible()||(mZoomBar!=null&&mZoomBar.getVisibility()==VISIBLE))){
...
//        }
        for (OnPreviewTouchedListener listener : mOnPreviewTouchedListeners) {
    ...
    public void addOnPreviewTouchedListener(OnPreviewTouchedListener listener) {
        if (listener != null && !mOnPreviewTouchedListeners.contains(listener)) {
            mOnPreviewTouchedListeners.add(listener);
        }
    }
    public void removeOnPreviewTouchedListener(OnPreviewTouchedListener listener) {
        if (listener != null && mOnPreviewTouchedListeners.contains(listener)) {
            mOnPreviewTouchedListeners.remove(listener);
        }
    }
    @Override
    ...
    private class ZoomProcessor implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            if (now > mDelayZoomCallUntilMillis) {
                ...
                if(mHelpTipListener != null){
                    mHelpTipListener.notifyEventFinshed();
                    mHelpTipListener = null;
                }
        ...
        public boolean onScaleBegin(ScaleGestureDetector detector) {
            if (mScaleDetector != null && mScaleDetector.getPointerCount() < 2) {
                return false;
            }
