...
public class CameraCapabilities {
    ...
    public static final String KEY_AEC_SETTLED = "cur-exposure-settled";
     // For MTK platform  AIS-Key : value: off, ais
    ...
    protected final ArrayList<String> mSupportedVideoHighFrameRates = new ArrayList<String>();
    protected final ArrayList<Size> mSupportedHsrSizes = new ArrayList<Size>();
    ...
    protected boolean mManualSensorSupported;
    protected boolean mManualIsoSupported;
    protected boolean mManualExposureTimeSupported;
    ...
    protected List<String> mSupportedIsoValues = new ArrayList<String>();
    ...
    protected List<String> mSupportedAntibanding = new ArrayList<String>();
    /**
     * Focus modes.
     */
    ...
    public CameraCapabilities(CameraCapabilities src) {
        ...
        mSupportedVideoHighFrameRates.addAll(src.mSupportedVideoHighFrameRates);
        mSupportedHsrSizes.addAll(src.mSupportedHsrSizes);
        ...
        mZslSupported=src.mZslSupported;
        ...
        mMinISO = src.mMinISO;
        mMaxISO = src.mMaxISO;
        mMinExposureTime = src.mMinExposureTime;
        mMaxExposureTime = src.mMaxExposureTime;
        mMinFocusScale = src.mMinFocusScale;
        mMaxFocusScale = src.mMaxFocusScale;
        mSupportedIsoValues.addAll(src.mSupportedIsoValues);
    ...
    /**
     * @return The supported video frame rates that can be used by MediaRecorder.
     */
    public final List<String> getSupportedVideoHighFrameRates(){
        return new ArrayList<String>(mSupportedVideoHighFrameRates);
    }
    /**
     * @return The supported Hsr sizes
     */
    public final List<Size> getSupportedHsrSizes(){
        return new ArrayList<Size>(mSupportedHsrSizes);
    }
    ...
    public boolean supports(final CameraSettings settings) {
        if (zoomCheck(settings) && exposureCheck(settings) && focusCheck(settings) &&
                flashCheck(settings) && photoSizeCheck(settings) && videoSizeCheck(settings) && previewSizeCheck(settings) &&
    ...
    private boolean exposureCheck(final CameraSettings settings) {
        ...
        if (index > getMaxExposureCompensation() || index < getMinExposureCompensation()) {
            Log.i(TAG, "Exposure compensation index is not supported. Min = " + //MODIFIED by yuanxing.tan, 2016-04-11,BUG-1933361
    ...
    private boolean flashCheck(final CameraSettings settings) {
        ...
        if (!supports(flashMode)) {
            Log.i(TAG, //MODIFIED by yuanxing.tan, 2016-04-11,BUG-1933361
    ...
    private boolean photoSizeCheck(final CameraSettings settings) {
        ...
        Log.i(TAG, "Unsupported photo size:" + photoSize); //MODIFIED by yuanxing.tan, 2016-04-11,BUG-1933361
        return false;
    }

    private boolean videoSizeCheck(final CameraSettings settings) {
        Size videoSize = settings.getCurrentVideoSize();
        if (mSupportedVideoSizes.contains(videoSize)) {
            return true;
        }
        Log.i(TAG, "Unsupported video size:" + videoSize); //MODIFIED by yuanxing.tan, 2016-04-11,BUG-1933361
        return false;
    }
    ...
    private boolean previewSizeCheck(final CameraSettings settings) {
        ...
        Log.i(TAG, "Unsupported preview size:" + previewSize); //MODIFIED by yuanxing.tan, 2016-04-11,BUG-1933361
        return false;
    }
    ...
    private boolean videoStabilizationCheck(final CameraSettings settings) {
        ...
        Log.i(TAG, "Video stabilization is not supported"); //MODIFIED by yuanxing.tan, 2016-04-11,BUG-1933361
        return false;
    }
    ...
    public final int getMinFocusScale() {
        return mMinFocusScale;
    }

    public final int getMaxFocusScale() {
        return mMaxFocusScale;
    }
