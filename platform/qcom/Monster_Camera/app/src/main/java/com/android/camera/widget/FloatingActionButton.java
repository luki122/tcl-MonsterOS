...
public class FloatingActionButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        ...
        mCircleSize = getDimension(mSize == SIZE_NORMAL ? R.dimen.fab_size_normal
    ...
    int getColor(@ColorRes
    int id) {
        return getResources().getColor(id);
    }

    float getDimension(@DimenRes
    int id) {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        // R.styleable.FloatActionButton, 0, 0);
        //
        // if (attr != null) {
        // try {
        // mColorNormal = attr.getColor(R.styleable.FloatActionButton_colorNormal,
        // getColor(android.R.color.holo_blue_dark));
        // mColorPressed = attr.getColor(R.styleable.FloatActionButton_colorPressed,
    ...
    void updateBackground() {
        ...
        final RectF circleRect = new RectF(circleLeft, circleTop, circleLeft, circleTop);

        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[] {
                        // getResources().getDrawable(R.drawable.mmode_back_pressed),
                        //
                        getIconDrawable(),
        ...
        layerDrawable.setLayerInset(0, 5, 10, 5, 0); // control floatbutton's size
    ...
    private Drawable createStrokesDrawable(RectF circleRect) {
        ...
        // inner bottom
        paint.setShader(new LinearGradient(innerStrokeRect.centerX(), innerStrokeRect.top,
                innerStrokeRect.centerX(), innerStrokeRect.bottom,
                new int[] {
                        Color.TRANSPARENT, HALF_TRANSPARENT_BLACK, Color.BLACK
                },
                new float[] {
                        0f, 0.8f, 1f
                },
        ...
        paint.setShader(new LinearGradient(innerStrokeRect.centerX(), innerStrokeRect.top,
                innerStrokeRect.centerX(), innerStrokeRect.bottom,
                new int[] {
                        Color.WHITE, HALF_TRANSPARENT_WHITE, Color.TRANSPARENT
                },
                new float[] {
                        0f, 0.2f, 1f
                },
