...
public interface ModuleController extends ShutterButton.OnShutterButtonListener {
    ...
    /**
     * Do something(now stopPreview only) when onModeSelecting before pause called
    ...
    /**
     * Called in onCameraOpened after CameraAppUI.onChangeCamera() to notify
     * that the buttons are initialized already.
     */
