...
public class TextureViewHelper implements TextureView.SurfaceTextureListener,
    ...
    public TextureViewHelper(TextureView preview, ModeTransitionView textureViewCover,CaptureLayoutHelper helper,
                             CameraProvider cameraProvider,SurfaceTexture surface) {
        mSurface=surface;
        mPreview = preview;
        mModeCover=textureViewCover;
    ...
    private void updatePreviewArea(Matrix matrix) {
        ...
        if(mPreviewArea!=null) {
            mModeCover.mapPreviewRect(mPreviewArea);
        }
    }
    ...
    public void setSurfaceTextureListener(TextureView.SurfaceTextureListener listener) {
        ...
        if(mSurface!=null){
            onSurfaceTextureAvailable(mSurface,0,0);
            mPreview.setSurfaceTexture(mSurface);
        }
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        Log.w(TAG,String.format("surface size is %dx%d",width,height));
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
         /* MODIFIED-BEGIN by sichao.hu, 2016-08-16,BUG-2743263*/
        mSurfaceSize=new Point(width,height);
        Log.w(TAG,String.format("surface size changed to %dx%d",width,height));
        /* MODIFIED-END by sichao.hu,BUG-2743263*/
        if (mSurfaceTextureListener != null) {
