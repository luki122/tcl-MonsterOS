...
public interface VideoController extends OnShutterButtonListener {
    ...
    public static final int IDLE=PREVIEW_STOPPED+1;
    public static final int RECORDING_PENDING_START=IDLE+1;
    public static final int RECORDING=RECORDING_PENDING_START+1;
    public static final int RECORDING_PENDING_STOP=RECORDING+1;
