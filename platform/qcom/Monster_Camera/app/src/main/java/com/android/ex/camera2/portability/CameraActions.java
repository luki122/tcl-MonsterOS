...
class CameraActions {
    ...
    public static final int SET_GESTURE_CALLBACK = 801;
    public static final int START_GESTURE_DETECTION = 802;
    public static final int STOP_GESTURE_DETECTION = 803;
    public static final int START_RAMA = 804;
    public static final int STOP_RAMA = 805;
    public static final int SET_RAMA_CALLBACK = 806;
    public static final int SET_RAMA_MOVE_CALLBACK = 807;
    /*MODIFIED-END by peixin,BUG-1845449*/

    public static final int WAIT_DONE_DUMMY=901; // MODIFIED by sichao.hu, 2016-08-16,BUG-2743263

    public static final int SET_META_DATA_CALLBACK = 1001; // MODIFIED by xuyang.liu, 2016-10-13,BUG-3110198
    ...
    public static String stringify(int action) {
        switch (action) {
            ...
            case WAIT_DONE_DUMMY:
                return "WAIT_DONE_DUMMY";
