...
public abstract class CameraModule implements ModuleController {
    ...
    /**
     * Handle the SD Card event in each module if needed.
     */
    ...
    protected void onStoragePathChanged() {} // MODIFIED by nie.lei, 2016-05-26,BUG-2208223
    public void preparePause() {}

    /* MODIFIED-BEGIN by xuan.zhou, 2016-06-06,BUG-2251935*/
    public void onSpecificUIApplied() {
        // Do nothing here. Should be overridden in PhotoModule and VideoModule.
    }
    ...
    public void onZoomBarVisibilityChanged(boolean visible) {} // MODIFIED by jianying.zhang, 2016-10-26,BUG-3212745
}
