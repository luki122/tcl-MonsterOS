...
public class KeyguardPasswordView extends KeyguardAbsKeyInputView
    ...
    private View editDiver; //TCL Monster: kth add for pwd layout 20161101
    ...
    protected void resetState() {
        mSecurityMessageDisplay.setMessage(getMessageWithCount(R.string.kg_password_instructions), true);///TCL Monster: kth mod for show default msg as important 20161102
...
//                        mImm.showSoftInput(mPasswordEntry, InputMethodManager.SHOW_IMPLICIT);
                    mImm.toggleSoftInput(0, InputMethodManager.HIDE_NOT_ALWAYS);///TCL Monster: kth mod for [BUG 2823031] 20161118
...
//                            mImm.showSoftInput(mPasswordEntry, InputMethodManager.SHOW_IMPLICIT);
    ...
    protected void onFinishInflate() {
        ...
        editDiver = findViewById(R.id.keyguard_pwd_diver);//TCL Monster: kth add for pwd layout 20161101
    ...
    public void notifyWallpaperChanged(int RGB, float alpha) {
        mPasswordEntry.setTextColor(RGB);
        emcBtn.setTextColor(RGB);
        mSecurityMessageDisplay.setMsgNomalColor(RGB, alpha);
        //TCL Monster: kth add for pwd layout 20161101 start @{
        editDiver.setBackgroundColor(RGB);
        editDiver.setAlpha(.1f);
        //end @}
    }
