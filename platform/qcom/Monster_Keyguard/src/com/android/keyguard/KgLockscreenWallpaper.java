 ...
 */
public class KgLockscreenWallpaper extends IWallpaperManagerCallback.Stub implements Runnable {

    private static final String TAG = "KgLockscreenWallpaper";
    ...
    public KgLockscreenWallpaper(Context ctx, Handler h) {
        mH = h;
