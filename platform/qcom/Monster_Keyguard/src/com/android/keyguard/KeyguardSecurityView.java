...
public interface KeyguardSecurityView {
    ...
    /**
     * TCL Monster: kth add for keyguard inversion 20161022
     *
     * @param RGB   the text and icon color according to lock screen wallpaper {@link MstMainColorHelper.calcTextColor()}
     * @param alpha the text and icon alpha, colors hold different alpha
     */
    void notifyWallpaperChanged(int RGB, float alpha);

    /**
     * TCL Monster: kth add bouncer disappear when cancel down 20161112
     */
    void startCancelDownAnimation();
