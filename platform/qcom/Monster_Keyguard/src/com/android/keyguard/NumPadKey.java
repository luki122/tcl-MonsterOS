...
public class NumPadKey extends ViewGroup {
    ...
    /**Mst: tangjun add for KeyguardDigitView begin 2016.6.27*/
    private TextView mDigitTextView;
    /**Mst: tangjun add for KeyguardDigitView end 2016.6.27*/
    ...
    private View.OnClickListener mListener = new View.OnClickListener() {
        ...
        public void onClick(View thisView) {
            ...
            /**Mst: tangjun add for KeyguardDigitView begin 2016.6.27*/
            if (mDigitTextView != null && mDigitTextView.isEnabled() && mDigitTextView.getText().length() < 8) {
            	mDigitTextView.append(String.valueOf(mDigit));
            }
            /**Mst: tangjun add for KeyguardDigitView end 2016.6.27*/
            userActivity();
            doHapticKeyClick();
    ...
    protected NumPadKey(Context context, AttributeSet attrs, int defStyle, int contentResource) {
        ...
        ///kth add for change keyguard bouncer font 20160822 start @{
        //Typeface tf = Typeface.createFromAsset(context.getAssets(), "fonts/Helvetica_Neue_CE_35_Thin_keyboard.ttf");
        //mDigitText.setTypeface(tf);///end @}
        if (mDigit >= 0) {
            if (sKlondike == null) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        /// TCL Monster: kth add for digitview tap ripple 20161101 start
        setBackground(RippleUtils.getRippleDrawable(getContext(), NumPadKey.this));
        /// TCL Monster: kth add for digitview tap ripple 20161101 end
    }
    ...
    public void setTextColor(int RGB) {
        mDigitText.setTextColor(RGB);
        mKlondikeText.setTextColor(RGB);
    }
    /// end @}
}
