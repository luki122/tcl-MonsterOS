...
public class PasswordTextView extends View {
    ...
    private int mPaintColor = 0xffffffff;///TCL Monster: kth mod for sim pin puk inversion 20161117
    ...
    public PasswordTextView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mDrawPaint.setColor(mPaintColor);///TCL Monster: kth mod for sim pin puk inversion 20161117
