...
public class KeyguardSimPinView extends KeyguardPinBasedInputView {
    ...
    protected void verifyPasswordAndUnlock() {
        ...
        if (entry.length() < 4 || entry.length() > 8) {///TCL Monster: kth mod for [BUG 2822001] 20161110
    ...
    public void notifyWallpaperChanged(int RGB, float alpha) {
        super.notifyWallpaperChanged(RGB, alpha);///TCL Monster: kth mod for sim pin puk inversion 20161117
    }
