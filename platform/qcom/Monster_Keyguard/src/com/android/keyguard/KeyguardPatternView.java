...
public class KeyguardPatternView extends LinearLayout implements KeyguardSecurityView,
    ...
    private EmergencyButton emcBtn;
    ...
    protected void onFinishInflate() {
        ...
        emcBtn = (EmergencyButton) findViewById(R.id.emergency_call_button);
        if (emcBtn != null) {
            emcBtn.setCallback(this);
        }
        /// kth add for digitview layout 20160902 start @{
        cancel = (Button) findViewById(R.id.bouncer_control_cancel);
...
//                mCallback.reset(); kth mod 20161112
    ...
    private void displayDefaultSecurityMessage() {
        mSecurityMessageDisplay.setMessage(getMessageWithCount(R.string.kg_pattern_instructions), true);///TCL Monster: kth mod for show default msg as important 20161102
    }
    ...
    private class UnlockPatternListener implements LockPatternView.OnPatternListener {
        ...
        private void onPatternChecked(int userId, boolean matched, int timeoutMs,
            ...
            if (matched) {
                ...
                if (timeoutMs == 0) {
                    ///kth add for change keyguard bouncer font 20160811 start @{
                    if (DEBUG) Log.d(TAG, "KeyguardPatternView onPatternChecked isvalidPattern=" + isValidPattern);
                    if (!isValidPattern) {
                        mSecurityMessageDisplay
                                .setMessage(R.string.kg_failed_pattern_too_short, true);///end@}
                    } else {
                        mSecurityMessageDisplay.
    ...
    public void startAppearAnimation() {
        ...
        animSet.start();
        enableClipping(true);
/* TCL Monster: kth remove it temp, LockPatternView animate would cause LockPatternView circle error 20161112
        setAlpha(1f);
        ...
        /// TCL Monster: kth mod bouncer anim 20161114 end
    }
    ...
    public boolean startDisappearAnimation(final Runnable finishRunnable) {
        ...
        enableClipping(false);
        setTranslationY(0);
        ///TCL Monster: kth mod for [BUG 3502560] start
...
//                    200,
//                    - mDisappearAnimationUtils.getStartTranslation() * 2,
//                    false /* appearing */,
//                    mDisappearAnimationUtils.getInterpolator(),
//                    null /* finishRunnable */);
//        }
//        /// TCL Monster: kth add 20161112 start
//        mDisappearAnimationUtils.createAnimation(emcBtn, 0,
//                200,
//                - mDisappearAnimationUtils.getStartTranslation(),
//                false /* appearing */,
//                mDisappearAnimationUtils.getInterpolator(),
//                null /* finishRunnable */);
//        mDisappearAnimationUtils.createAnimation(cancel, 0,
//                200,
//                - mDisappearAnimationUtils.getStartTranslation(),
//                false /* appearing */,
//                mDisappearAnimationUtils.getInterpolator(),
//                null /* finishRunnable */);
//        /// TCL Monster: kth add 20161112 end
        ...
        animSet.playTogether(animatorTrans, animatorAlpha);
        animSet.start();
        ///TCL Monster: kth mod for [BUG 3502560] end
        return true;
    }
    ...
    public void notifyWallpaperChanged(int RGB, float alpha) {
        ...
        cancel.setTextColor(RGB);
        mSecurityMessageDisplay.setMsgNomalColor(RGB, alpha);
        mLockPatternView.setRegularColor(RGB);
        setAlpha(alpha);
    }
    /// end @}
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        cancel.setBackground(RippleUtils.getRippleDrawable(getContext(), cancel));
    }
