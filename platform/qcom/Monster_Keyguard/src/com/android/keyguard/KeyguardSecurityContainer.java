...
import mst.app.dialog.AlertDialog; /// TCL Monster: kth mod for mst dialog style 20161022
...
public class KeyguardSecurityContainer extends FrameLayout implements KeyguardSecurityView {
    ...
    public void notifyWallpaperChanged(int RGB, float alpha) {
        KeyguardSecurityView v = getSecurityView(mCurrentSecuritySelection);
        if (v != null) {
            v.notifyWallpaperChanged(RGB, alpha);
        }
    }
    ...
    private int getSecurityViewIdForMode(SecurityMode securityMode) {
        switch (securityMode) {
            ...
            /**Mst: tangjun mod for Digit Keyguard begin 2016.6.27*/
            //case PIN: return R.id.keyguard_pin_view;
            case PIN: return R.id.keyguard_digit_view;
            /**Mst: tangjun mod for Digit Keyguard end 2016.6.27*/
    ...
    protected int getLayoutIdFor(SecurityMode securityMode) {
        switch (securityMode) {
            ...
            case PIN: return R.layout.keyguard_digit_view;
            /**Mst: tangjun mod for Digit Keyguard end 2016.6.27*/
