...
public class AppDetailActivity extends BaseActivity {
    ...
    private ProgressBar mProgressBarGrey;
    ...
    private int iconViewMarginTop = 0;          // 图标初始时顶部间距
    ...
    private int greyViewAndRecommendTranslationY = 0;   // 底部分割线和应用推荐需要上移的位置
    ...
    protected void onStart() {
        ...
        if (empty_height == 0) {
            ...
            iconViewMarginTop = getResources().getDimensionPixelOffset(R.dimen.detail_icon_margin_top);
            ...
            greyViewAndRecommendTranslationY = getResources().getDimensionPixelOffset(R.dimen.detail_page_grew_translation_y);
        }
    ...
    protected void onResume() {
        ...
        if (updateListener != null) {
            ...
            current_status = AppDownloader.STATUS_DEFAULT;
    ...
    public void initViews() {
        ...
        scrollView.setOnScrollChangeListener(new View.OnScrollChangeListener() {
            ...
            public void onScrollChange(View view, int x, int y, int oldx, int oldy) {
                ...
                setGreyLineAndRecommendProgress(progress);
            }
        });
        ...
        mProgressBarGrey = (ProgressBar) findViewById(R.id.download_progress_rate_grey);
        ...
        mDownloadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int tagId = (int) download_text.getTag();
                String dis_text = download_text.getText().toString();
//                if (dis_text.equals(getResources().getString(
//                        R.string.item_open))) {
...
//                }
                ...
                if (tagId == R.string.app_download || tagId == R.string.download_process_update) {
                ...
                } else if (tagId == R.string.app_install) {
                    mDownloadBtnLayout.setVisibility(view.GONE);
                ...
                } else if (tagId == R.string.item_open) {
                    ApkUtil.openApp(AppDetailActivity.this,
                            downloadData.getPackageName());
                }
            }
    ...
    public void initData() {
        ...
        RequestHelper.getAppDetail(this, packageName, new DataResponse<AppDetailInfo>() {
            ...
            public void onResponse(AppDetailInfo value) {
                ...
                List<AppDetailInfo.AppImageInfo> infoes = value.getAppImageList();
                if (infoes != null && infoes.size() > 0) {
                    String[] images = new String[infoes.size()];
                    for (int i = 0; i < infoes.size(); i++) {
                        images[i] = infoes.get(i).getNormalPic();
                    }
                    setupAppDetailDisplay(images);
                } else {
                    findViewById(R.id.hsv_pic_space).setVisibility(View.VISIBLE);
                ...
                tv_itd_version.setText(TextUtils.isEmpty(value.getVersionName())
                        ? getString(R.string.app_detail_no_info) : value.getVersionName());
                tv_itd_author.setText(TextUtils.isEmpty(value.getAuthor())
                        ? getString(R.string.app_detail_no_info) : value.getAuthor());
                tv_itd_update_time.setText(TextUtils.isEmpty(value.getUpdateTime())
                        ? getString(R.string.app_detail_no_info) : value.getUpdateTime());
                tv_itd_type.setText(TextUtils.isEmpty(value.getAppType())
                        ? getString(R.string.app_detail_no_info) : value.getAppType());

                InstalledAppInfo info = InstallAppManager
                        .getInstalledAppInfo(AppDetailActivity.this, value.getPackageName());

                if (info != null && info.getVersionCode() < value.getVersionCode()
                        && !TextUtils.isEmpty(value.getChangelog())) {
                    tv_introduce.setText(getString(R.string.app_update_info));

                    String changeLog = value.getChangelog();
                    changeLog = changeLog.replace("\r", "").replace("\n\r", "");
                    tv_description.setText(Html.fromHtml(changeLog));

                } else {
                    String description = value.getAppDescription();
                    if (TextUtils.isEmpty(description)) {
                        description = getString(R.string.app_detail_no_description);
                    }
...
//				mListView.setVisibility(View.VISIBLE);
    ...
    private void initImageLoad() {
        ...
        opIconsImage = SystemUtil.buildAppListDisplayImageOptions(this);
    }
...
//                            this, 17)));
    ...
    private void exitActivity() {
        if (!closing) {
            ...
            View anim_bg = findViewById(R.id.anim_bg);
            Animation m3 = new AlphaAnimation(1f, 0f);
            m3.setDuration(200);
            m3.setFillAfter(true);
            m3.setAnimationListener(new Animation.AnimationListener() {
                @Override
                public void onAnimationStart(Animation animation) {
                    closing = true;
                }
    ...
    private void setNameProgress(int progress) {
        ...
        int translationX = (int) (value * (progress * 1.0f / 100));
        int translationY = (int) ((iconViewMarginTop - iconViewAfterPaddingTop) * (progress * 1.0f / 100));
    ...
    private void setGreyLineAndRecommendProgress(int progress) {
        int value = greyViewAndRecommendTranslationY;

        int translationY = (int) (value * (progress * 1.0f / 100));
        view_line.setTranslationY(-translationY);
        rl_recommend.setTranslationY(-translationY);
    }
    ...
    private AppDetailAnimInfo getAppDetailAnimInfo(View view) {
        ...
        Point point = new Point(location[0], location[1] - (view.getHeight() / 2 - dip2px(this, 32.5f)));
        ...
        animInfo.setLayoutInitHeight(view.getHeight())
                ...
                .setIconMarginLeft(view.getWidth() / 2 - dip2px(this, 32.5f))
                .setIconMarginTop(view.getHeight() / 2 - dip2px(this, 32.5f))
                .setInitIconSize(dip2px(this, 65))
        ...
        if (installedAppInfo == null) {
            ...
            if (downloader != null) {
                ...
                if (status == AppDownloader.STATUS_DOWNLOADING) {
                    ...
                    mProgressBarGrey.setProgress(progress);
                    showGreyProgressBar(false);
                    ...
                    dis_download_text
                            .setText(getString(R.string.download_process_fail));
                    mProgressBar.setProgress(progress);
                    mProgressBarGrey.setProgress(progress);
                    showGreyProgressBar(true);
                ...
                if (null == tempData) {
                    ...
                    download_text.setTag(R.string.app_download);
                } else {
                    ...
                    if (((status == AppDownloader.STATUS_INSTALLFAILED) || (status == AppDownloader.STATUS_INSTALLED))
                        ...
                        if (status == AppDownloader.STATUS_INSTALLFAILED) {
                            ...
                            download_text.setTag(R.string.app_install);
                        } else {
                            mDownloadBtnLayout.setVisibility(View.VISIBLE);
                            mDownloadProLayout.setVisibility(View.GONE);
                            download_text.setText(R.string.app_install);
            ...
            if (downloadData.getVersionCode() > installedAppInfo
                ...
                if (downloader != null) {
                    ...
                    if (tempData == null) {
                        ...
                        download_text.setTag(R.string.download_process_update);
                    } else {
                        int status = tempData.getStatus();
                ...
                download_text.setTag(R.string.item_open);
    ...
    public void setAnimal1() {
        ...
        mProgressBarGrey.setProgress(0);
        ...
        CustomAnimation animation = new CustomAnimation(
                new CustomAnimCallBack() {
                    ...
                    public void callBack(float interpolatedTime,
                        ...
                        download_text.setTextSize(18 * (1 - 0.4f * (interpolatedTime)));
    ...
    private void showGreyProgressBar(boolean show) {
        if (show) {
            mProgressBar.setVisibility(View.GONE);
            mProgressBarGrey.setVisibility(View.VISIBLE);
        } else {
            mProgressBar.setVisibility(View.VISIBLE);
            mProgressBarGrey.setVisibility(View.GONE);
        }
    }
