...
public class AppDetailInfo {
	...
	public String toString() {
		return "AppDetailInfo [appIcon=" + appIcon + ", bigAppIcon="
				+ bigAppIcon + ", appId=" + appId + ", packageName="
				+ packageName + ", appName=" + appName + ", applevel="
				+ applevel + ", downloads=" + downloads + ", downloadCountStr="
				+ downloadCountStr + ", downloadUrl=" + downloadUrl
				+ ", appSize=" + appSize + ", versionName=" + versionName
				+ ", versionCode=" + versionCode + ", md5=" + md5
				+ ", updateTime=" + updateTime + ", author=" + author
				+ ", appDescription=" + appDescription + ", appType=" + appType
