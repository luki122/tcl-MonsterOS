...
//	private Notification notification;
	...
	private void sendDownloadingNotify() {
		...
		mNotifyBuilder.setContentTitle(appCount + getString(R.string.notification_status_dis_download));
		...
		mNotifyBuilder.setContentIntent(PendingIntent.getActivity(context, notiId, intent,
