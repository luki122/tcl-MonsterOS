 ...
 * City manager
 */
public class OtherWeatherManagerActivity extends OtherBaseActivity {
...
//        initWindow();
    ...
    private void bindUpdateService() {
        Intent bindServiceIntent = new Intent(OtherWeatherManagerActivity.this, UpdateService.class);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        try {
            ...
            boolean isDealed = super.dispatchTouchEvent(ev);
