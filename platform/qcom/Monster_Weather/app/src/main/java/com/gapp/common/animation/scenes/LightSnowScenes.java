 ...
 * $desc
 */
public class LightSnowScenes extends AbsSnowScenes {

    private final static int BIG_SIZE = 5;
    private final static int NORMAL_SIZE = 10;
    private final static int SMALL_SIZE = 15;

    public LightSnowScenes(IPainterView painterView, BitmapManager manager) {
