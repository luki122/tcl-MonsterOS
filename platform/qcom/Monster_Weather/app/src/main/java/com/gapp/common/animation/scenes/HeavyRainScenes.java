 ...
 * Created on 16-9-9.
 */
public class HeavyRainScenes extends AbsRainScenes {
    private final static int LEVE_1_SIZE = 14;
    private final static int LEVE_2_SIZE = 70;
    private final static int LEVE_3_SIZE = 50;


    public HeavyRainScenes(IPainterView painterView, BitmapManager manager) {
