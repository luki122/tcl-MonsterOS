 ...
 * Created on 16-9-9.
 */
public class LightRainScenes extends AbsRainScenes {
    private final static int LEVE_1_SIZE = 5;
    private final static int LEVE_2_SIZE = 20;
    private final static int LEVE_3_SIZE = 25;

    public LightRainScenes(IPainterView painterView, BitmapManager manager) {
