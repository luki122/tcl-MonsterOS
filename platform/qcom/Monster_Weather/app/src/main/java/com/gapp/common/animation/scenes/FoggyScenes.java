 ...
 * $desc
 */
public class FoggyScenes extends AbsScenes {

    private int size = 100;

    public FoggyScenes(IPainterView painterView, BitmapManager manager) {
    ...
    public void init() {
        ...
        if (null != parent) {
            ...
            drawable.setLinearColors(0, 0.7f, 0xFFA8B2BB, 0x00A8B2BB);
            ((View) mPainterView).setBackground(drawable);
        }

        ViewLRSVGSprite foggy1 = new ViewLRSVGSprite(context, R.drawable.svg_foggy2_drawable, false);
        ...
        ViewLRSVGSprite foggy2 = new ViewLRSVGSprite(context, R.drawable.svg_foggy1_drawable);
