 ...
 * $desc
 */
public class ThunderShowerWithHailScenes extends AbsRainScenes{
    private final static int RAIN_LIGHT_COUNT = 48;
    private final static int RAIN_MODERATE_COUNT = 30;
    private final static int RAIN_BIG_COUNT = 6;

    private final static int SNOW_LIGHT_COUNT = 13;
    private final static int SNOW_MODERATE_COUNT = 8;
    private final static int SNOW_BIG_COUNT = 3;
    ...
    public ThunderShowerWithHailScenes(IPainterView painterView, BitmapManager manager) {
