...
import android.telephony.TelephonyManager; // MODIFIED by qili.zhang, 2016-10-08,BUG-2833095
...
//[SOLUTION]-Add-BEGIN by TCTNB.(JiangLong Pan), 08/05/2016, SOLUTION-2473988
//Comcel require specific Clear Codes And Busy tone isn't palyed
            case android.telephony.DisconnectCause.TCT_USER_BUSY:
...
//[SOLUTION]-Add-BEGIN by TCTNB.(JiangLong Pan), 08/05/2016, SOLUTION-2473988
//Comcel require specific Clear Codes And Busy tone isn't palyed
            case android.telephony.DisconnectCause.TCT_UNOBTAINABLE_NUMBER:
            case android.telephony.DisconnectCause.TCT_ERROR_NETWORK_FAIL:
            case android.telephony.DisconnectCause.TCT_STR_ERROR_NETWORK_BUSY:
            case android.telephony.DisconnectCause.TCT_ERROR_NUMBER:
            case android.telephony.DisconnectCause.TCT_NO_USER_RESPONDING:
            case android.telephony.DisconnectCause.TCT_NO_ANSWER_FROM_USER:
            case android.telephony.DisconnectCause.TCT_GSM_UNSPECIFIED:
//[SOLUTION]-Add-END by TCTNB.(JiangLong Pan)
...
//[SOLUTION]-Add-BEGIN by TCTNB.(JiangLong Pan), 08/05/2016, SOLUTION-2473988
//Comcel require specific Clear Codes And Busy tone isn't palyed
                if (context.getResources().getBoolean(com.android.internal.R.bool.feature_tctfw_comcelClearCodes_on)) {
                    resourceId = R.string.callFailed_userBusy_Comcel;
                } else {
...
//[SOLUTION]-Add-END by TCTNB.(JiangLong Pan)
            ...
            case android.telephony.DisconnectCause.ICC_ERROR:
               /* MODIFIED-BEGIN by qili.zhang, 2016-10-08,Porting-2383586*/
                final boolean hasSim = TelephonyManager.getDefault().hasIccCard();
                if (!hasSim) {
                    resourceId = R.string.callFailed_network_not_support;
                } else {
                    resourceId = R.string.callFailed_simError;
                }
                /* MODIFIED-END by qili.zhang*/
                break;
...
//Comcel require specific Clear Codes And Busy tone isn't palyed
            ...
            case android.telephony.DisconnectCause.TCT_STR_ERROR_NETWORK_BUSY:
                if (context.getResources().getBoolean(com.android.internal.R.bool.feature_tctfw_comcelClearCodes_on)) {
                    resourceId = R.string.callFailed_str_error_network_busy;
                }
                break;

            case android.telephony.DisconnectCause.TCT_USER_BUSY:
                if (context.getResources().getBoolean(com.android.internal.R.bool.feature_tctfw_comcelClearCodes_on)) {
                    resourceId = R.string.callFailed_str_error_user_busy;
                }
                break;

            case android.telephony.DisconnectCause.TCT_UNOBTAINABLE_NUMBER:
                if (context.getResources().getBoolean(com.android.internal.R.bool.feature_tctfw_comcelClearCodes_on)) {
                    resourceId = R.string.callFailed_str_error_unobtainable_number;
                }
                break;
            case android.telephony.DisconnectCause.TCT_NO_USER_RESPONDING:
                if (context.getResources().getBoolean(com.android.internal.R.bool.feature_tctfw_comcelClearCodes_on)) {
                    resourceId = R.string.callFailed_absent_subscriber;
                }
                break;
            case android.telephony.DisconnectCause.TCT_NO_ANSWER_FROM_USER:
                if (context.getResources().getBoolean(com.android.internal.R.bool.feature_tctfw_comcelClearCodes_on)) {
                    resourceId = R.string.callFailed_b_anwer_time_out;
                }
                break;
            case android.telephony.DisconnectCause.TCT_GSM_UNSPECIFIED:
                if (context.getResources().getBoolean(com.android.internal.R.bool.feature_tctfw_comcelClearCodes_on)) {
                ...
                break;
//[SOLUTION]-Add-END by TCTNB.(JiangLong Pan)
            //[FEATURE]-Add-BEGIN by TCTNB.(Chuanjun Chen), 09/20/2016, FEATURE-2723557 And TASk-2847250
            case android.telephony.DisconnectCause.ERROR_UNSPECIFIED:
                if(context.getResources().getBoolean(R.bool.def_algb_show_out_of_service_on)){
                    resourceId = R.string.callFailed_emergency_out_of_service;
                }
                break;
...
//[SOLUTION]-Add-END by TCTNB.(JiangLong Pan)
            ...
            case android.telephony.DisconnectCause.ERROR_UNSPECIFIED:
                if(context.getResources().getBoolean(R.bool.def_algb_show_out_of_service_on)) {
                    resourceId = R.string.callFailed_emergency_out_of_service_description;
                }
                break;
                //[FEATURE]-Add-END by TCTNB.(Chuanjun Chen)
