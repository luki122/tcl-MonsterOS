...
/* MODIFIED-BEGIN by siyan.chen-nb, 2016-10-13,BUG-3067773*/
import android.view.View;
import android.view.ViewGroup;
/* MODIFIED-END by siyan.chen-nb,BUG-3067773*/
...
import android.widget.Toast; //[SOLUTION]-Add-BEGIN by TCTNB.(Chuanjun Chen), 08/26/2016, SOLUTION- 2498670 And TASk-2781388
...
// MODIFIED-BEGIN by yanjun.kang, 2016-11-10, BUG-3412136
//        if (isInMultiWindowMode()) {
//            finish();
//            return;
//        }
// MODIFIED-END by yanjun.kang, BUG-3412136
    }
    ...
    protected void onResume() {
        ...
        if (mSubMenuVoicemailSettings != null) {
            ...
            //[SOLUTION]-Add-BEGIN by TCTNB.(Caixia Chen), 08/19/2016, SOLUTION-2472456
            boolean editable = getResources().getBoolean(R.bool.feature_phone_voicemailNumberEditable_on);
            Log.i("Defect:3231990","editable="+editable);
            if (!editable){
                mSubMenuVoicemailSettings.setEnabled(false);
            }
            //[SOLUTION]-Add-END by TCTNB.(Caixia Chen)

//[FEATURE]-Add-BEGIN by TCTNB.(JiangLong Pan), 09/02/2016, task-2828198
//Ability to configure Voice mail number and name at CLID
            String voicemailName = getResources().getString(R.string.def_phone_voicemail_name);
            if (!TextUtils.isEmpty(voicemailName)) {
                mSubMenuVoicemailSettings.setDialogTitle(voicemailName);
                mSubMenuVoicemailSettings.setTitle(voicemailName);
            }
//[FEATURE]-Add-END by TCTNB.(JiangLong Pan)
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mSubMenuVoicemailSettings) {
            ...
            if (dialog != null) {
                ...
                ViewGroup actionBarView = getActionBar(dialog.getWindow().getDecorView());
                if (actionBarView != null) {
                    actionBarView.getChildAt(0).setOnClickListener(v -> dialog.dismiss());
                }
                // MODIFIED-END by siyan.chen-nb, BUG-3067773
            }
    ...
    // MODIFIED-BEGIN by siyan.chen-nb, 2016-10-13, BUG-3067773
    public ViewGroup getActionBar(View v) {
        if (v == null || !(v instanceof ViewGroup)) return null;
        ...
        try {
            for (int i = 0; i < viewGroup.getChildCount(); i++) {
                ...
                if (child instanceof ViewGroup) {
                    ViewGroup actionbarGroup = (ViewGroup) child.findViewById(id);
            ...
            Log.e(LOG_TAG, "getActionBar Exception", e);
        }
        return null;
    }
    // MODIFIED-END by siyan.chen-nb, BUG-3067773
        ...
        if (requestCode == VOICEMAIL_PREF_ID) {
            ...
            try {
                ...
                if ((cursor == null) || (!cursor.moveToFirst())) {
                    ...
                    //[SOLUTION]-Add-BEGIN by TCTNB.(Chuanjun Chen), 08/26/2016, SOLUTION- 2498670 And TASk-2781388
                    Toast.makeText(this,R.string.voicemail_setup_images_failed,Toast.LENGTH_SHORT).show();
