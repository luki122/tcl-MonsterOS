...
//        mContactListIntent.setType(Phone.CONTENT_ITEM_TYPE);
    ...
    protected void onBindDialogView(View view) {
        ...
        if (editText != null) {
            ...
            //[SOLUTION]-Add-BEGIN by TCTNB.(Caixia Chen), 08/08/2016, SOLUTION-2500004
            ...
            editText.addTextChangedListener(new TextWatcher() {            
                public void afterTextChanged(Editable s) {  
                	...
                	AlertDialog dialog= (AlertDialog)(EditPhoneNumberPreference.this.getDialog());
                	if(dialog != null) {
		                Button pButton = dialog.getButton(DialogInterface.BUTTON_POSITIVE);
		                Button nButton = dialog.getButton(DialogInterface.BUTTON_NEUTRAL);   
		                if(pButton != null) pButton.setEnabled(length > 7 ? true : false);
		                if(nButton != null) nButton.setEnabled(length > 7 ? true : false);
                	}
                }            
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        if (mConfirmationMode == CM_ACTIVATION) {
            if (mChecked) {
                ...
                if (getContext().getResources().getConfiguration().locale.getCountry().equals("ES") ||
                        getContext().getResources().getConfiguration().locale.getCountry().equals("MX")) {
                    if (mChangeNumberText.length() > 8) {
                        mChangeNumberText = String.valueOf(mChangeNumberText.subSequence(0, 7)) + ".";
                    }
                }
...
//        builder.setTitle(R.string.voicemail_settings_number_label); // MODIFIED by siyan.chen-nb, 2016-10-14,BUG-3067773
    }
    ...
    public boolean isAllDayChecked() {
        ...
        return mTimePeriodAllDay == null ? true : mTimePeriodAllDay.isChecked();//[SOLUTION]-Add-BEGIN by TCTNB.(Chuanjun Chen), 09/09/2016, SOLUTION-2472520 And TASk-2781039
    }
