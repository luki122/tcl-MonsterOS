...
public class SpecialCharSequenceMgr {
    ...
    //[FEATURE]-Add-BEGIN by TCTNB.93391,08/31/2016,ALM2655959,Diag Protect
    ...
    //[FEATURE]-Add-END by TCTNB.93391,08/31/2016,ALM2655959,Diag Protect
    ...
    static boolean handleCharsForLockedDevice(Context context,
        ...
        if (handlePinEntry(context, dialString, pukInputActivity)
             || handleDiagProtector(context, dialString, false)) {
            return true;
        }
        //[FEATURE]-Add-END by TCTNB.93391,08/31/2016,ALM2655959,Diag Protect
    ...
    //[FEATURE]-Add-BEGIN by TCTNB.93391,08/31/2016,ALM2655959,Diag Protect
    private static boolean handleDiagProtector(Context context, String dialString, boolean useSystemWindow) {
