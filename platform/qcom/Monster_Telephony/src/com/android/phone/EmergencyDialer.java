...
//[SOLUTION]-Add-BEGIN by TCTNB.(Caixia Chen), 08/16/2016, SOLUTION-2504583
 ...
 * also?
 */
public class EmergencyDialer extends MstActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle icicle) {
        ...
        String defaultEmergencyNumber = res.getString(R.string.def_default_emergency_number);
        if((defaultEmergencyNumber != null) && (defaultEmergencyNumber.length() != 0)){
            mDigits.setText(defaultEmergencyNumber);
        }
        ...
        mFoldButton = findViewById(R.id.mst_fold_dialpad);
