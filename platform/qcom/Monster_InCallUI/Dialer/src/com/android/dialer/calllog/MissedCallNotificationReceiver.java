...
public class MissedCallNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String name = intent.getStringExtra("android.telecom.extra.missedcall_name");
        CallLogNotificationsService.updateMissedCallNotifications(context, count, number, name);
