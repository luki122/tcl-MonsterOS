...
public class CallLogNotificationsService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        switch (action) {
            ...
            case ACTION_UPDATE_MISSED_CALL_NOTIFICATIONS:
                ...
                //[SOLUTION]-Mod-BEGIN by TCTNB.(Caixia Chen), 08/23/2016, SOLUTION-2504488
                String name = intent.getStringExtra("MISSED_CALL_NAME");
                MissedCallNotifier.getInstance(this).updateMissedCallNotification(count, number, name);
    ...
    public static void updateMissedCallNotifications(Context context, int count,
        ...
        serviceIntent.putExtra("MISSED_CALL_NAME", name);
