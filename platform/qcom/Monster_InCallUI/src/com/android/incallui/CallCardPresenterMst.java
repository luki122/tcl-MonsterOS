 ...
 */
public class CallCardPresenterMst extends Presenter<CallCardPresenterMst.CallCardUi>
    ...
    private static final String TAG = CallCardPresenterMst.class.getSimpleName();
    ...
    public static class ContactLookupCallback implements ContactInfoCacheCallback {
        private final WeakReference<CallCardPresenterMst> mCallCardPresenter;
        private final boolean mIsPrimary;

        public ContactLookupCallback(CallCardPresenterMst callCardPresenter, boolean isPrimary) {
            mCallCardPresenter = new WeakReference<CallCardPresenterMst>(callCardPresenter);
            mIsPrimary = isPrimary;
        }

        @Override
        public void onContactInfoComplete(String callId, ContactCacheEntry entry) {
        	CallCardPresenterMst presenter = mCallCardPresenter.get();
            if (presenter != null) {
    ...
    public void onStateChange(InCallState oldState, InCallState newState, CallList callList) {
        ...
        // Start/stop timers.
        //modify by lgy
        if (isPrimaryCallActive() || isPrimaryCallHold()) {
...
//                true /* shouldAnimate */);
    ...
    public void updateCallTime() {
        ...
        if (ui == null) {
            mCallTimer.cancel();
        } else if (!isPrimaryCallActive() && !isPrimaryCallHold()) {
            ui.setPrimaryCallElapsedTime(false, 0);
            mCallTimer.cancel();
        } else {
//            final long callStart = mPrimary.getConnectTimeMillis();
//            final long duration = System.currentTimeMillis() - callStart;
            final long duration = mPrimary.getDuration();
            Log.d(this, "updateCallTime duration = " + duration);
    ...
    private void updatePrimaryDisplayInfo() {
        ...
        if (mPrimary == null) {
            ...
            ui.setPrimary(null, null, false, null, null, false, false, false, null, null, null);
            ui.setSimSubId(SubscriptionManager.INVALID_SUBSCRIPTION_ID);
            return;
        }
        ...
        if (mPrimary.isConferenceCall()) {
            ...
            if (isCallSubjectShown) {
                ...
                if(number != null && number.equalsIgnoreCase(mPrimaryContactInfo.area)) {
                	number = null;
                }
            }
            ...
            ui.setPrimary(
                    ...
                    ,mPrimaryContactInfo.area,
                    mPrimaryContactInfo.mark,
                    mPrimaryContactInfo.note);
            if(nameIsNumber && mPrimaryContactInfo.mark != null) {
            	ui.setPrimaryPhoneNumber(name);
            }
        ...
        ui.setSimSubId(mPrimary.getSubId());
    ...
    private void updateSecondaryDisplayInfo() {
        ...
        if (mSecondary == null) {
            ...
            ui.setSecondary(false, null, null, false, null, null, false /* isConference */,
                    false /* isVideoCall */, mIsFullscreen , null, null);
            return;
        }
        ...
        if (mSecondary.isConferenceCall()) {
            ...
            ui.setSecondary(
                    ...
                    false /* isConference */,
                    mSecondary.isVideoCall(mContext),
                    mIsFullscreen, mSecondaryContactInfo.area, mSecondaryContactInfo.mark);
        } else {
            // Clear the secondary display info.
            ui.setSecondary(false, null, null, false, null, null, false /* isConference */,
                    false /* isVideoCall */, mIsFullscreen, null, null);
...
//          return contactInfo.location;
    ...
    //add by lgy 
    private boolean isPrimaryCallHold() {
        return mPrimary != null && mPrimary.getState() == Call.State.ONHOLD;
    }
...
//                call.isCallSubjectSupported();
    ...
    public interface CallCardUi extends Ui {
        ...
        void setPrimary(String number, String name, boolean nameIsNumber, String label,
                Drawable photo, boolean isSipCall, boolean isContactPhotoShown, boolean isWorkCall,  String area, MarkResult mark, String note);
        void setSecondary(boolean show, String number,String name, boolean nameIsNumber, String label,
                ...
                boolean isFullscreen, String area, MarkResult mark);
