...
import static com.android.incallui.CallButtonFragmentMst.Buttons.BUTTON_COUNT;
import static com.android.incallui.CallButtonFragmentMst.Buttons.*;
...
import com.mediatek.telecom.recording.RecordManager;
import com.mst.ui.InCallCompoundButton;
 ...
 */
public class CallButtonFragmentMst
        extends BaseFragment<CallButtonPresenterMst, CallButtonPresenterMst.CallButtonUi>
        implements CallButtonPresenterMst.CallButtonUi, OnMenuItemClickListener, OnDismissListener,
...
//        public static final int BUTTON_COUNT = 16;
        public static final int BUTTON_ADD_CALL = 5;
        public static final int BUTTON_MERGE = 6;
        public static final int BUTTON_RECORD = 7;   
        public static final int BUTTON_END = 8;   
...
//    private ImageButton mRecordButton;
   ...
   public CompoundButton mRecordButton;
   ...
   private ImageButton mFloatingActionButton;
    ...
    @Override
    public CallButtonPresenterMst createPresenter() {
        // TODO: find a cleaner way to include audio mode provider than having a singleton instance.
        return new CallButtonPresenterMst();
    }

    @Override
    public CallButtonPresenterMst.CallButtonUi getUi() {
        return this;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View parent = inflater.inflate(R.layout.call_button_fragment_mst, container, false);
...
//        mRecordButton.setOnClickListener(this);
        ...
        mFloatingActionButtonContainer = parent.findViewById(
                R.id.floating_end_call_action_button_container);
        mFloatingActionButton = (ImageButton) parent.findViewById(
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.audioButton) {
            ...
            getPresenter().muteClicked(mMuteButton.isChecked());
        } else if (id == R.id.mergeButton) {
            mLastMergeCallActionTime =  SystemClock.uptimeMillis();
            getPresenter().mergeClicked();
            mMergeButton.setEnabled(false);
        } else if (id == R.id.holdButton) {
            getPresenter().holdClicked(mHoldButton.isChecked());
...
//            }
         ...
         if (activity == null) {
  		  ...
  		  boolean hasRecordPermission = PermissionsUtil.hasPermission(activity,RECORD_PERMISSION);
  		  boolean hasSdPermission = PermissionsUtil.hasPermission(activity,SD_PERMISSION);
          if(!hasRecordPermission || !hasSdPermission){
        	   requestPermissions(new String[] {RECORD_PERMISSION, SD_PERMISSION}, RECORD_PERMISSION_REQUEST_CODE);
              return;
          } else {
          	RecordManager.getInstance().onRecordClick();  
          }
        } else {
...
//        mSwitchCameraButton.setEnabled(isEnabled);
        ...
        if (now > mLastMergeCallActionTime + 1000) {
...
//        final LayerDrawable layers = (LayerDrawable) mAudioButton.getBackground();
        final LayerDrawable layers = (LayerDrawable) ((InCallCompoundButton)mAudioButton).getDrawable();
...
//                .setAlpha(showToggleIndicator ? VISIBLE : HIDDEN);
    ...
    private void updateAudioButtonContentDescription(int mode) {
        ...
        if (stringId != 0) {
            ...
            //add by lgy 
            ((InCallCompoundButton)mAudioButton).setCustomText(stringId);
        }
    }
...
//        	mRecordButton.setCustomText(R.string.gn_record);
...
//        	mRecordButton.setCustomText(R.string.record_button_off);
        	mRecordTime.setText("");
        }
    }
...
//            }
    ...
    private long mLastMergeCallActionTime; 
    ...
    void restoreState() {
        ...
        mShowDialpadButton.setChecked(false);
        mHoldButton.setChecked(false);
        mSwapButton.setChecked(false);
        mAddCallButton.setChecked(false);
        mMergeButton.setChecked(false);
        mRecordButton.setChecked(false);
    }
}
