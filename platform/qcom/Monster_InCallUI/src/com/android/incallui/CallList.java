...
public class CallList {
    ...
    private void notifyGenericListeners() {
        ...
        if(FloatWindowManager.isStatusWindowShowing()) {
            FloatWindowManager.updateStatusBarWindow(InCallApp.getInstance());
        }
    }
...
//                delay = 0;
    ...
    void addActiveSubChangeListener(ActiveSubChangeListener listener) {
        Preconditions.checkNotNull(listener);
        //modify by lgy for speed
        if(!mActiveSubChangeListeners.contains(listener)) {
