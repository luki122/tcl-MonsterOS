...
public class PointCloud {
    ...
    public PointCloud(Drawable drawable) {
        ...
        if (mDrawable != null) {
        	Log.i("PointCloud", "width = " + drawable.getIntrinsicWidth());
        	Log.i("PointCloud", "height = " + drawable.getIntrinsicHeight());
...
//            }
//        }
        Log.i("PointCloud", " mCenterX = " + mCenterX + ",mCenterY = " + mCenterY);
        canvas.translate(mCenterX, mCenterY);
        canvas.translate(glowManager.x, glowManager.y);
        canvas.translate(-0.5f * getWidth(mDrawable), -0.5f * getHeight(mDrawable));
