                ...
                if(ntargets == 2) {
                    ...
                    //向下是正的，方向顺时针，从最左的－PI 转一圈到＋PI 
                     for (int i = 0; i < ntargets; i++) {
                          ...
                          double targetMaxRad;
                          if(i == 0) {
                              targetMinRad = - Math.PI + Math.PI /3; 
                                      targetMaxRad = 0 - + Math.PI /3;
                          } else if(i ==1) {
                              targetMinRad =  Math.PI /2 - Math.PI / 6 ; 
                              targetMaxRad = Math.PI  + Math.PI /3 ;
                          } else {
                              targetMinRad = 0 -  Math.PI /3; 
                              targetMaxRad = Math.PI /2 - Math.PI / 6 ;
                          }
