...
public class Call {
    ...
    private long getConnectClockTimeMillis() {
        return mTelecomCall.getDetails().getExtras().getLong("connect_clock_time");
    }
    
    public long getDuration() {
        return  SystemClock.elapsedRealtime() - getConnectClockTimeMillis();
    }
