...
import com.android.phone.common.dialpad.InCallDialpadView;
 ...
 */
public class DialpadFragmentMst extends BaseFragment<DialpadPresenterMst, DialpadPresenterMst.DialpadUi>
        implements DialpadPresenterMst.DialpadUi, View.OnTouchListener, View.OnKeyListener,
    ...
    private InCallDialpadView mDialpadView;
...
//        }
    ...
    @Override
    public DialpadPresenterMst createPresenter() {
        return new DialpadPresenterMst();
    }

    @Override
    public DialpadPresenterMst.DialpadUi getUi() {
        return this;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View parent = inflater.inflate(
                R.layout.incall_dialpad_fragment_mst, container, false);
        mDialpadView = (InCallDialpadView) parent.findViewById(R.id.dialpad_view);
        ...
        mEndCall =  parent.findViewById(R.id.dialpad_floating_action_button);
        ...
        mDialpadButton = parent.findViewById(R.id.mst_fold_dialpad);
        mDialpadButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        		InCallActivity activity = (InCallActivity) getActivity();
        		if (activity != null) {
        			activity.getCallButtonFragment().displayDialpad(false /* show */, true /* animate */);
        		}
            }
        });
...
//        updateColors();
    ...
    public void animateShowDialpad() {
        final InCallDialpadView dialpadView = (InCallDialpadView) getView().findViewById(R.id.dialpad_view);
