 ...
 * user's profile if configured to do so.
 */
public class ProfileAndContactsLoader extends CursorLoader {
	...
	/**
	 * Whether to load the profile and merge results in before any other
	 * results.
	 */
	...
	public void setLoadExtraContactsLast(Uri uri, String[] projection,
	...
	private Cursor loadExtraContacts() {
		return getContext().getContentResolver().query(mExtraUri,
				mExtraProjection, mExtraSelection, mExtraSelectionArgs, null);
	}
}
