...
public class EditEventActivity extends AbstractCalendarActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == EventRepeatChooseActivity.EVENT_REPEAT_CHOOSE_CODE &&
                resultCode == RESULT_OK && data != null) {
            if (mEditFragment != null && mEditFragment.mView != null) {
                mEditFragment.mView.onRecurrenceSet(data.getStringExtra(EventRepeatChooseActivity.EVENT_RRULE));
            }
        }
    }
