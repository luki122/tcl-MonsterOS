...
public class BirthdayReceicer extends BroadcastReceiver {
    ...
    public static void checkLocalAccount(ContentResolver resolver) {
        ...
        } else if (cursor != null && cursor.moveToFirst() && cursor.getInt(1) == 0) {
            ContentValues values = new ContentValues();
            values.put(Calendars.VISIBLE, 1);
            resolver.update(Calendars.CONTENT_URI, values,
                    Calendars.ACCOUNT_NAME + "=?", new String[] { Utils.LOCAL_ACCOUNT_NAME });
        }
