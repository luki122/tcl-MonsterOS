...
//        SearchView.OnCloseListener {
    ...
    private OnMenuItemClickListener onMenuItemClickListener = new OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            if (mInfoFragment != null) {
                 mInfoFragment.onMenuItemClick(item);
             }
            return true;
    	}
    };
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.mst_event_info_layout);

        Toolbar toolbar = (Toolbar) findViewById(R.id.my_toolbar);
        toolbar.inflateMenu(R.menu.mst_event_info_title_bar);
        toolbar.setOnMenuItemClickListener(onMenuItemClickListener);
        toolbar.setOverflowIcon(getDrawable(R.drawable.mst_toolbar_overflow_icon_white));
        toolbar.setNavigationIcon(R.drawable.mst_toolbar_back_icon_white);
