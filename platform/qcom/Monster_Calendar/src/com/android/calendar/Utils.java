...
public class Utils {
    ...
    **/
    ...
    public static int getDefaultReminderMinutes(Context context) {
        String minutes = getSharedPreference(context, GeneralPreferences.KEY_DEFAULT_REMINDER, "10");
    ...
    public static int getFirstDayOfWeek(Context context) {
        ...
        if (GeneralPreferences.WEEK_START_DEFAULT.equals(pref)) {
            ...
            String startDayStr = context.getString(R.string.preferences_week_start_day_default);
