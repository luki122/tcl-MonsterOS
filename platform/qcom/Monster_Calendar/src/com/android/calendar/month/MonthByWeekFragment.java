...
import com.android.calendar.mst.CalendarSettingsActivity;
import com.android.calendar.mst.MonthAgendaView;
...
public class MonthByWeekFragment extends SimpleDayPickerFragment implements
    ...
    protected boolean mDoBirthdayReminder;
    ...
    private FloatingActionButton mCreateEventView;

    private long mLastLoadTime = -10000;
    ...
    private Uri updateUri() {
        ...
        // likai begin
        MonthWeekEventsView weekView = ((MonthAgendaView) mViewSwitcher.getCurrentView()).getFirstWeekView();
        if (weekView != null) {
    ...
    protected String updateWhere() {
        ...
        if (!mDoBirthdayReminder) {
            where += " AND " + Instances.OWNER_ACCOUNT + "!='"
                    + Utils.BIRTHDAY_REMINDER_ACCOUNT_NAME + "'";
        }
        return where;
    }
    ...
    protected void setUpAdapter() {
        ...
        weekParams.put(MonthByWeekAdapter.WEEK_PARAMS_IS_MINI, 0/*mIsMiniMonth ? 1 : 0*/);
    ...
    public View onCreateView(
    	...
    	View v = inflater.inflate(R.layout.mst_month_by_week, container, false);
        mDayNamesHeader = (ViewGroup) v.findViewById(R.id.day_names);

        // likai begin
        mEventLoader = new EventLoader(mContext);

        mCreateEventView = (FloatingActionButton) v.findViewById(R.id.create_event);
        mViewSwitcher = (ViewSwitcher) v.findViewById(R.id.month_view_switcher);
        /*mViewSwitcher.setFactory(this);

        MonthAgendaView currentMonthView = (MonthAgendaView) mViewSwitcher.getCurrentView();
        currentMonthView.setParams(mViewSwitcher, mAdapter, this,
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // likai begin
        mCreateEventView.setOnFloatingActionButtonClickListener(new OnFloatActionButtonClickListener() {
            @Override
        ...
        if (mViewSwitcher != null) {
            ...
            MonthAgendaView currentMonthView = (MonthAgendaView) mViewSwitcher.getCurrentView();
            currentMonthView.setParams(mViewSwitcher, mAdapter, this,
                    mSelectedDay, mEventLoader, (View) mCreateEventView);
            currentMonthView.setHighlightFlag(true);
            currentMonthView.highlightToday();
        }
        // likai end
    ...
    public void onResume() {
        ...
        MonthAgendaView currentMonthView = (MonthAgendaView) mViewSwitcher.getCurrentView();
        currentMonthView.setRootView(getView());
    ...
    protected void setUpHeader() {
        ...
        mDayLabels = getResources().getStringArray(R.array.day_labels);
    }
    ...
    public void doResumeUpdates() {
        ...
        boolean preDoBirthdayReminder = mDoBirthdayReminder;
        mDoBirthdayReminder = Utils.getSharedPreference(mContext,
                CalendarSettingsActivity.KEY_BIRTHDAY_REMINDER, true);
        // if (prevHideDeclined != mHideDeclined && mLoader != null) {
        if ((preDoBirthdayReminder != mDoBirthdayReminder || prevHideDeclined != mHideDeclined) && mLoader != null) {
    ...
    public void eventsChanged() {
        ...
        if (now < (mLastLoadTime + LOADER_DELAY)) {
            return;
        } else {
            mLastLoadTime = now;
        }
    ...
    public View makeView() {
       MonthAgendaView monthView = new MonthAgendaView(mContext);
       monthView.setLayoutParams(new ViewSwitcher.LayoutParams(
    ...
    public void onMonthViewSwitched(Time monthDate) {
        ...
        long millis = monthDate.normalize(true);
        int monthDateJulianDay = Time.getJulianDay(millis, monthDate.gmtoff);
    ...
    private void launchCreateEvent() {
        ...
        int selectJulianDay = Time.getJulianDay(controller.getTime(), t.gmtoff);
