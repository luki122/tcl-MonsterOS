    ...
    public static String getRepeatString(Context context, Resources r, EventRecurrence recurrence,
        ...
        switch (recurrence.freq) {
            case EventRecurrence.DAILY:
               ...
               return r.getString(R.string.event_daily) + endString;
            case EventRecurrence.WEEKLY: {
                if (recurrence.repeatsOnEveryWeekDay()) {
                    return r.getString(R.string.event_every_weekday/*every_weekday*/) + endString;
                } else {
                    String string;
                    ...
                    /*return r.getQuantityString(R.plurals.weekly, interval, interval, string)
                            + endString;*/
                    return r.getString(R.string.event_weekly, string) + endString;
                }
            }
