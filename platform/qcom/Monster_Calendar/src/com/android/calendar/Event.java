...
public class Event implements Cloneable {
    ...
    private static final int PROJECTION_OWNER_ACCOUNT_INDEX = 20;
    private static final int PROJECTION_DTSTART_INDEX = 21;
     ...
     */
    public static synchronized void loadEvents(Context context, ArrayList<Event> events, int startDay, int days,
    ...
    private static Event generateEventFromCursor(Cursor cEvents) {
        ...
        e.ownerAccount = cEvents.getString(PROJECTION_OWNER_ACCOUNT_INDEX);
        e.dtstart = cEvents.getLong(PROJECTION_DTSTART_INDEX);
