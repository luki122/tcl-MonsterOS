...
public class DismissAlarmsService extends IntentService {
    ...
    public static final String SHOW_BIRTHDAY_ACTION = "com.android.calendar.SHOW_BIRTHDAY";
    ...
    public void onHandleIntent(Intent intent) {
        ...
        if (SHOW_BIRTHDAY_ACTION.equals(intent.getAction())) {
            Intent birthdayViewIntent = AlertUtils.buildBirthdayViewIntent(this, eventStart);

            TaskStackBuilder.create(this)
                    .addParentStack(BirthdayInfoActivity.class).addNextIntent(birthdayViewIntent).startActivities();
        }
    }
