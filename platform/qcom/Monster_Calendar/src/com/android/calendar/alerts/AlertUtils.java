...
public class AlertUtils {
    ...
    public static final int BIRTHDAY_REMINDER_NOTIFICATION_ID = 1;
    ...
    public static Intent buildBirthdayViewIntent(Context context, long millis) {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setClass(context, BirthdayInfoActivity.class);
