...
public class AlertActivity extends Activity implements OnClickListener {
    ...
    private static final String SELECTION = CalendarAlerts.STATE + "=? AND " + CalendarAlerts.OWNER_ACCOUNT + "!=?";
    private static final String[] SELECTIONARG = new String[] {
        Integer.toString(CalendarAlerts.STATE_FIRED), Utils.BIRTHDAY_REMINDER_ACCOUNT_NAME
    };
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mAdapter = new AlertAdapter(this, R.layout.mst_alert_item/*alert_item*/);
