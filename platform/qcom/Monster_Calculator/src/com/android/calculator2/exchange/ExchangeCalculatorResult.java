...
public class ExchangeCalculatorResult extends AlignedTextView {
    ...
    public final ForegroundColorSpan mExponentColorSpan;
    ...
    public ExchangeCalculatorResult(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mGestureDetector = new GestureDetector(context,
            new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onFling(MotionEvent e1, MotionEvent e2,
                    ...
                    stopActionMode();
                    ExchangeCalculatorResult.this.cancelLongPress();
    ...
    void setEvaluator(ExchangeEvaluator evaluator) {
   ...
   public  void displayResult(int initPrec, int msd, int leastDigPos, String truncatedWholePart) {
     ...
     */
    public String getFormattedResult(int precOffset, int maxSize, int lastDisplayedOffset[],
    ...
    void redisplay() {
        ...
        if (expIndex > 0 && result.indexOf('.') == -1) {
          // Gray out exponent if used as position indicator
            ...
            str_result = formattedResult.toString();
        } else {
            setText(result);
            str_result = result;
        }
    ...
    private boolean isHideToChinese(){
        String getText  = getFullText();
        if(getText.contains(getContext().getString(R.string.op_sub))||getText.contains("E") ||!isNum(getText) ){
            return true;
        }
        return false;
    }
