...
public class SystemUtil {
    ...
    public static final int REQUEST_LOGIN_QQ_SETTING = 1007;
    public static final int REQUEST_LOGIN_QQ_SETTING_CHANGE_ACCOUNT = 1008;
    public static final int REQUEST_MAINACT_FIRST_LOGIN = 1009;
    ...
    public static boolean checkNoNetWork(final Context context){

        boolean is = hasNetwork();
