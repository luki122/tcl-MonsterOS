...
public class AppRecoveryActivity extends BaseActivity {
    ...
    public void selectAllRecoveryApp(boolean selectOrReverse) {
    ...
    public void selectAllRecommendApp(boolean selectOrReverse) {
        for (int i = 0; i < itemList.size(); i++) {
            if (itemList.get(i).getType() == RecoveryAppItem.ITEM_VIEW_TYPE_ITEM
    ...
    public boolean isRecoveryAppSelectedAll() {
        boolean result = true;
        for (int i = 0; i < itemList.size(); i++) {
            if (itemList.get(i).getType() == RecoveryAppItem.ITEM_VIEW_TYPE_ITEM
                    && itemList.get(i).getAppType() == RecoveryAppItem.ITEM_VIEW_APP_TYPE_RECOVERY) {
    ...
    public boolean isRecommendAppSelectedAll() {
        boolean result = true;
        for (int i = 0; i < itemList.size(); i++) {
            if (itemList.get(i).getType() == RecoveryAppItem.ITEM_VIEW_TYPE_ITEM
                    && itemList.get(i).getAppType() == RecoveryAppItem.ITEM_VIEW_APP_TYPE_RECOMMEND) {
    ...
    public void updateSelectCountText() {
        ...
        // 更新header
        for (int i = 0; i < itemList.size(); i++) {
            if (itemList.get(i).getType() == RecoveryAppItem.ITEM_VIEW_TYPE_HEADER) {
                adapter.notifyItemChanged(i);
            }
        }
    }
