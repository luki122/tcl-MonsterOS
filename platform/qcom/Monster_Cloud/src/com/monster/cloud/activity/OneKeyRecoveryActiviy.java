...
public class OneKeyRecoveryActiviy extends MstActivity implements View.OnClickListener {
    ...
    private void checkRecovery() {
        ...
        if (sms_time_type > 0 && check_sms.isChecked()) {
            ...
            recovery_sms_ing.setText(R.string.revocery_waitting);
        } else {
    ...
    public void setEnableStartRecorvery(boolean is) {
        ...
        if (is) {
            ...
            String size = df.format(count_show);
...
//            text_connect.setText(R.string.comput_time);
    ...
    public String getLeftSize() {
        ...
        float count_show = sizeShow(count_all);
        java.text.DecimalFormat df = new java.text.DecimalFormat("#.##");
        return df.format(count_show) + getUnit(count_all);
    }

    private float sizeShow(float size) {
    ...
    private void resultSMS(Intent data) {
        ...
        if (is_sync_by_time) {
            ...
            switch (sms_time_type) {
                case 1:
                    str_sms_info = getString(R.string.last_month_info);
                    break;
                case 2:
                    str_sms_info = getString(R.string.last_three_month_info);
                    break;
                case 3:
                    str_sms_info = getString(R.string.last_half_a_year_info);
                    break;
                case 4:
                    str_sms_info = getString(R.string.last_year_info);
                    break;
                case 5:
                    str_sms_info = getString(R.string.all_info);
                    break;
            }
