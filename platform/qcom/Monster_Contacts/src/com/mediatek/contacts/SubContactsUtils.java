...
public class SubContactsUtils extends ContactsUtils {
    ...
    public static Uri insertToDB(Account mAccount, String name, String number, String email,
            String additionalNumber, ContentResolver resolver, long indicate, String simType,
            long indexInSim, Set<Long> grpAddIds) {
        Log.i(TAG, "[insertToDB]name:" + name + ",number :" + number + ",email:" + email
                + ",additionalNumber = " + additionalNumber + ",indicate:" + indicate + ",simType:"
                + simType + ",indexInSim:" + indexInSim);
    ...
    public static void buildInsertOperation(ArrayList<ContentProviderOperation> operationList,
            Account mAccount, String name, String number, String email, String additionalNumber,
            ContentResolver resolver, int indicate, String simType, long indexInSim,
            Set<Long> grpAddIds) {
        Log.i(TAG, "[buildInsertOperation]name:" + name + ",number:" + number
                + ",additionalNumber:" + additionalNumber + ",indicate:" + indicate + ",simType:"
                + simType + ",indexInSim:" + indexInSim);
        ...
        if (SimCardUtils.SimType.SIM_TYPE_USIM_TAG.equals(simType)
            ...
            if (!ExtensionManager.getInstance().getAasExtension()
                    .updateOperationList(mAccount, operationList, backRef)) {
    ...
    public static void insertPhoneNumber(String number,
        ...
        Log.i(TAG, "[insertPhoneNumber]phoneTypeSuffix is " + phoneTypeSuffix + ",backRef:"
    ...
    public static void insertAdditionalNumber(ArrayList<ContentProviderOperation> operationList,
        ...
        Log.i(TAG, "[insertAdditionalNumber]additionalNumber is " + additionalNumber
                + ",backRef:" + backRef);
    ...
    public static void insertName(ArrayList<ContentProviderOperation> operationList, String name,
            int backRef) {
        Log.i(TAG, "[insertName]name is " + name + ",backRef:" + backRef);
        if (!TextUtils.isEmpty(name)) {
            ContentProviderOperation.Builder builder = ContentProviderOperation
                    .newInsert(Data.CONTENT_URI);
    ...
    public static void insertEmail(ArrayList<ContentProviderOperation> operationList, String email,
            int backRef) {
        Log.i(TAG, "[insertEmail]email is " + email + ",backRef:" + backRef);
    ...
    public static void insertRawContacts(ArrayList<ContentProviderOperation> operationList,
            Account mAccount, int indicate, long indexInSim) {
