...
public class GroupBrowseActivity extends mst.app.MstActivity implements 
mst.widget.toolbar.Toolbar.OnMenuItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setMstContentView(R.layout.mtk_group_browse_activity);
...
//		toolbar.setBackgroundColor(Color.WHITE);
		toolbar.setNavigationOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent homeIntent = new Intent(GroupBrowseActivity.this, PeopleActivity.class);
