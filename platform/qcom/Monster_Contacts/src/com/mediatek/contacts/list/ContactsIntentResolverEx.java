...
public class ContactsIntentResolverEx extends ContactsIntentResolver {
    ...
    public ContactsRequest resolveIntent(Intent intent) {
        ...
        if (ContactsIntent.contain(intent)) {
            ...
            if (ContactsIntent.LIST.ACTION_PICK_MULTI_CONTACTS.equals(action)) {
            ...
            } else if (ContactsIntent.LIST.ACTION_DELETE_MULTI_CONTACTS.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_DELETE_MULTIPLE_CONTACTS);
            } else if (ContactsIntent.LIST.ACTION_GROUP_MOVE_MULTI_CONTACTS.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_GROUP_MOVE_MULTIPLE_CONTACTS);
            ...
            } else if (ContactsIntent.LIST.ACTION_SHARE_MULTI_CONTACTS.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_SHARE_MULTIPLE_CONTACTS);
            } else if (ContactsIntent.LIST.ACTION_GROUP_ADD_MULTI_CONTACTS.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_GROUP_ADD_MULTIPLE_CONTACTS);
                ...
                request.setActionCode(ContactsRequestAction.ACTION_PICK_MULTIPLE_DATAS);
            }else if (ContactsIntent.LIST.AUTO_RECORD_CONTACTS_LIST.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_MST_RECORD_CONTACTS_LIST);
            }else if (ContactsIntent.LIST.PRIVACY_CONTACTS_CONTACTS_LIST.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_MST_PRIVACY_CONTACTS_LIST);
            }else if (ContactsIntent.LIST.PRIVACY_ADD_CONTACTS_CONTACTS_LIST.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_MST_PRIVACY_ADD_CONTACTS_LIST);
            }
