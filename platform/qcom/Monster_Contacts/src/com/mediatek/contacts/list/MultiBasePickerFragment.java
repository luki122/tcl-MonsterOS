...
public class MultiBasePickerFragment extends AbstractPickerFragment
    ...
    protected void onCreateView(LayoutInflater inflater, ViewGroup container) {
        ...
        ((ContactListMultiChoiceActivity)getActivity()).toolbar.setVisibility(View.INVISIBLE);
    ...
    protected void configureAdapter() {
        ...
        adapter.setSelectedContactsListener(this);

    }

    @Override
    protected ContactListAdapter createListAdapter() {
        Log.i(TAG, "[createListAdapter]");
    ...
    public void onOptionAction() {    	
        ...
        Log.d(TAG,"onOptionAction,idArray:"+(idArray==null?"null":idArray.length));
        if (idArray == null) {
