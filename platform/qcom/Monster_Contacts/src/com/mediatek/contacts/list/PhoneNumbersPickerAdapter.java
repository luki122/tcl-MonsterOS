...
public class PhoneNumbersPickerAdapter extends DataKindBasePickerAdapter {
    protected static final String TAG = "PhoneNumbersPickerAdapter";
    ...
    protected static final int QUAN_PINYIN = 12;
    protected static final int JIAN_PINYIN = 13;
    ...
    protected void configureSelection(CursorLoader loader, long directoryId,
        ...
        case ContactListFilter.FILTER_TYPE_DEFAULT:
            // No selection needed.
        	selection.append("(data1 <> '' AND data1 is not NULL)");
            break;
        ...
        case ContactListFilter.FILTER_TYPE_RECORD_CONTACT:
        	Log.d(TAG,"configureSelection FILTER_TYPE_RECORD_CONTACT");
        	selection.append("auto_record=1");
        	break;
        	
        case ContactListFilter.FILTER_TYPE_SELECT_RECORD_CONTACT:
        	Log.d(TAG,"configureSelection FILTER_TYPE_SELECT_RECORD_CONTACT");
        	selection.append("auto_record!=1");
        	break;
