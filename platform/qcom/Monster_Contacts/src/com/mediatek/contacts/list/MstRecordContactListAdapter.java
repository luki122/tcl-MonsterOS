...
public class MstRecordContactListAdapter extends PhoneNumbersPickerAdapter implements SliderView.OnSliderButtonLickListener{
	protected static final String TAG = "MstRecordContactListAdapter";
	public MstRecordContactListAdapter(Context context, ListView lv) {
		super(context, lv);
