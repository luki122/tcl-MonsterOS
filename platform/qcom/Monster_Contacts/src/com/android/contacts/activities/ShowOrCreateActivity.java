...
public final class ShowOrCreateActivity extends ContactsActivity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /// M: Bug fix ALPS01535648, google default bug. @{
        //  Prevent adding the empty phone number or email address to existing contact.
        ...
        if (ContactsUtils.SCHEME_MAILTO.equals(scheme)) {
            ...
            /** M: New Feature @{ */
            if (ActivitiesUtils.checkSimNumberValid(this, ssp)) {
                return;
            }
            /** @} */
