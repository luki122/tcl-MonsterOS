...
OnCloseListener, OnFocusChangeListener,mst.widget.toolbar.Toolbar.OnMenuItemClickListener,FragmentCallbacks {
	...
	*/}
	...
	public void configureListFragment() {
		...
		case ContactsRequest.ACTION_INSERT_OR_EDIT_CONTACT: {
			...
			mSearchView.setVisibility(View.GONE);
			toolbar.setTitle(getResources().getString(R.string.mst_add_to_exist_contact));
...
//			fragment.setSectionHeaderDisplayEnabled(false);
		...
		case ContactsRequest.ACTION_CREATE_SHORTCUT_CONTACT: {
			...
			fragment.setCallbacks(this);
			mSearchView.setVisibility(View.GONE);
			toolbar.setTitle(R.string.mst_choose_contacts);
			break;
		}
		...
		case ContactsRequest.ACTION_PICK_PHONE: {
			...
			fragment.setCallbacks(this);
			mSearchView.setVisibility(View.GONE);
			toolbar.setTitle(R.string.mst_choose_number);
			mListFragment = fragment;
			break;
		}
