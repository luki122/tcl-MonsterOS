...
public class JoinContactListFragment extends ContactEntryListFragment<JoinContactListAdapter> {
    ...
    private void showTargetContactName(String displayName) {
        ...
        /** M: Bug Fix CR ID: ALPS00117275. */
        //AOSP code:String blurb = activity.getString(R.string.blurbJoinContactDataWith, name);
        String blurb = ContactsListUtils.getBlurb(getActivity(), displayName);
