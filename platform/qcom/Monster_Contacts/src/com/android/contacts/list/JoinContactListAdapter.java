...
public class JoinContactListAdapter extends ContactListAdapter {
    ...
    protected ContactListItemView newView(
        ...
        switch (partition) {
            case PARTITION_SUGGESTIONS:
            case PARTITION_ALL_CONTACTS:
            	final ViewGroup mainUi = (ViewGroup)(super.newView(context, partition, cursor, position, parent)).findViewById(R.id.front_view);
                return (ContactListItemView)(mainUi.getChildAt(1));
