...
import com.android.contacts.activities.MstContactImportExportActivity;
...
public class ContactsUnavailableFragment extends Fragment implements OnClickListener {
    ...
    private mst.widget.FoldProgressBar mProgress;
    ...
    public View onCreateView(
        ...
        drawable.setStroke(1, getResources().getColor(R.color.mst_list_main_text_color)); // 边框粗细及颜色  
        drawable.setColor(0xFFFFFF); // 边框内部颜色            
        mImportContactsButton.setBackgroundDrawable(drawable); // 设置背景（效果就是有边框及底色）  
        
        mImportContactsButton.setOnClickListener(this);
        mProgress = (mst.widget.FoldProgressBar) mView.findViewById(R.id.progress);
...
//                mListener.onImportContactsFromFileAction();
    			Intent intent=new Intent(getActivity(),MstContactImportExportActivity.class);
