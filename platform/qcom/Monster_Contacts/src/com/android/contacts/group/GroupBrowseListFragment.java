...
public class GroupBrowseListFragment extends Fragment
    ...
    private /*AutoScrollListView*/MstListView mListView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // M: Bug Fix for ALPS00302773
        // Select contact group for message @{
        ...
        mListView = (/*AutoScrollListView*/MstListView) mRootView.findViewById(R.id.list);
...
//                rightPadding, mListView.getPaddingBottom());
    ...
    private final LoaderManager.LoaderCallbacks<Cursor> mGroupLoaderListener =
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        	Log.d(TAG,"onLoadfinished,data:"+(data==null?"null":data.getCount()));
    ...
    private void viewGroup(Uri groupUri) {
    	Log.d(TAG,"viewGroup,groupUri:"+groupUri);
    ...
    */}
    ...
    ///M: For move to other group feature.
    public int getAccountGroupMemberCount() {
        return mAccountGroupMemberCount;
    }
    ...
    protected OnItemClickListener configOnItemClickListener() {
        return new OnItemClickListener() {
            ...
            ///M: For move to other group feature.
                    mAccountGroupMemberCount =
                        mAdapter.getItem(position).getAccountGroupMemberCount();
    ...
    protected MstListView getListView() {
        return mListView;
    }
