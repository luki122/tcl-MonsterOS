...
import com.mediatek.contacts.group.GroupsUtils;
...
public class GroupBrowseListAdapter extends BaseAdapter {
	...
	public void setCursor(Cursor cursor) {
		...
		/// M: For move to other group feature. @{
		GroupsUtils.initGroupsByAllAccount(mCursor, mAccountNameList, mAccountGroupMembers);
	...
	@Override
	public int getCount() {
		Log.d(TAG,"getCount,mCursor:"+((mCursor==null)?"null":mCursor.isClosed()+","+mCursor.getCount()));
	...
	public GroupListItem getItem(int position) {
		Log.d(TAG,"getItem,position:"+position+" mcursor:"+mCursor);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Log.d(TAG,"getview,position:"+position+" entry.getTitle(): "+entry.getTitle());
		View result;
...
//		}
		...
		viewCache.groupMemberCount.setText(entry.getMemberCount()==0?"": " ("+entry.getMemberCount()+")");
...
//			divider = view.findViewById(R.id.divider);
			groupTitle = (TextView) view.findViewById(android.R.id.text1);
			groupTitle.setSingleLine(true);
			groupTitle.setEllipsize(TruncateAt.END);
			accountType=null;
			accountName=null;
			accountHeader=null;
			accountHeaderExtraTopPadding=null;
			divider=null;
			mUri=null;
		}
	...
	protected int getGroupListItemLayout() {
		        return R.layout.mst_group_brower_item;
//		return com.mst.R.layout.list_item_1_line;
	}
