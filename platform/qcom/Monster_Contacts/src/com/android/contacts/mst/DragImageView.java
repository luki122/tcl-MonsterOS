...
public class DragImageView extends ImageView {
	...
	public void setmCallbacks(FragmentCallbacks mCallbacks) {
		...
		Log.d(TAG,"mcallbacks1:"+mCallbacks);
	}
	...
	private int mst_start_x,mst_start_y;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			mst_start_x=(int) event.getRawX();
			mst_start_y=(int) event.getRawY();
			onTouchDown(event);
			break;
		...
		case MotionEvent.ACTION_UP:
			Log.d(TAG,"ACTION_UP");
			mode = MODE.NONE;
			int mst_end_x= (int) event.getRawX();
			int mst_end_y= (int) event.getRawY();
			Log.d(TAG,"mst_start_x:"+mst_start_x+" mst_start_y:"+mst_start_y+" mst_end_x:"+mst_end_x+" mst_end_y:"+mst_end_y);
			if(Math.abs(mst_start_x-mst_end_x)<13&&Math.abs(mst_start_y-mst_start_y)<13){
				Log.d(TAG,"点击了");
				if(mCallbacks!=null) mCallbacks.onFragmentCallback(FragmentCallbacks.SHOW_BUSINESS_CARD_LARGE_PHOTO, null);
			}
			break;
