...
public class ContactDisplayUtils {
	...
	/**
	 * Returns the note of the contact or null if there isn't one.
	 */
	public static String getNote(Context context, Contact contactData) {
		for (RawContact rawContact : contactData.getRawContacts()) {
			for (DataItem dataItem : Iterables.filter(
					rawContact.getDataItems(), NoteDataItem.class)) {
				NoteDataItem noteItem = (NoteDataItem) dataItem;
				final String note = noteItem.getNote();
