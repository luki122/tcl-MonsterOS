...
//        }
    ...
    public void onClick(View v) {
    	...
    	mDialog = new AlertDialog.Builder(getContext()).setAdapter(mAdapter, null).create();
...
//        mPopup = null;
     ...
     */
    private static final String TAG = "GroupMembershipView-liumx";
    /*
     * Change Feature by Mediatek End.
     */
    /** M: Bug Fix for ALPS00440157 @{ */
    private void changeAccountType(String accountName, String accountTpye, boolean needChange) {
        ...
        Log.i(TAG, "[changeAccountType] accountName, accountTpye : " + accountName
                + " , " + accountTpye);
    }
    /** @} */
    ...
    private boolean mIsCreateGroupEnable = true; //false;

	public void onGroupCreate(boolean hadChanges, Uri groupUri) {
		Log.e(TAG, "[onNewIntent]View.onGroupCreated: "+hadChanges+"; groupUri: "+groupUri);
	}
}
