...
public abstract class LabeledEditorView extends LinearLayout implements Editor, DialogShowingView {
    ...
    protected void onFinishInflate() {
        ...
        /// M: New Feature.
        mLabel = (MstSpinner) findViewWithTag("edit_spinner");
...
//                (int) getResources().getDimension(R.dimen.editor_padding_between_editor_views));
    ...
    public void rebuildLabel() {
        ...
        Log.d(TAG, "hasCustomSelection(): " + mEditTypeAdapter.hasCustomSelection());
        if (mEditTypeAdapter.hasCustomSelection()) {
            ...
            Log.d(TAG, "Position: " + mEditTypeAdapter.getPosition(mType) + " | mType : " + mType);
            ExtensionManager.getInstance().getAasExtension().rebuildLabelSelection(mState, mLabel,
    ...
    protected void notifyEditorListener() {
        if (mListener != null) {
        	Log.e(TAG, "Label:EditorListener.FIELD_CHANGED");
    ...
    public void setValues(DataKind kind, ValuesDelta entry, RawContactDelta state, boolean readOnly,
        ...
        /// M: For AAS.
        if (ExtensionManager.getInstance().getAasExtension().handleLabel(kind, entry, state)) {
            mHasTypes = false;
        }
    ...
    protected void onTypeSelectionChange(int position) {
        ...
        /// M: For AAS. @{
        if (ExtensionManager.getInstance().getAasExtension().onTypeSelectionChange(mState,
                mEntry, mKind, mEditTypeAdapter, selected, mType)) {
    ...
    private class EditTypeAdapter extends ArrayAdapter<EditType> {
        ...
        public EditTypeAdapter(Context context) {
            ...
            mTextColorDark = context.getResources().getColor(R.color.mst_list_main_text_color);
...
//            }
        ...
        public View getDropDownView(int position, View convertView, ViewGroup parent) {
            return createViewFromResource(
                    position, convertView, parent, com.mst.R.layout.spinner_popup_dialog_singlechoice_material);
        }
...
//                textView.setHorizontalFadingEdgeEnabled(false);
            ...
            /** M:AAS [COMMD_FOR_AAS]@ { */
            String text = ExtensionManager.getInstance().getAasExtension().
    ...
    /// M: AAS debug tag.
    private static final String TAG = "LabeledEditorView-liumx";
}
