...
public class StructuredNameEditorView extends TextFieldsEditorView {
    ...
    private static final String TAG = "StructuredNameEditorView-liumx";
    ...
    public void setValues(DataKind kind, ValuesDelta entry, RawContactDelta state, boolean readOnly,
        ...
        updateEmptiness();
        setDeleteButtonVisible(getDisplayName() == null ? false : (getDisplayName().compareTo("") != 0));
    }
    ...
    private void switchFromStructuredNameToFullName() {
        ...
        String displayName = NameConverter.structuredNameToDisplayName(getContext(),
                structuredNameMap);
        /// M: change the logic of erase structure name
    ...
    public String getDisplayName() {
        ...
        /// M: it may cause Exception if valuesDelta is null @{
        if (valuesDelta == null) {
            Log.e(TAG, "getDisplayName:null, return to avoid NPE");
            return null;
        }
        /// @}
        if (hasShortAndLongForms()) {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        /// M: Bug fix ALPS00477285.
        // mSnapshot = (StructuredNameDataItem) DataItem.createFrom(null, ss.mSnapshot);
        ContactEditorUtilsEx.restoreStructuredNameDataItem(ss, mSnapshot);
    }
    ...
    public void clearAllFields() {
    	setDisplayName("");
    	final String column = StructuredName.DISPLAY_NAME;
