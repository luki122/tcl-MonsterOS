...
import mst.provider.ContactsContract.DisplayPhoto;
...
public class PhotoEditorView extends LinearLayout implements Editor {
    ...
    protected void onFinishInflate() {
        ...
        if (mPhotoImageView != null) {
        	mPhotoImageView.setOnClickListener(new OnClickListener() {
                @Override
    ...
    /** {@inheritDoc} */
    @Override
    public void setValues(DataKind kind, ValuesDelta values, RawContactDelta state,
        ...
        if (values != null) {
            ...
            if (photoBytes != null) {
                ...
                Log.d(TAG, "[setValues] setImageBitmap");
                mHasSetPhoto = true;
    ...
    public void setPhotoEntry(Bitmap photo) {
        ...
        Log.d(TAG, "[setPhotoBitmap] setPhotoBitmap");
        mHasSetPhoto = true;
        mEntry.setFromTemplate(false);
    ...
    public void setFullSizedPhoto(Uri photoUri) {
        if (photoUri != null) {
            ...
            mContactPhotoManager.loadPhoto(mPhotoImageView, photoUri,
                    mPhotoImageView.getWidth(), /* darkTheme = */ false, /* isCircular = */ true,
...
//            mPhotoImageView.setImageDrawable(mDefaultIconDrawable);
//        } else {
//            mPhotoImageView.setImageDrawable(ContactPhotoManager.
//                    getDefaultAvatarDrawableForContact(getResources(), false, null));
//        }
    	mPhotoImageView.setImageResource(R.drawable.mst_photo_editor_view_default);
        mHasSetPhoto = false;
    ...
    /// M: Set a default icon to the photo editor view.
    public void setDefaultIconDrawable(Drawable iconDrawable) {
        mDefaultIconDrawable = iconDrawable;
    }

    /// M: This Drawable has a higher priority to show.
