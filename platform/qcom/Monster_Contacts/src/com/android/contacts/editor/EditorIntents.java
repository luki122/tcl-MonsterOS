...
public class EditorIntents {
    private static final String TAG = "EditorIntents";
    ...
    public static Intent createCompactEditContactIntent(Uri contactLookupUri,
            ...
            long nameId, boolean isEditingUserProfile) {
        Log.d(TAG, "[createCompactEditContactIntent]");
        ...
        putEditingUserProfile(intent,isEditingUserProfile);
        //add by lgy for 3151342
    ...
    /// M: add isEditingUserProfile flag for user profile feature
    private static void putEditingUserProfile(Intent intent, boolean isEditingUserProfile) {
        intent.putExtra(ContactEditorBaseFragment.INTENT_EXTRA_NEW_LOCAL_PROFILE,
