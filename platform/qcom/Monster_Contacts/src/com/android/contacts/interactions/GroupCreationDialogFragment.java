...
public class GroupCreationDialogFragment extends GroupNameDialogFragment {
    ...
    public static final String ACTION_COMPLETED = "group_created";
    ...
    public static void show(FragmentManager fragmentManager, String accountType,
            String accountName, String dataSet, long rawContactId,
            OnGroupCreatedListener listener) {
        Bundle args = new Bundle();
        initDialogConfig(fragmentManager, accountType, accountName, dataSet, rawContactId,
                listener, args);
    }

    /** M: for CR ALPS01752048 @{ */
    public static void show(FragmentManager fragmentManager, String accountType,
            String accountName, String dataSet, long rawContactId, OnGroupCreatedListener listener,
            int subId) {
        Bundle args = new Bundle();
    ...
    protected void onCompleted(String groupLabel) {
        ...
        activity.startService(ContactSaveService.createNewGroupIntentForIcc(activity,
                ...
                membersToAddArray,
                activity.getClass(), ACTION_COMPLETED,
                simIndexArray, subId));
    }
    ...
    public boolean checkName(CharSequence name, String accountType, String accountName) {
        ...
        if (mContext == null) {
            ...
            Toast.makeText(mApplicationContext, R.string.save_group_fail, Toast.LENGTH_SHORT)
                    .show();
            return false;
        }
        /** @} */
        ...
        if (nameExists) {
            Toast.makeText(mContext, R.string.group_name_exists, Toast.LENGTH_SHORT).show();
            // /M:fix CR ALPS00945678,about click phone contact
