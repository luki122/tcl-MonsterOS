...
import mst.provider.ContactsContract.AggregationExceptions;
...
public class ContactSaveService extends IntentService {
    ...
    private void createGroup(Intent intent) {
        ...
        Log.d(TAG, "[createGroupToIcc]groupName:" + label + " ,accountName:" + accountName
                + ",AccountType:" + accountType+" dataSet:"+dataSet);
    ...
    public static Intent createGroupUpdateIntent(Context context, long groupId, String newLabel,
            ...
            Class<? extends Activity> callbackActivity, String callbackAction) {
    	Log.d(TAG,"createGroupUpdateIntent,context:"+context
    			+"\ngroupId:"+groupId
    			+"\nnewLabel:"+newLabel
    			+"\nrawContactsToAdd:"+Arrays.toString(rawContactsToAdd)
    			+"\nrawContactsToRemove:"+Arrays.toString(rawContactsToRemove)
