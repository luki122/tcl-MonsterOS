 ...
 */
public class MstExpandingEntryCardView extends CardView {
    ...
    public MstExpandingEntryCardView(Context context) {
        this(context, null);
    }

    public MstExpandingEntryCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                }
    ...
    private View createEntryView(LayoutInflater layoutInflater, final Entry entry,
        ...
        if (entry.getIcon() != null && entry.getIntent() != null) {
        	thirdIcon.setImageDrawable(entry.getIcon());
        	thirdIcon.setOnClickListener(mOnClickListener);
